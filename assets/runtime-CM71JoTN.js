...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function P_(n,t,e){return new bi({name:"SphericalGaussianBlur",defines:{SAMPLES:w_,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:La(),fragmentShader:`
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function ph(){return new bi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:La(),fragmentShader:`
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function mh(){return new bi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:La(),fragmentShader:`
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function La(){return`
	...
	`}class Ud extends jn{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const i={width:t,height:t,depth:1},r=[i,i,i,i,i,i];this.texture=new Ed(r),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),d=new Ft(l,u),h=new Da(-1,1,1,-1,0,1);let f=null,_=null,y=!1,m,p=null,b=[],T=!1;this.setSize=function(M,g){o.setSize(M,g),a!==null&&a.setSize(M,g),c!==null&&c.setSize(M,g);for(let x=0;x<b.length;x++){const R=b[x];R.setSize&&R.setSize(M,g)}},this.setEffects=function(M){b=M,T=b.length>0&&b[0].isRenderPass===!0;const g=o.width,x=o.height;b.length>0&&a===null&&(a=new jn(g,x,{type:Mi,depthBuffer:!1,stencilBuffer:!1}),c=new jn(g,x,{type:Mi,depthBuffer:!1,stencilBuffer:!1}));for(let R=0;R<b.length;R++){const v=b[R];v.setSize&&v.setSize(g,x)}},this.begin=function(M,g){if(y||M.toneMapping===_i&&b.length===0)return!1;if(p=g,g!==null){const x=g.width,R=g.height;(o.width!==x||o.height!==R)&&this.setSize(x,R)}return T===!1&&M.setRenderTarget(o),m=M.toneMapping,M.toneMapping=_i,!0},this.hasRenderPass=function(){return T},this.end=function(M,g){M.toneMapping=m,y=!0;let x=o,R=a;for(let v=0;v<b.length;v++){const w=b[v];w.enabled!==!1&&(w.render(M,R,x,g),w.needsSwap!==!1&&(x=R,R=R===a?c:a))}if(f!==M.outputColorSpace||_!==M.toneMapping){f=M.outputColorSpace,_=M.toneMapping,u.defines={},te.getTransfer(f)===de&&(u.defines.SRGB_TRANSFER="");const v=B_[_];v&&(u.defines[v]=""),u.needsUpdate=!0}u.uniforms.tDiffuse.value=x.texture,M.setRenderTarget(p),M.render(d,h),p=null,y=!1},this.isCompositing=function(){return y},this.dispose=function(){o.dispose(),a!==null&&a.dispose(),c!==null&&c.dispose(),l.dispose(),u.dispose()}}const Fd=new un,yc=new no(1,1),Od=new vd,Bd=new Op,zd=new Ed,gh=[],_h=[],vh=new Float32Array(16),xh=new Float32Array(9),Mh=new Float32Array(4);function Ts(n,t,e){const i=n[0];if(i<=0||i>0)return n;const r=t*e;let s=gh[r];if(s===void 0&&(s=new Float32Array(r),gh[r]=s),t!==0){i.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,n[o].toArray(s,a)}return s}function qe(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function Ke(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function Ia(n,t){let e=_h[t];e===void 0&&(e=new Int32Array(t),_h[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function k_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function G_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;n.uniform2fv(this.addr,t),Ke(e,t)}}function H_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(qe(e,t))return;n.uniform3fv(this.addr,t),Ke(e,t)}}function V_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;n.uniform4fv(this.addr,t),Ke(e,t)}}function W_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(qe(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),Ke(e,t)}else{if(qe(e,i))return;Mh.set(i),n.uniformMatrix2fv(this.addr,!1,Mh),Ke(e,i)}}function X_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(qe(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),Ke(e,t)}else{if(qe(e,i))return;xh.set(i),n.uniformMatrix3fv(this.addr,!1,xh),Ke(e,i)}}function $_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(qe(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),Ke(e,t)}else{if(qe(e,i))return;vh.set(i),n.uniformMatrix4fv(this.addr,!1,vh),Ke(e,i)}}function Y_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function q_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;n.uniform2iv(this.addr,t),Ke(e,t)}}function K_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(qe(e,t))return;n.uniform3iv(this.addr,t),Ke(e,t)}}function Z_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;n.uniform4iv(this.addr,t),Ke(e,t)}}function J_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function Q_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;n.uniform2uiv(this.addr,t),Ke(e,t)}}function j_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(qe(e,t))return;n.uniform3uiv(this.addr,t),Ke(e,t)}}function tv(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;n.uniform4uiv(this.addr,t),Ke(e,t)}}function ev(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(yc.compareFunction=e.isReversedDepthBuffer()?Hc:Gc,s=yc):s=Fd,e.setTexture2D(t||s,r)}function nv(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture3D(t||Bd,r)}function iv(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTextureCube(t||zd,r)}function rv(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture2DArray(t||Od,r)}function sv(n){switch(n){case 5126:return k_;case 35664:return G_;case 35665:return H_;case 35666:return V_;case 35674:return W_;case 35675:return X_;case 35676:return $_;case 5124:case 35670:return Y_;case 35667:case 35671:return q_;case 35668:case 35672:return K_;case 35669:case 35673:return Z_;case 5125:return J_;case 36294:return Q_;case 36295:return j_;case 36296:return tv;case 35678:case 36198:case 36298:case 36306:case 35682:return ev;case 35679:case 36299:case 36307:return nv;case 35680:case 36300:case 36308:case 36293:return iv;case 36289:case 36303:case 36311:case 36292:return rv}}function ov(n,t){n.uniform1fv(this.addr,t)}function av(n,t){const e=Ts(t,this.size,2);n.uniform2fv(this.addr,e)}function lv(n,t){const e=Ts(t,this.size,3);n.uniform3fv(this.addr,e)}function cv(n,t){const e=Ts(t,this.size,4);n.uniform4fv(this.addr,e)}function uv(n,t){const e=Ts(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function hv(n,t){const e=Ts(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function dv(n,t){const e=Ts(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function fv(n,t){n.uniform1iv(this.addr,t)}function pv(n,t){n.uniform2iv(this.addr,t)}function mv(n,t){n.uniform3iv(this.addr,t)}function gv(n,t){n.uniform4iv(this.addr,t)}function _v(n,t){n.uniform1uiv(this.addr,t)}function vv(n,t){n.uniform2uiv(this.addr,t)}function xv(n,t){n.uniform3uiv(this.addr,t)}function Mv(n,t){n.uniform4uiv(this.addr,t)}function Sv(n,t,e){const i=this.cache,r=t.length,s=Ia(e,r);qe(i,s)||(n.uniform1iv(this.addr,s),Ke(i,s));let o;this.type===n.SAMPLER_2D_SHADOW?o=yc:o=Fd;for(let a=0;a!==r;++a)e.setTexture2D(t[a]||o,s[a])}function yv(n,t,e){const i=this.cache,r=t.length,s=Ia(e,r);qe(i,s)||(n.uniform1iv(this.addr,s),Ke(i,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||Bd,s[o])}function bv(n,t,e){const i=this.cache,r=t.length,s=Ia(e,r);qe(i,s)||(n.uniform1iv(this.addr,s),Ke(i,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||zd,s[o])}function Ev(n,t,e){const i=this.cache,r=t.length,s=Ia(e,r);qe(i,s)||(n.uniform1iv(this.addr,s),Ke(i,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||Od,s[o])}function wv(n){switch(n){case 5126:return ov;case 35664:return av;case 35665:return lv;case 35666:return cv;case 35674:return uv;case 35675:return hv;case 35676:return dv;case 5124:case 35670:return fv;case 35667:case 35671:return pv;case 35668:case 35672:return mv;case 35669:case 35673:return gv;case 5125:return _v;case 36294:return vv;case 36295:return xv;case 36296:return Mv;case 35678:case 36198:case 36298:case 36306:case 35682:return Sv;case 35679:case 36299:case 36307:return yv;case 35680:case 36300:case 36308:case 36293:return bv;case 36289:case 36303:case 36311:case 36292:return Ev}}class Tv{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=sv(e.type)}}class Av{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=wv(e.type)}}class Rv{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(t,e[a.id],i)}}}const El=/(\w+)(\])?(\[|\.)?/g;function Sh(n,t){n.seq.push(t),n.map[t.id]=t}function Cv(n,t,e){const i=n.name,r=i.length;for(El.lastIndex=0;;){const s=El.exec(i),o=El.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){Sh(e,l===void 0?new Tv(a,n,t):new Av(a,n,t));break}else{let d=e.map[a];d===void 0&&(d=new Rv(a),Sh(e,d)),e=d}}}class na{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=t.getActiveUniform(e,o),c=t.getUniformLocation(e,a.name);Cv(a,c,this)}const r=[],s=[];for(const o of this.seq)o.type===t.SAMPLER_2D_SHADOW||o.type===t.SAMPLER_CUBE_SHADOW||o.type===t.SAMPLER_2D_ARRAY_SHADOW?r.push(o):s.push(o);r.length>0&&(this.seq=r.concat(s))}setValue(t,e,i,r){const s=this.map[e];s!==void 0&&s.setValue(t,i,r)}setOptional(t,e,i){const r=e[i];r!==void 0&&this.setValue(t,i,r)}static upload(t,e,i,r){for(let s=0,o=e.length;s!==o;++s){const a=e[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,r)}}static seqWithValue(t,e){const i=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&i.push(o)}return i}}function yh(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const Pv=37297;let Dv=0;function Lv(n,t){const e=n.split(`
`),i=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return i.join(`
`)}const bh=new Bt;function Iv(n){te._getMatrix(bh,te.workingColorSpace,n);const t=`mat3( ${bh.elements.map(e=>e.toFixed(4))} )`;switch(te.getTransfer(n)){case ca:return[t,"LinearTransferOETF"];case de:return[t,"sRGBTransferOETF"];default:return Nt("WebGLProgram: Unsupported color space: ",n),[t,"LinearTransferOETF"]}}function Eh(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),s=(n.getShaderInfoLog(t)||"").trim();if(i&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return e.toUpperCase()+`

`+s+`

`+Lv(n.getShaderSource(t),a)}else return s}function Nv(n,t){const e=Iv(t);return[`vec4 ${n}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}const Uv={[nd]:"Linear",[id]:"Reinhard",[rd]:"Cineon",[Nc]:"ACESFilmic",[od]:"AgX",[ad]:"Neutral",[sd]:"Custom"};function Fv(n,t){const e=Uv[t];return e===void 0?(Nt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Yo=new A;function Ov(){te.getLuminanceCoefficients(Yo);const n=Yo.x.toFixed(4),t=Yo.y.toFixed(4),e=Yo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Bv(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ks).join(`
`)}function zv(n){const t=[];for(const e in n){const i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function kv(n,t){const e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(t,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:n.getAttribLocation(t,o),locationSize:a}}return e}function ks(n){return n!==""}function wh(n,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_SUN_LIGHTS/g,t.numSunLights).replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_SUN_LIGHT_SHADOWS/g,t.numSunLightShadows).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Th(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Gv=/^[ \t]*#include +<([\w\d./]+)>/gm;function bc(n){return n.replace(Gv,Vv)}const Hv=new Map;function Vv(n,t){let e=Xt[t];if(e===void 0){const i=Hv.get(t);if(i!==void 0)e=Xt[i],Nt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+t+">")}return bc(e)}const Wv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ah(n){return n.replace(Wv,Xv)}function Xv(n,t,e,i){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Rh(n){let t=`precision ${n.precision} float;
...
#define LOW_PRECISION`),t}const $v={[Jo]:"SHADOWMAP_TYPE_PCF",[zs]:"SHADOWMAP_TYPE_VSM"};function Yv(n){return $v[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const qv={[yr]:"ENVMAP_TYPE_CUBE",[ms]:"ENVMAP_TYPE_CUBE",[Ra]:"ENVMAP_TYPE_CUBE_UV"};function Kv(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":qv[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const Zv={[ms]:"ENVMAP_MODE_REFRACTION"};function Jv(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":Zv[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Qv={[ed]:"ENVMAP_BLENDING_MULTIPLY",[tp]:"ENVMAP_BLENDING_MIX",[ep]:"ENVMAP_BLENDING_ADD"};function jv(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":Qv[n.combine]||"ENVMAP_BLENDING_NONE"}function tx(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function ex(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=Yv(e),l=Kv(e),u=Jv(e),d=jv(e),h=tx(e),f=Bv(e),_=zv(s),y=r.createProgram();let m,p,b=e.glslVersion?"#version "+e.glslVersion+`
...
<div id="money-stream"></div><div id="status-bar" role="status"><div id="status-main"><b id="hint-key">E</b><span><small id="status-kicker">NEXT ACTION</small><strong id="nav-label">Job board</strong><em id="nav-distance"></em></span></div><div id="notice"><b id="notice-icon"><svg viewBox="0 0 36 36" aria-hidden="true"><path d="M15.2 4.8 Q18 1 20.8 4.8 L33.8 28.2 Q36 33 31 33 H5 Q0 33 2.2 28.2 Z" fill="#c83d39"/></svg><span>!</span></b><span id="notice-text"></span></div><div id="purchase" hidden><strong id="purchase-name"></strong><div class="progress"><i id="purchase-progress"></i></div><small id="purchase-detail">STAND STILL TO INVEST</small></div></div><aside id="tutorial-card" hidden><small>TUTORIAL</small><h2 id="tutorial-title"></h2><ul id="tutorial-points"></ul><div class="tutorial-actions"><button id="tutorial-skip">Skip tutorial</button><button id="tutorial-next">Got it</button></div></aside><nav id="camera-controls"><button id="camera-follow" title="Follow">◎</button><button id="zoom-in">＋</button><button id="zoom-out">−</button><button id="help">?</button></nav><button id="stuck-button" hidden>Got stuck?</button><footer><button data-action="interact"><b>E</b><span>Interact</span></button><button data-action="cab"><b>F</b><span>Cab</span></button><button data-action="rotate"><b>R</b><span>Rotate</span></button><button data-action="rear"><b>G</b><span>Rear</span></button></footer><dialog id="dialog"></dialog>`;document.querySelector("footer")?.insertAdjacentHTML("beforeend",'<button data-action="secure"><b>Q</b><span>Secure</span></button>');document.documentElement.style.setProperty("--premium-color",ve.color);et("#job-count").insertAdjacentHTML("afterend",'<div id="job-score"></div>');let nf=!1,W=$d(),jt=null;for(const n of["movecraft-rewrite-v1","movecraft-update-backup"])try{const t=Qi.getItem(n);if(t){jt=JSON.parse(t);break}}catch{}try{if(jt?.company&&(W=tM(jt.company)),jt&&jt.worldVersion!==2){const n=t=>{t[0]>120?t[0]+=Oh.destination-144:t[0]>45&&(t[0]+=Oh.pickup-72)};for(const t of jt.loads??[])t.mode!=="truck"&&n(t.position);jt.truck&&(jt.truck.position=[0,0,0],jt.truck.yaw=0),jt.player=[-6,0,1],jt.navLeg="",jt.navIndex=0,jt.navPath=[],jt.worldVersion=2}}catch{}let wr=!0,Tr=!0,Ms=!0,Ss=!0,vi=.35,Rl=!0,so=null;try{const n=JSON.parse(Qi.getItem("movecraft-audio-v1")??"{}");wr=n.effects??wr,Tr=n.ambient??Tr,Ms=n.music??Ms,Ss=n.vehicle??Ss,vi=n.volume??vi}catch{}Lf(()=>{so&&lf()});const Pe=new Xp;Pe.background=new qt(13032672);Pe.fog=new Xc(13032672,115,215);const Ei=new Ix({antialias:!0});Ei.setPixelRatio(Math.min(devicePixelRatio,1.5));Ei.shadowMap.enabled=!0;Ei.shadowMap.type=Qh;Ei.toneMapping=Nc;Ei.toneMappingExposure=1.15;et("#world").appendChild(Ei.domElement);const Oe=new Da(-18,18,12,-12,.1,450);Oe.position.set(22,29,26);Oe.zoom=.78;const gn=new Ux(Oe,Ei.domElement);gn.enablePan=!1;gn.enableDamping=!0;gn.minZoom=.55;gn.maxZoom=3.5;gn.minPolarAngle=.35;gn.maxPolarAngle=1.03;Pe.add(new Cm(16775135,6588822,2));const ki=new Lm(16772305,2.7);ki.position.set(-25,45,20);ki.castShadow=!0;ki.shadow.mapSize.set(2048,2048);Object.assign(ki.shadow.camera,{left:-32,right:32,top:32,bottom:-32,near:.1,far:100});ki.shadow.normalBias=.035;Pe.add(ki,ki.target);const Ua=uM();Pe.add(Ua.root);const ys=new me;ys.name="navigation-route-guide";Pe.add(ys);const rf=7.2,sf=()=>Te+6,ji=new me;ji.name="navigation-parking-guide";const of=new ri({color:16768099,transparent:!0,opacity:.68,depthWrite:!1,side:an,polygonOffset:!0,polygonOffsetFactor:-3}),Fa=new Ft(new si(rf,1),of);Fa.rotation.x=-Math.PI/2;Fa.position.y=.105;ji.add(Fa);ji.visible=!1;Pe.add(ji);let Zo="",Gt=nu(0,W.levels.truck,0),yn=Gt.fromSite.x,ln=Gt.fromSite.z??0,Tn=Gt.toSite.x,hn=Gt.toSite.z??0,gr=jd(W),Bn=xs(yn,Gt.fromSite.variant,!1,ln),ni=xs(Tn,Gt.toSite.variant,!0,hn);Pe.add(gr.root,Bn.root,ni.root);const _r=Hd(15313475),ot=_r.root;function ga(){const n=Hd(15313475,0,W.selectedSkins.person,W.levels.worker),t=_r.root.userData.rig?.body;t&&(ot.remove(t),ei(t));const e=n.root.userData.rig.body;n.root.remove(e),ot.add(e),_r.root.userData.rig=n.root.userData.rig,_r.animate=n.animate}ga();ot.position.set(-6,0,1);Pe.add(ot);const ru=new Ft(new Qc(.38,.46,32),new ri({color:16773043,side:an}));ru.rotation.x=-Math.PI/2;ru.position.y=.04;ot.add(ru);let At,Te=4.2,Dn=5,Ve=!1,je=!1,zt=null,Qt=!1,Ie=0,Gs=0,Cl=100,vr=1,Bi=1,Tc=0,_a=0,xe=null;const ee=[],tr=[];let Ln=!1;const ts=new me;ts.name="cargo-safety-net";let ze=null,Wn=[];const Ac=new Map,Kn=new Ft(new si(1,1),new ri({color:16763725,transparent:!0,opacity:.82,side:an,depthWrite:!1}));Kn.rotation.x=-Math.PI/2;Kn.position.y=.095;Kn.visible=!1;Kn.renderOrder=4;Pe.add(Kn);const Ni=new Ft(new si(1,1),new ri({color:13974845,transparent:!0,opacity:.72,side:an,depthWrite:!1}));Ni.rotation.x=-Math.PI/2;Ni.position.y=.105;Ni.visible=!1;Ni.renderOrder=5;Pe.add(Ni);let bs=0,Yn=0,xr="",tn=0,kt=Number(jt?.tutorialStep??0),we=0,Pl=0,Dl=0,va=0,Mn=0,Rc=0,ra="",sa="",kh=-1,os=-10,es=!1,Xn=0,Zn=!1,Ys=0;const Zi=[],Cc=[],Pc=[],vM=ot.position.clone(),af=new A,Li=new A,Ne=new Set,su=new A(0,1,0),Fn=new Ft(new nr(1,.04,1),new ri({color:2981988,transparent:!0,opacity:.58,depthTest:!0,depthWrite:!1}));Pe.add(Fn);Fn.renderOrder=10;const ou=new Sc(new om(Fn.geometry),new qc({color:1527614,depthTest:!0,depthWrite:!1}));ou.renderOrder=11;Fn.add(ou);Fn.visible=!1;let hi=[],Mr=[],ns=null;const ii=n=>At.userData.cargo.localToWorld(n.clone()),wi=n=>At.userData.cargo.worldToLocal(n.clone()),qs=n=>At.localToWorld(n.clone());let Ks=null,xa=null,Ma=null,as=null,ls=null,Gh=-1,Hh=-1,Vh=-1,Wh=-1;function Bs(){Qi.setItem("movecraft-audio-v1",JSON.stringify({effects:wr,ambient:Tr,music:Ms,vehicle:Ss,volume:vi}))}function au(){const n=so??(so=new AudioContext);if(n.resume(),Ks)return n;const t=n.createBuffer(1,n.sampleRate*2,n.sampleRate),e=t.getChannelData(0);for(let s=0;s<e.length;s++)e[s]=(Math.random()*2-1)*.24;const i=n.createBufferSource();i.buffer=t,i.loop=!0;const r=n.createBiquadFilter();return r.type="lowpass",r.frequency.value=720,Ks=n.createGain(),i.connect(r).connect(Ks).connect(n.destination),i.start(),ls=n.createOscillator(),ls.type="sine",xa=n.createGain(),ls.connect(xa).connect(n.destination),ls.start(),as=n.createOscillator(),as.type="sawtooth",Ma=n.createGain(),as.connect(Ma).connect(n.destination),as.start(),n}function Ar(n){if(!wr||Jh())return;const t={coin:[660,880],purchase:[520,780,1040],reward:[620,880,1175],error:[220,165],door:[300,225]}[n],e=au();t.forEach((i,r)=>{const s=e.createOscillator(),o=e.createGain(),a=e.currentTime+r*.07;s.type=n==="error"||n==="door"?"triangle":"sine",s.frequency.setValueAtTime(i,a),o.gain.setValueAtTime(1e-4,a),o.gain.exponentialRampToValueAtTime(Math.max(.001,vi*.09),a+.012),o.gain.exponentialRampToValueAtTime(1e-4,a+.13),s.connect(o).connect(e.destination),s.start(a),s.stop(a+.14)})}function lf(){if(!so||!Ks||!xa||!Ma||!as||!ls)return;const n=so.currentTime;Ks.gain.setTargetAtTime(Tr?vi*.065:0,n,.25),xa.gain.setTargetAtTime(Ms?vi*.042:0,n,.25),Ma.gain.setTargetAtTime(Ss&&Qt?vi*(.012+Math.min(1,Math.abs(Ie)/10)*.055):0,n,.12),as.frequency.setTargetAtTime(58+Math.abs(Ie)*13,n,.12);const t=Math.floor(we/1.5);t!==Gh&&(Gh=t,ls.frequency.setTargetAtTime([174.6,220,196,261.6,174.6,233,196,146.8][t%8],n,.16));const e=Math.floor(we/11);Tr&&e!==Hh&&(Hh=e,e>0&&oi(1050+e%3*120,.06))}function oi(n=500,t=.1){if(!(!wr||Jh()))try{const e=au(),i=e.createOscillator(),r=e.createGain();i.frequency.value=n,r.gain.setValueAtTime(vi*.1,e.currentTime),r.gain.exponentialRampToValueAtTime(.001,e.currentTime+t),i.connect(r).connect(e.destination),i.start(),i.stop(e.currentTime+t)}catch{}}function Vt(n){et("#notice-text").textContent=n;const t=/^(No |There |Clear |Park |Stand |Move around|Step |Brake |Stop |Finish |Cannot|Can't|The driver door|This furniture|Place .* on)/i.test(n);et("#notice").classList.toggle("error",t),t&&we-Wh>1.2&&(Wh=we,Ar("error")),va=4,et("#status-bar").classList.add("show-notice")}function ir(n){Ne.clear();const t=!n.includes('class="reward-modal"');et("#dialog").innerHTML=`${t?'<button class="close" aria-label="Close">×</button>':""}${n}`,et("#dialog").open||et("#dialog").showModal(),t&&(et("#dialog .close").onclick=()=>et("#dialog").close())}const Jn=[["Welcome to MOVING EMPIRE",["Walk with W A S D; Shift makes you sprint","The top bar tells you the next useful action","We will introduce the controls in two complete groups"],"#status-bar"],["The whole Actions bar",["The row at the bottom contains every action","E interacts and places · F enters or leaves the cab · R rotates furniture","G moves the rear ramp · Q secures the entire load with a net","The same letters work on a keyboard; tap the buttons on touchscreens"],"footer"],["The whole Camera bar",["The four buttons on the left only change your view","◎ follows you again · + zooms in · − zooms out · ? opens help","Drag the scene to look around. These controls do not move your character"],"#camera-controls"],["Accept your first move",["The card on the right is your job panel","Walk onto the marked job field to accept a move"],"#job-card"],["Money and price fields",["Coins and Jems are shown together in the upper-left corner","Coins pay for upgrades: stand still on a marked price field to invest them","The field fills as you pay. A confirmation window opens when the upgrade is ready","Jems are earned from moves and daily gifts; they buy skins or coins in the shop"],".wallet"]],Zs=[["Choose your reward",["The completion window shows score and item damage","Collect coins now or use the video option for the shown bonus","Damage lowers coins and Jems"],"#job-card"],["The top task bar",["Shows the single action to do next","A red ! warns when something blocks an action","Follow the fixed blue ground arrows while driving"],"#status-bar"],["Your money",["Coins pay for upgrades","Jems buy skins and can be exchanged for coins"],".wallet"],["The Shop",["🛒 opens three tabs: daily gifts, coins & Jems, and skins","Claim one gift per day; a missed day restarts the streak","Skin purchases change looks, not upgrade levels"],"#daily-button"],["Coins and Jems",["The shop exchanges 10 Jems for 2,000 coins","The Jems video is an in-game preview until real ads are connected","Coins cannot buy Jems"],"#daily-button"],["Settings",["⚙ opens sound, city ambience, music and vehicle audio switches","It also has display quality, safe update and Replay tutorial","Got stuck? moves you to a safe road"],"#settings"],["Your job panel",["Shows the current task, cargo count, score and payment","Tap its heading to fold or open it"],"#job-card"],["Upgrade fields",["Stand still on a price field to pay","The large field fills as coins are invested","A window lists exactly what changed when complete"],"#status-bar"],["Your company",["▥ opens progress, employee trucks and their income","Truck size, worker strength and base level are upgrades, separate from skins"],"#company-toggle"],["Game mode",["NORMAL uses earned coins and Jems","DEV provides test money and the development workbench"],"#mode-toggle"],["Development tools",["🧪 appears in DEV mode and opens job, delivery and upgrade tests","Use NORMAL for your saved career"],"#mode-toggle"]],gi=10,dr=gi+Zs.length;function ho(){const n=kt>=dr,t=!et("#tutorial-card").hidden;document.body.classList.toggle("tutorial-active",t),document.body.dataset.tutorialStep=String(kt),document.body.dataset.tutorialStage=t?kt<=2?"intro":kt===3?"job":kt===4?"money":kt>=gi?"final":"move":"off",document.body.classList.toggle("tutorial-camera-introduced",kt>=2),document.body.classList.toggle("tutorial-shop-introduced",kt>=gi+3),document.body.classList.toggle("tutorial-settings-introduced",kt>=gi+5);const e=new Set(n||kt>=1?["interact","cab","rotate","rear","secure"]:[]);document.querySelectorAll("footer [data-action]").forEach(i=>i.classList.toggle("tutorial-hidden",!e.has(i.dataset.action)))}function fo(){const n=et("#tutorial-card"),t=et("#camera-controls");if(n.hidden){n.style.top="",n.style.maxHeight="",t.style.top="",t.style.transform="",t.style.visibility="",et("#right-rail").style.top="";return}const e=document.querySelector("#right-rail .tutorial-focus");if(innerWidth<=700&&document.body.dataset.tutorialStage==="final"&&e){const c=Math.ceil(e.getBoundingClientRect().bottom+12);n.style.top=`${c}px`,n.style.maxHeight=`${Math.max(150,innerHeight-c-94)}px`}else n.style.top="",n.style.maxHeight="";const i=n.getBoundingClientRect(),r=t.getBoundingClientRect(),s=et("footer").getBoundingClientRect().top,o=s-5;document.body.dataset.tutorialStage==="job"&&innerWidth<=700?et("#right-rail").style.top=`${Math.ceil(i.bottom+12)}px`:et("#right-rail").style.top="";const a=i.bottom+7;if(a+r.height>o){t.style.visibility="hidden";return}t.style.visibility="",t.style.top=`${a}px`,t.style.transform="none"}new ResizeObserver(fo).observe(et("#tutorial-card"));window.addEventListener("resize",fo);function fi(n,t,e="Got it",i=""){document.body.classList.remove("tutorial-exit","tutorial-exit-skip"),document.querySelectorAll(".tutorial-focus").forEach(r=>r.classList.remove("tutorial-focus")),et("#tutorial-title").textContent=n,et("#tutorial-points").innerHTML=t.map(r=>`<li>${r}</li>`).join(""),et("#tutorial-next").textContent=e,et("#tutorial-card").hidden=!1,et("#tests").hidden=!0,ho(),i&&document.querySelector(i)?.classList.add("tutorial-focus"),fo()}function cf(n=!1){document.body.classList.remove("tutorial-exit","tutorial-exit-skip"),document.body.offsetWidth,document.body.classList.toggle("tutorial-exit-skip",n),document.body.classList.add("tutorial-exit"),window.setTimeout(()=>document.body.classList.remove("tutorial-exit","tutorial-exit-skip"),1800)}function fs(n){W.jobs>0&&kt<gi&&(kt=gi),n==="job"&&kt<=5?(kt=6,fi("Follow the route",["Blue arrows show the way"],"Got it","#status-bar")):n==="lift"&&kt<=6?(kt=7,fi("Load furniture",["Green = fits · red = blocked","E places · R rotates"],"Got it",'[data-action="interact"]')):n==="loaded"&&kt<=7?(kt=8,fi("Get in the truck",["F · enter the cab"],"Got it",'[data-action="cab"]')):n==="cab"&&kt<=8?(kt=9,fi("Secure and drive",["Stand at the rear and press Q once to cover all cargo with a net","The net protects furniture from driving damage","W/S drives · A/D steers"],"Got it","#status-bar")):n==="delivered"&&kt<=9?(kt=9,fi("Finish the move",["Park in the yellow bay","Then choose your reward"],"Got it","#job-card")):n==="paid"&&kt<=gi&&(kt=gi,fi(Zs[0][0],Zs[0][1],"Next",Zs[0][2])),ho(),De()}et("#tutorial-next").onclick=()=>{if(kt<Jn.length-1)kt++,fi(Jn[kt][0],Jn[kt][1],"Got it",Jn[kt][2]);else if(kt>=gi&&kt<dr-1){kt++;const n=Zs[kt-gi];fi(n[0],n[1],kt===dr-1?"Finish tutorial":"Next",n[2])}else kt===Jn.length-1?kt=5:kt===dr-1&&(kt=dr),et("#tutorial-card").hidden=!0,fo(),document.querySelectorAll(".tutorial-focus").forEach(n=>n.classList.remove("tutorial-focus"));ho(),kt===dr&&cf(),De()};et("#tutorial-skip").onclick=()=>{kt=dr,et("#tutorial-card").hidden=!0,fo(),document.querySelectorAll(".tutorial-focus").forEach(n=>n.classList.remove("tutorial-focus")),ho(),cf(!0),De()};function oo(){const n=At,t=n?.position.clone()??new A,e=n?.rotation.clone()??new yi;for(const o of ee)o.mode==="truck"&&Pe.attach(o.mesh);n&&ei(n),Dn=ma(W.levels.truck),Te=.2+Dn*.8,At=Wd(Dn,W.levels.truck,W.selectedSkins.truck),At.position.copy(t),At.rotation.copy(e),Pe.add(At);for(const o of ee)o.mode==="truck"&&(At.userData.cargo.add(o.mesh),o.mesh.position.copy(o.position));Dr();const i=new me;i.position.set(4.69,.35,-1.95),D(i,0,.55,.65,.06,1.1,1.28,At.userData.bodyColor,!0),D(i,0,1.4,.65,.06,.62,1.28,3495010,!0);const r=D(i,.035,1.4,.65,.025,.48,1.02,9091781);r.material=new _s({color:8895944,transparent:!0,opacity:.38,roughness:.12}),D(i,-.035,.68,.65,.035,.34,.95,7692094,!0);for(const o of[.04,1.26])D(i,.055,.85,o,.08,1.7,.06,3230808,!0);D(i,.075,.78,1.02,.035,.08,.24,2506569,!0),At.add(i);const s=i.clone(!0);s.position.x=1.31,s.scale.x=-1,At.add(s),At.userData.cabDoor=i,uf(),n&&za()}function xM(){ei(gr.root),gr=jd(W),Pe.add(gr.root),co(),zn(),za()}function uf(){const n=e=>e*e*(3-2*e),t=n(ue.clamp(vr*2,0,1));At.userData.rampPivot.rotation.x=ue.lerp(-Math.PI/2,Math.atan(.78/2.2),t),At.userData.cabDoor&&(At.userData.cabDoor.rotation.y=n(Tc)*1.42)}function Es(n){n.mode==="truck"?(At.userData.cargo.add(n.mesh),n.mesh.position.copy(n.position)):n.mode==="hand"?(ot.add(n.mesh),n.mesh.position.set(0,.95,lo(n))):(Pe.add(n.mesh),n.mesh.position.copy(n.position)),n.mesh.rotation.set(0,n.item.rotated?Math.PI/2:0,0)}function Dr(){for(const c of[...ts.children])c instanceof Sc?(c.geometry.dispose(),c.material.dispose(),c.removeFromParent()):ei(c);At.userData.cargo.add(ts);const n=ee.filter(c=>c.mode==="truck");for(const c of n)c.secured=Ln;if(!Ln||!n.length)return;for(const c of n){const[l,u]=Qe(c.item),d=new Ft(new si(l*Ut-.06,u*Ut-.06),new ri({color:5548651,transparent:!0,opacity:.2,depthWrite:!1,side:an}));d.rotation.x=-Math.PI/2,d.position.set(c.position.x,.805,c.position.z),d.userData.owned=!0,ts.add(d)}At.updateMatrixWorld(!0);const t=Math.max(1.04,...n.map(c=>new Cr().setFromObject(c.mesh).max.y-At.position.y+.24));ts.userData.clearance=t;const e=[],i=Array.from({length:9},(c,l)=>1.35+l*3.3/8),r=Array.from({length:Dn*2+1},(c,l)=>.2+l*Ut/2),s=(c,l)=>e.push(...c.toArray(),...l.toArray());for(const c of r)for(let l=0;l<i.length-1;l++)s(new A(i[l],t,c),new A(i[l+1],t,c));for(const c of i)for(let l=0;l<r.length-1;l++)s(new A(c,t,r[l]),new A(c,t,r[l+1]));for(const c of[i[0],i.at(-1)])for(const l of[r[0],r.at(-1)])s(new A(c,.94,l),new A(c,t,l));const o=new Fe;o.setAttribute("position",new ie(e,3));const a=new Sc(o,new qc({color:16118761,transparent:!0,opacity:.95}));a.userData.owned=!0,ts.add(a)}function MM(){const n=wi(ot.position);if(Qt||zt||ze||Math.hypot(n.x-3,n.z-Te)>3.1)return Vt("Stand at the rear of the truck to secure the load.");if(!ee.some(t=>t.mode==="truck"))return Vt("Load furniture before securing the net.");Ln=!Ln,Dr(),Vt(Ln?"Cargo net secured over the entire load.":"Cargo net opened for loading."),oi(Ln?600:350),De()}function Sa(n=!1){if(Ve&&!je&&!n)return Vt("Finish this move and collect payment first.");Rc=0;const t=`${Gt.fromSite?.id??""}->${Gt.toSite?.id??""}`;for(const s of ee)ei(s.mesh);ee.length=0,tr.length=0,Ln=!1,Dr(),zt=null,ze=null,bs=W.jobs;const e=Yn;do Yn=Math.floor(Math.random()*7);while(Yn===e);xr="",tn=0;const i=Math.max(W.jobs,Math.floor((W.levels.truck+W.levels.worker)*.45));let r=0;do Gt=nu(i,W.levels.truck,W.jobs*11+Yn+r++);while(`${Gt.fromSite.id}->${Gt.toSite.id}`===t&&r<10);Ve=!0,je=!1,yn=Gt.fromSite.x,ln=Gt.fromSite.z??0,Tn=Gt.toSite.x,hn=Gt.toSite.z??0,ei(Bn.root),ei(ni.root),Bn=xs(yn,Gt.fromSite.variant+Yn,!1,ln),ni=xs(Tn,Gt.toSite.variant+Yn,!0,hn),Pe.add(Bn.root,ni.root),hf(),Dc();for(const s of Gt.items){const o={item:s,mesh:Vd(s.model),mode:"ground",position:new A(yn+s.pickupX,.12,ln+s.pickupZ),velocity:new A,angular:new A,hitAt:-10,settled:!0,secured:!1,damage:0};ee.push(o),Es(o)}zn(),Vt(`New move: ${Gt.from} → ${Gt.to}. Follow the ground arrows.`),fs("job"),De()}function rr(){return Ve&&ee.length>0&&ee.every(n=>n.mode==="delivered")}function hf(){const n=[],t=new Set,e=[...Gt.items].sort((i,r)=>r.w*r.d-i.w*i.d||i.id-r.id);for(const i of e){const r=i.w*Ut+.32,s=i.d*Ut+.32,o=[];for(let l=ln-4.5+s/2;l<=ln+4.45-s/2;l+=.48)for(let u=yn-10.25+r/2;u<=yn-.95-r/2;u+=.48)o.push({x:u,z:l,rank:Math.sin(i.id*17.37+u*8.1+l*3.7)});o.sort((l,u)=>l.rank-u.rank);const a=({x:l,z:u},d)=>!Bn.barriers.some(h=>Math.abs(l-h.x)<(r+h.w)/2+d&&Math.abs(u-h.z)<(s+h.d)/2+d)&&!n.some(h=>Math.abs(l-h.x)<(r+h.w)/2+d&&Math.abs(u-h.z)<(s+h.d)/2+d);let c=o.find(l=>a(l,.18))??o.find(l=>a(l,.035));if(!c){const l=[];for(let u=ln+5.7+s/2;u<=ln+8.2-s/2;u+=.2)for(let d=yn-10+r/2;d<=yn-1.2-r/2;d+=.35)l.push({x:d,z:u});c=l.find(u=>a(u,.04))}c?(i.pickupX=c.x-yn,i.pickupZ=c.z-ln,n.push({x:c.x,z:c.z,w:r,d:s})):t.add(i.id)}t.size&&(Gt.items=Gt.items.filter(i=>!t.has(i.id)),Gt.reward=Math.round(Gt.items.reduce((i,r)=>i+r.value,0)*(1+(Gt.difficulty-1)*.07)))}function Dc(){Ac.clear();const n=ee.filter(r=>r.mode==="delivered").map(r=>({x:r.position.x,z:r.position.z,w:r.item.w*Ut,d:r.item.d*Ut})),t=Tn-10.1,e=hn-4.9,i=(bs*7+Yn*3)%11;for(const r of[...Gt.items].sort((s,o)=>o.w*o.d-s.w*s.d||s.id-o.id)){if(ee.some(o=>o.item.id===r.id&&o.mode==="delivered"))continue;let s;for(const o of[.18,.02])for(let a=0;a<121&&!s;a++){const c=(Math.floor(a/11)*3+i)%11,l=(a*7+i*2)%11;if(c>11-r.d||l>11-r.w)continue;const u=t+(l+r.w/2)*Ut,d=e+(c+r.d/2)*Ut,h=r.w*Ut/2,f=r.d*Ut/2,_=ni.barriers.some(m=>Math.abs(u-m.x)<h+m.w/2+o&&Math.abs(d-m.z)<f+m.d/2+o),y=n.some(m=>Math.abs(u-m.x)<h+m.w/2+o&&Math.abs(d-m.z)<f+m.d/2+o);!_&&!y&&(s=new A(u,.12,d),n.push({x:u,z:d,w:h*2,d:f*2}))}s&&Ac.set(r.id,s)}}function df(n){const t=Ac.get(n.item.id);if(!t)return null;const e=ot.position.clone().add(new A(0,0,1.1).applyQuaternion(ot.quaternion));return{target:t,close:Math.min(Math.hypot(e.x-t.x,e.z-t.z),Math.hypot(ot.position.x-t.x,ot.position.z-t.z))<1.5}}function ff(n){return n.x>Tn-10.5&&n.x<Tn-.5&&n.z>hn-5&&n.z<hn+4.9}function lu(){return ii(new A(3,0,(Te-2.2)/2))}function Oa(){const n=ee.some(s=>s.mode==="ground"&&!s.fallen),t=!Ve||je?"yard":n?"pickup":"delivery";if(t==="yard")return{leg:t,point:new A(2,0,-15)};const i=(t==="pickup"?yn:Tn)+4,r=t==="pickup"?ln:hn;return{leg:t,point:new A(i,0,r-2.1)}}function cu(n=Oa().point){if(Math.abs(Ie)>=.35)return!1;const t=rf/2,e=sf()/2;for(const i of[.8,5.2])for(const r of[-2.35,Te+.25]){const s=ii(new A(i,0,r));if(Math.abs(s.x-n.x)>t||Math.abs(s.z-n.z)>e)return!1}return!0}function ya(){return Math.round(Gt.reward*Math.max(.5,ao()/100))}function ao(){return Math.max(0,100-ee.reduce((n,t)=>n+(t.damage??0),0))}function pf(){const n=new Map;for(const t of tr){const e=`${t.item} · ${t.reason}`;n.set(e,(n.get(e)??0)+t.points)}return[...n].map(([t,e])=>`<li><span>${t}</span><b>−${e}</b></li>`).join("")}function Lc(n=1){if(!rr()||je)return;const t=ya()*n;Na(W,t);const e=mM(ao());W.jems+=e,W.jobs++,je=!0,zn(),oi(880,.3),Ar("reward"),Vt(`+$${t} · +${e} ${ve.name} · Move completed!`),fs("paid"),De()}function ba(){!rr()||je||et("#dialog").open||!et("#tutorial-card").hidden||(ir(`<div class="reward-modal"><small>MOVE COMPLETE</small><h2>$${ya().toLocaleString("en-US")}</h2><p>${Gt.from} → ${Gt.to}</p><p>Care score: ${ao()}/100 · −${100-ao()} points</p>${tr.length?`<ul class="damage-list">${pf()}</ul>`:"<p>No cargo damage.</p>"}<button id="claim-normal">Collect money</button>${`<button id="claim-double">▶ Watch video · collect $${(ya()*2).toLocaleString("en-US")}</button>`}<p class="fine">The reward video is a short in-game preview.</p></div>`),et("#claim-normal").onclick=()=>{et("#dialog").close(),Lc(1)},et("#claim-double").onclick=()=>{const n=et("#dialog");n.innerHTML='<div class="reward-video"><b>MOVING EMPIRE</b><p>Your crew makes every move count.</p><div class="progress"><i></i></div></div>',window.setTimeout(()=>{n.close(),Lc(2)},3e3)})}function SM(){if(W.levels.truck<bn.truck)return"truck"}function Ll(){if(!(W.levels.truck<bn.truck)){if(W.levels.yard<bn.yard&&W.fleet.length>=W.levels.yard)return"yard";if(W.levels.hire<bn.hire&&W.fleet.length<W.levels.yard)return"hire";if(Kd(W)&&!W.finished)return"factory"}}function yM(n){if(W.test)return 0;if(n.income!==void 0)return Math.min(1,Mn/.8);if(n.upgrade)return Math.min(1,(W.contributions[n.upgrade]??0)/vs(W,n.upgrade));if(n.fleet!==void 0){const t=W.fleet[n.fleet];return t?Math.min(1,(t.contribution??0)/(1e3*(t.level+1))):0}return Math.min(1,Mn/1.8)}function zn(){for(const i of hi)ei(i.root);hi=[];const n=(i,r,s,o,a,c,l=0)=>{const u=zh(r,s,0,0,7589002,l);u.position.copy(o),Pe.add(u),hi.push({key:i,root:u,position:o,upgrade:a,fleet:c})};n("job","NEXT MOVE",Ve&&!je?"ACTIVE":"ACCEPT",new A(-10,.06,1)),hi[hi.length-1].root.visible=!Ve||je,W.finished&&(hi[hi.length-1].root.visible=!1);const t={truck:new A(-.45,.06,-1.25),worker:new A(-20,.06,-4.8),yard:new A(-8,.06,-20.7),factory:new A(15,.06,-15)},e=[SM(),W.levels.worker<bn.worker?"worker":void 0,Ll()==="hire"?void 0:Ll()].filter((i,r,s)=>!!i&&s.indexOf(i)===r);for(const i of e){const r=vs(W,i),s=(W.contributions[i]??0)/r;n(i,Er[i],W.test?"FREE":`$${r.toLocaleString("en-US")}`,t[i],i,void 0,s)}if(Ll()==="hire"){const i=W.fleet.length,r=vs(W,"hire");n("hire",`HIRE CREW ${i+1}`,W.test?"FREE":`$${r.toLocaleString("en-US")}`,new A(8+i*4.8,.06,-16.5),"hire",void 0,(W.contributions.hire??0)/r)}W.fleet.forEach((i,r)=>{if((i.pending??0)>0){const s=zh("COLLECT CREW",`$${i.pending}`,0,0,7589002,0),o=new A(8+r*4.8,.05,-19.5);s.position.copy(o),Pe.add(s),hi.push({key:`income-${r}`,root:s,position:o,income:r})}if(i.level<4){const s=(i.level+1)*1e3;n(`fleet-${r}`,`TRUCK ${r+2} · LV ${i.level}`,W.test?"FREE":`$${s.toLocaleString("en-US")}`,new A(8+r*4.8,.05,-16.5),void 0,r,(i.contribution??0)/s)}})}function mf(n){const t=W.levels[n],e=eM(W,n);if(e)return Vt(e);Ar("purchase"),n==="truck"&&oo(),n==="worker"&&ga(),["yard","hire"].includes(n)?xM():zn(),oi(700,.2);const i={truck:[`Loading deck: ${ma(t)} → ${ma(W.levels.truck)} rows`,`Top speed: ${Math.round((8.5+t*1.3)*3.6)} → ${Math.round((8.5+W.levels.truck*1.3)*3.6)} km/h`,W.levels.truck===1?"Cab and roof added":W.levels.truck===2?"More enclosed body panels":W.levels.truck===3?"Cargo body reinforced":W.levels.truck===4?"Full-height enclosed body completed":"Trailer length and load capacity increased",...W.levels.truck>=bn.truck?["Company-base upgrade unlocked"]:[]],worker:[`Worker level: ${t} → ${W.levels.worker}`,"More stamina before resting","Furniture carrying speed increased"],yard:[`Base level ${W.levels.yard}`,"One new employee parking bay",`${W.levels.yard} bays available`],hire:[`${W.fleet.length} crews employed`,"New employee added","New employee truck included"],factory:["MOVING EMPIRE completed","Furniture company purchased","Coming soon!"],cargo:["Included in the central truck upgrade"],gear:["Included in the central truck upgrade"],fleet:["Employee truck upgraded"]};W.levels[n]>t&&ir(`<div class="upgrade-modal"><small>UPGRADE COMPLETE</small><div class="upgrade-badge">✓</div><h2>${Er[n]}</h2><ul>${i[n].map(r=>`<li>${r}</li>`).join("")}</ul><button class="modal-ok">Continue</button></div>`),document.querySelector(".modal-ok")?.addEventListener("click",()=>et("#dialog").close()),Vt(`${Er[n]} · Level ${W.levels[n]}`),De()}function Ea(){if(!(Qt||ze||zt))return hi.find(n=>{const t=Number(n.root.userData.padHalfWidth??1.3),e=Number(n.root.userData.padHalfDepth??.85);return n.root.visible&&Math.abs(ot.position.x-n.position.x)<t*1.16&&Math.abs(ot.position.z-n.position.z)<e*1.2&&Math.abs(ot.position.y-n.position.y)<1.15})}function Xh(n,t=!1){if(!t&&we-kh<.14)return;kh=we,we-Vh>.32&&(Vh=we,Ar("coin"));const e=document.querySelector(".wallet").getBoundingClientRect(),i=n.position.clone().project(Oe),r=(i.x+1)/2*innerWidth,s=(1-i.y)/2*innerHeight,o=e.left+e.width/2,a=e.top+e.height/2,c=t?r:o,l=t?s:a,u=t?o:r,d=t?a:s,h=document.createElement("i");h.textContent="$",h.style.left=`${c}px`,h.style.top=`${l}px`,h.style.setProperty("--money-x",`${u-c}px`),h.style.setProperty("--money-y",`${d-l}px`),h.classList.toggle("payout",t),et("#money-stream").appendChild(h),h.addEventListener("animationend",()=>h.remove(),{once:!0}),window.setTimeout(()=>h.remove(),1200)}function bM(n){const t=Ea();if(!t||Li.length()>.2){Mn=0,ra="",et("#purchase").hidden=!0,t||(sa="");return}if(sa===t.key||(t.key!==ra&&(Mn=t.key==="job"?Rc:0,ra=t.key),t.upgrade&&Yd(W,t.upgrade)))return;if(Mn+=n,t.key==="job"&&(Rc=Mn),t.upgrade&&!W.test){W.contributions??={};const s=vs(W,t.upgrade),o=W.contributions[t.upgrade]??0,a=Math.min(W.cash,s-o,s*n/1.8);W.cash-=a,W.contributions[t.upgrade]=o+a,Mn=Math.min(Mn,(o+a)/s*1.8),a>0&&Xh(t)}if(t.fleet!==void 0&&!W.test){const s=W.fleet[t.fleet],o=1e3*(s.level+1),a=s.contribution??0,c=Math.min(W.cash,o-a,o*n/1.8);W.cash-=c,s.contribution=a+c,Mn=Math.min(Mn,(a+c)/o*1.8),c>0&&Xh(t)}const e=W.test?Math.min(1,Mn/1.8):yM(t);t.root.userData.setProgress?.(e),et("#purchase").hidden=!1,et("#purchase-name").textContent=t.key==="job"?"Accept the next move":t.income!==void 0?`Collect $${W.fleet[t.income]?.pending??0}`:t.upgrade?Er[t.upgrade]:"Upgrade fleet truck",et("#purchase-progress").style.width=`${Math.min(100,e*100)}%`;const i=t.upgrade?vs(W,t.upgrade):t.fleet!==void 0?1e3*(W.fleet[t.fleet].level+1):0,r=Math.min(i,Math.round(i*e));if(et("#purchase-detail").textContent=i?W.test?"DEVELOPMENT MODE · FREE":`${Math.round(e*100)}% · $${r.toLocaleString("en-US")} OF $${i.toLocaleString("en-US")} INVESTED`:"STAND STILL TO ACTIVATE",Mn>=1.8)if(sa=t.key,Mn=0,et("#purchase").hidden=!0,t.key==="job")Sa();else if(t.income!==void 0){const s=rM(W,t.income);Vt(`+$${s} · Employee route complete`),zn(),De()}else t.upgrade?mf(t.upgrade):t.fleet!==void 0&&nM(W,t.fleet)&&(co(),zn(),ir(`<div class="upgrade-modal"><small>VEHICLE UPGRADED</small><div class="upgrade-badge">✓</div><h2>Employee truck ${t.fleet+2}</h2><ul><li>Faster route</li><li>$125 more income per trip</li><li>Vehicle level ${W.fleet[t.fleet].level}</li></ul><button class="modal-ok">Continue</button></div>`),et(".modal-ok").onclick=()=>et("#dialog").close(),De())}function EM(){const n=wi(ot.position);return n.x>1.15&&n.x<4.85&&n.z>=.2&&n.z<=Te&&ot.position.y>.6}function po(n){const t=wi(n);if(t.x>1.4&&t.x<4.6){if(t.z>=.2&&t.z<=Te)return .78;if(vr>.94&&t.z>Te&&t.z<Te+2.2)return .78*(Te+2.2-t.z)/2.2}return 0}function wM(n,t=1/0){let e=-1/0;for(const i of ee){if(i.mode!=="truck"&&i.mode!=="ground")continue;const[r,s]=Qe(i.item),o=i.mode==="truck"?wi(n):n,a=i.position,c=a.y+tf(i.item.model);c<=t+.14&&Math.abs(o.x-a.x)<r*Ut/2-.08&&Math.abs(o.z-a.z)<s*Ut/2-.08&&(e=Math.max(e,c))}return e}function wa(n,t=1/0){return Math.max(po(n),wM(n,t))}function ps(){if(EM())return!0;const n=wi(ot.position);return vr>.94&&n.x>1.4&&n.x<4.6&&n.z>Te&&n.z<=Te+2.25}function gf(){let n,t=2.75;for(const e of ee){if(["hand","air","delivered"].includes(e.mode)||e.mode==="truck"&&!ps())continue;const i=e.mesh.getWorldPosition(new A),r=Math.hypot(i.x-ot.position.x,i.z-ot.position.z);r<t&&Math.abs(i.y-ot.position.y)<1.5&&(n=e,t=r)}return n}function $h(n,t){return ee.every(e=>{if(e===t||["hand","air","delivered"].includes(e.mode))return!0;const i=e.mesh.getWorldPosition(new A),[r,s]=Qe(e.item);return Math.abs(n.x-i.x)>r*Ut/2+.38||Math.abs(n.z-i.z)>s*Ut/2+.38})}function TM(n){const t=n.mesh.getWorldPosition(new A),[e,i]=Qe(n.item),r=n.mode==="truck",s=r?n.position:t,a=[new A(s.x-e*Ut/2-.62,0,s.z),new A(s.x+e*Ut/2+.62,0,s.z),new A(s.x,0,s.z-i*Ut/2-.62),new A(s.x,0,s.z+i*Ut/2+.62)].map(u=>r?ii(u.setY(.78)):u.setY(0)).filter(u=>{if(Rr(u,.3)||!$h(u,n)||r&&!Ba(u))return!1;for(let d=1;d<=6;d++){const h=ot.position.clone().lerp(u,d/6);if(!$h(h,n)||Rr(h,.24))return!1}return!0});if(!a.length)return null;const c=a.sort((u,d)=>u.distanceToSquared(ot.position)-d.distanceToSquared(ot.position))[0];c.y=po(c);const l=Math.atan2(t.x-c.x,t.z-c.z);return{to:c,yaw:l,item:t}}function uu(){if(!zt)return null;const[n,t]=Qe(zt.item),e=new A(0,0,.65+Math.max(n,t)*Ut/2).applyQuaternion(ot.quaternion).add(ot.position),i=wi(e),r=ee.map(u=>({...u.item,x:u.mode==="truck"?(u.position.x-1.4)/Ut-Qe(u.item)[0]/2:u.item.x,z:u.mode==="truck"?(u.position.z-.2)/Ut-Qe(u.item)[1]/2:u.item.z,location:u.mode==="truck"?"truck":"pickup"})),s=ue.clamp(Math.round((i.x-1.4)/Ut-n/2),0,4-n),o=ue.clamp(Math.round((i.z-.2)/Ut-t/2),0,Dn-t),a=(u,d)=>iu(r,zt.item,u,d,4,Dn);if(a(s,o))return{x:s,z:o,w:n,d:t,valid:!0};let c=null,l=1/0;for(let u=0;u<=Dn-t;u++)for(let d=0;d<=4-n;d++){const h=(d-s)**2+(u-o)**2;h<l&&a(d,u)&&(c={x:d,z:u,w:n,d:t,valid:!0},l=h)}return c??{x:s,z:o,w:n,d:t,valid:!1}}function lo(n){const[,t]=Qe(n.item);return .62+t*Ut/2}function AM(){if(ze||Qt)return;if(rr()&&!je)return ba();const n=Ea();if(n){n.key==="job"?Vt("Stand still on the job field to accept a move."):n.key==="collect"?Lc():n.upgrade||n.fleet!==void 0?Vt("Stand still on this field; payment starts automatically."):Vt("Stand inside the markers to build.");return}if(zt){const o=zt,a=o.mesh.getWorldPosition(new A);let c,l;if(ps()){const f=uu();if(!f.valid)return Vt("No clear space nearby. Press R to rotate or move along the truck.");o.item.x=f.x,o.item.z=f.z,c=new A(1.4+(f.x+f.w/2)*Ut,.78,.2+(f.z+f.d/2)*Ut),l="truck"}else{const f=ff(ot.position),_=df(o);if(f&&!_)return Vt("This furniture has no clear delivery spot. Move away from the doorway and try again.");if(f&&_&&!_.close)return Vt(`Place ${o.item.name} on its highlighted spot.`);if(c=f&&_?_.target.clone():ot.position.clone().add(new A(0,0,1.1).applyQuaternion(ot.quaternion)),c.y=.12,l=f&&_?"delivered":"ground",l!=="delivered"&&Rr(c,.3))return Vt("There is a wall here. Step into the room.")}Pe.attach(o.mesh);const u=o.mesh.getWorldQuaternion(new Si),d=l==="delivered"?0:(l==="truck"?At.rotation.y:0)+(o.item.rotated?Math.PI/2:0),h=new Si().setFromEuler(new yi(0,d,0));ze={kind:"drop",load:o,time:0,duration:.5,from:a,to:l==="truck"?ii(c):c,mode:l,fromQuaternion:u,toQuaternion:h},o.position.copy(c),zt=null;return}const t=gf();if(!t)return Vt("Stand close to furniture.");if(Ve&&!je){const{leg:o,point:a}=Oa(),c=t.mode==="ground"&&o==="pickup",l=t.mode==="truck"&&o==="delivery";if((c||l)&&!cu(a))return Vt(`Park the complete truck inside the yellow ${o} bay first.`)}const e=t.mesh.getWorldPosition(new A),i=TM(t);if(!i)return Vt("Move around the furniture so there is room to lift it safely.");const r=ot.position.clone(),s=ue.clamp(r.distanceTo(i.to)/3.8,.18,.55);Pe.attach(t.mesh),ze={kind:"lift",load:t,time:0,duration:s+(.62+t.item.weight*.34)/(1+W.levels.worker*.23),from:e,to:new A,mode:"hand",approachFrom:r,approachTo:i.to,approachYaw:i.yaw,approachDuration:s},t.mode="hand",Ln=!1,t.secured=!1,Dr(),t.velocity.set(0,0,0),t.angular.set(0,0,0),oi(260)}function RM(n){if(!ze)return;ze.time+=n;const t=ze,e=t.approachDuration??0,i=t.time<e,r=Math.min(1,Math.max(0,(t.time-e)/(t.duration-e))),s=r*r*(3-2*r),o=ot.userData.rig;if(i&&t.approachFrom&&t.approachTo){const c=Math.min(1,t.time/e),l=c*c*(3-2*c);if(ot.position.lerpVectors(t.approachFrom,t.approachTo,l),_r.animate(we,!0,!1,!1),t.approachYaw!==void 0){const u=Math.atan2(Math.sin(t.approachYaw-ot.rotation.y),Math.cos(t.approachYaw-ot.rotation.y));ot.rotation.y+=u*(1-Math.exp(-12*n))}t.load.mesh.position.copy(t.from);return}o.body.rotation.x=.42*Math.sin(r*Math.PI),o.body.position.y=-.19*Math.sin(r*Math.PI),o.arms.forEach(c=>c.rotation.x=-1.35*Math.sin(Math.min(1,r*1.35)*Math.PI/2));const a=t.kind==="lift"?ue.smoothstep(r,.08,.94):s;if(t.kind==="lift"&&t.to.copy(ot.position).add(new A(0,.95,lo(t.load)).applyQuaternion(ot.quaternion)),t.kind==="lift"){const c=t.from.clone();c.y=Math.max(t.to.y,t.from.y+.95),a<.58?t.load.mesh.position.lerpVectors(t.from,c,ue.smoothstep(a/.58,0,1)):t.load.mesh.position.lerpVectors(c,t.to,ue.smoothstep((a-.58)/.42,0,1))}else t.load.mesh.position.lerpVectors(t.from,t.to,a),t.fromQuaternion&&t.toQuaternion&&t.load.mesh.quaternion.slerpQuaternions(t.fromQuaternion,t.toQuaternion,a);t.load.mesh.rotation.x=ue.damp(t.load.mesh.rotation.x,0,8,n),t.load.mesh.rotation.z=ue.damp(t.load.mesh.rotation.z,0,8,n),t.time>=t.duration&&(t.load.mode=t.mode,t.mode==="truck"&&(t.load.fallen=!1),t.mode==="delivered"&&(t.load.item.rotated=!1),t.kind==="lift"?(zt=t.load,ot.add(t.load.mesh),t.load.mesh.position.set(0,.95,lo(t.load)),t.load.mesh.rotation.set(0,t.load.item.rotated?Math.PI/2:0,0),fs("lift")):(Es(t.load),t.mode==="truck"&&(Ln=!1,Dr()),za(),t.mode==="truck"&&fs("loaded")),t.load.velocity.set(0,0,0),t.load.angular.set(0,0,0),t.load.settled=!0,ze=null,o.body.rotation.x=0,o.body.position.y=0,oi(520),rr()&&(zn(),Vt("Everything delivered. Choose your reward."),fs("delivered"),Ys=1.6),De())}function CM(){if(Qt||ze||zt)return;const n=wi(ot.position);if(Math.hypot(n.x-3,n.z-Te)>4.8)return Vt("Walk to the rear of your truck.");if(n.x>1.2&&n.x<4.8&&n.z>Te-.2&&n.z<Te+2.4)return Vt("Step to the side of the ramp.");if(Bi<.5&&!cu())return Vt("Park fully in the yellow bay until it turns green before lowering the rear.");Bi=Bi>.5?0:1,oi(300,.25)}function PM(){if(!(ze||zt||xe)){if(Qt){Ie=0,_a=1,Ar("door"),xe={entering:!1,time:0,swapped:!1},Vt("Opening the driver door…");return}if(ot.position.distanceTo(qs(new A(5.3,0,-1)))>3.8)return Vt("The driver door is at the front right.");_a=1,Ar("door"),xe={entering:!0,time:0,swapped:!1,from:ot.position.clone()},Li.set(0,0,0),Vt("Opening the driver door…")}}function DM(n){if(!xe)return;xe.time+=n;const t=xe.entering?.72:.5;if(xe.entering&&!xe.swapped&&xe.from&&xe.time>=.14){const e=qs(new A(5.15,0,-1.15)),i=ue.smoothstep((xe.time-.14)/.55,0,1);e.y=po(e),ot.position.lerpVectors(xe.from,e,i),ot.rotation.y=At.rotation.y-Math.PI/2,_r.animate(we,!0,!1,!1)}if(!xe.swapped&&xe.time>=t){if(xe.swapped=!0,xe.entering)Qt=!0,ot.visible=!1,Vt(Bi?"Rear lowered. Raise it with G when loading is complete.":"W/S drive and brake. F exits when stopped."),fs("cab");else{Qt=!1,ot.visible=!0;let e=qs(new A(5.5,0,-1));for(const i of[5.5,.5]){const r=qs(new A(i,0,-1));if(!Rr(r,.28)){e=r;break}}ot.position.copy(e),Rr(ot.position,.28)&&mo(!1)}De()}xe.time>=(xe.entering?.82:.9)&&(_a=0),xe.time>=(xe.entering?1.18:1.35)&&(xe=null)}function Rr(n,t=.25){return[...Ua.barriers,...gr.barriers,...Bn.barriers,...ni.barriers].some(e=>Math.abs(n.x-e.x)<e.w/2+t&&Math.abs(n.z-e.z)<e.d/2+t)}function _f(){for(const n of[1.15,1.8,2.5,3.2,3.9,4.55,4.85])for(let t=-2.35;t<=Te+.4;t+=.42)if(Rr(t<0?qs(new A(n,0,t)):ii(new A(n,0,t)),.19))return!0;return!1}function LM(n){if(!zt)return!1;const[t,e]=Qe(zt.item),i=n.clone().add(new A(0,0,lo(zt)).applyAxisAngle(su,ot.rotation.y)),r=t*Ut/2,s=e*Ut/2,o=Math.abs(Math.cos(ot.rotation.y)),a=Math.abs(Math.sin(ot.rotation.y)),c=r*o+s*a,l=r*a+s*o;return i.x-c<We.minX||i.x+c>We.maxX||i.z-l<We.minZ||i.z+l>We.maxZ?!0:[...Ua.barriers,...gr.barriers,...Bn.barriers,...ni.barriers].some(u=>Math.abs(i.x-u.x)<c+u.w/2+.04&&Math.abs(i.z-u.z)<l+u.d/2+.04)}function Ba(n,t=Zn,e=ot.position.y){if(n.x<We.minX||n.x>We.maxX||n.z<We.minZ||n.z>We.maxZ||Rr(n)||LM(n))return!1;const i=wi(n);if(i.x>1.15&&i.x<4.85&&i.z>-2.4&&i.z<.2||!t&&Math.abs(wa(n,e+.2)-e)>.22||i.z>=.2&&i.z<Te&&(Math.abs(i.x-1.4)<.15||Math.abs(i.x-4.6)<.15)&&e<(W.levels.truck>0?2.75:1.02))return!1;for(const r of ee)if(r.mode==="truck"||r.mode==="ground"){const[s,o]=Qe(r.item),a=r.mode==="truck"?r.position:r.mesh.getWorldPosition(new A),c=r.mode==="truck"?i:n,l=a.y+tf(r.item.model);if(e<l-.08&&Math.abs(c.x-a.x)<s*Ut/2+.16&&Math.abs(c.z-a.z)<o*Ut/2+.16)return!1}return!0}function IM(n){if(Qt||xe||ze||et("#dialog").open)return Li.set(0,0,0),es=!1,!1;const t=Number(Ne.has("KeyD")||Ne.has("ArrowRight"))-Number(Ne.has("KeyA")||Ne.has("ArrowLeft")),e=Number(Ne.has("KeyW")||Ne.has("ArrowUp"))-Number(Ne.has("KeyS")||Ne.has("ArrowDown")),i=Oe.getWorldDirection(new A);i.y=0,i.normalize();const r=new A(-i.z,0,i.x).multiplyScalar(t).addScaledVector(i,e);es=Ne.has("ShiftLeft")&&!zt&&Cl>(es?2:18)&&r.lengthSq()>0,Cl=ue.clamp(Cl+n*(es?-27:16+W.levels.worker*2),0,100);const s=zt?Math.max(1.35,3.1-zt.item.weight*.25/(1+W.levels.worker*.3)):es?6.7:3.9;r.normalize().multiplyScalar(s*(1+W.levels.worker*.07)),Li.lerp(r,1-Math.exp(-10*n));const o=ot.position.clone();for(let a=0;a<4;a++)for(const c of["x","z"]){const l=ot.position.clone();if(l[c]+=Li[c]*n/4,Ba(l)){if(!Zn){const u=wa(l,ot.position.y+.2);ot.position.y-u>.22?(Zn=!0,Xn=Math.min(0,Xn),l.y=ot.position.y):l.y=u}ot.position.copy(l)}}if(Li.length()>.1){const a=Math.atan2(Li.x,Li.z),c=Math.atan2(Math.sin(a-ot.rotation.y),Math.cos(a-ot.rotation.y));ot.rotation.y+=c*(1-Math.exp(-14*n))}return o.distanceTo(ot.position)>.003}function NM(){Qt||xe||ze||et("#dialog").open||Zn||(Zn=!0,Xn=4.3,oi(390,.08))}function UM(n){if(Qt||xe){Zn=!1,Xn=0;return}const t=wa(ot.position,ot.position.y+.16);if(!Zn&&ot.position.y>t+.08&&(Zn=!0,Xn=Math.min(0,Xn)),!Zn){ot.position.y=t;return}const e=ot.position.y;Xn-=12.5*n,ot.position.y+=Xn*n;const i=wa(ot.position,e+.12);Xn<=0&&ot.position.y<=i&&e>=i-.06&&(ot.position.y=i,Xn=0,Zn=!1),ot.position.y<-2&&mo()}function mo(n=!0){if(Qt)return;const t=ot.position.clone(),e=[];for(const r of mn)for(let s=We.minX+6;s<We.maxX-6;s+=3)e.push(new A(s,0,r));for(const r of mr)for(let s=We.minZ+6;s<We.maxZ-6;s+=3)e.push(new A(r,0,s));e.sort((r,s)=>r.distanceToSquared(t)-s.distanceToSquared(t));for(const r of[2,3,4.2,5.5])for(let s=0;s<16;s++)e.push(new A(t.x+Math.cos(s*Math.PI*2/16)*r,0,t.z+Math.sin(s*Math.PI*2/16)*r));const i=e.find(r=>(r.y=po(r),Ba(r,!1,r.y)));ot.position.copy(i??new A(-6,0,1)),Xn=0,Zn=!1,Li.set(0,0,0),Pc.length=0,vM.copy(ot.position),et("#stuck-button").hidden=!0,n&&Vt("Moved you to the nearest clear space."),De()}function vf(){const n=lu(),t=At.rotation.y,e=At.userData.trailer,i=e.rotation.y,r=new A(3,0,(Te-2.2)/2),s=[];for(const c of mn)for(let l=We.minX+9;l<We.maxX-9;l+=4)s.push({center:new A(l,0,c),yaw:Math.PI/2});for(const c of mr)for(let l=We.minZ+9;l<We.maxZ-9;l+=4)s.push({center:new A(c,0,l),yaw:0});s.sort((c,l)=>c.center.distanceToSquared(n)-l.center.distanceToSquared(n));for(const c of[3.5,5.5,8])for(let l=0;l<12;l++)s.push({center:n.clone().add(new A(Math.cos(l*Math.PI*2/12)*c,0,Math.sin(l*Math.PI*2/12)*c)),yaw:t});const o=At.position.clone();e.rotation.y=0;const a=s.find(({center:c,yaw:l})=>(At.rotation.y=l,At.position.copy(c).sub(r.clone().applyAxisAngle(su,l)),At.updateMatrixWorld(!0),!(_f()||Mr.some(d=>d.visible&&c.distanceTo(d.position)<4.2))));a||(At.position.copy(o),At.rotation.y=t,e.rotation.y=i),At.updateMatrixWorld(!0),Ie=0,Gs=0,Cc.length=0,Zi.length=0,af.copy(At.position),et("#stuck-button").hidden=!0,Vt(a?"Moved the truck to the nearest clear space.":"No clear rescue position found nearby."),De()}function za(){!Qt&&!Ba(ot.position,!1,ot.position.y)&&mo(!1)}function FM(n){if(!Qt||xe)return{acceleration:0,yawRate:0};const t=Number(Ne.has("KeyW")||Ne.has("ArrowUp"))-Number(Ne.has("KeyS")||Ne.has("ArrowDown")),e=Number(Ne.has("KeyA")||Ne.has("ArrowLeft"))-Number(Ne.has("KeyD")||Ne.has("ArrowRight")),i=Ie;if(t&&Bi>.05)return Ie=0,we-os>1.5&&(os=we,Vt("Raise the rear with G before driving.")),{acceleration:0,yawRate:0};Ie+=t*(t*Ie<0?10:4+W.levels.truck*.45)*n,t||(Ie*=Math.exp(-1.7*n)),!t&&Math.abs(Ie)<.04&&(Ie=0),Ie=ue.clamp(Ie,-4,8.5+W.levels.truck*1.3),Gs=ue.damp(Gs,e*.52,6,n);const r=At.userData.trailer;r.rotation.y=0,At.updateMatrixWorld(!0);const s=Ie*Math.tan(Gs)/Math.max(3.1,Te*.65),o=new A(3,0,(Te-2.2)/2),a=ii(o),c=a.clone(),l=At.position.clone(),u=At.rotation.y;At.rotation.y+=s*n,a.addScaledVector(new A(-Math.sin(At.rotation.y),0,-Math.cos(At.rotation.y)),Ie*n),At.position.copy(a).sub(o.applyAxisAngle(su,At.rotation.y)),At.updateMatrixWorld(!0);let d=!1,h=!1;d=_f();const f=2.4;(a.x<We.minX+f||a.x>We.maxX-f||a.z<We.minZ+f||a.z>We.maxZ-f)&&(d=!0);for(const _ of Mr)_.visible&&a.distanceTo(_.position)<4.2&&a.distanceTo(_.position)<c.distanceTo(_.position)-.005&&(d=!0,h=!0);d&&(At.position.copy(l),Zi.push(we),At.rotation.y=u,At.updateMatrixWorld(!0),Ie=-i*.12,we-os>.7&&(os=we,oi(120,.18),h&&Vt("Both trucks stopped safely. Reverse away to continue.")));for(const _ of At.userData.wheels??[])_.rotation.x-=Ie*n/.46;for(const _ of At.userData.frontWheels??[])_.rotation.y=ue.damp(_.rotation.y,Gs*.72,9,n);return{acceleration:(Ie-i)/n,yawRate:s}}function co(){Mr.forEach(ei),Mr=[],ns=null,W.fleet.forEach((n,t)=>{const e=new me;e.name=`fleet-${t}`;const i=Wd(5,Math.min(n.level,4),W.selectedSkins.truck,!1);i.name=`employee-truck-${t}`,i.scale.setScalar(.64),i.position.set(-1.92,0,-.6),i.userData.rampPivot.rotation.x=-Math.PI/2;const r=new me;D(r,3.5,1.3,-1.22,.58,.6,.45,5668486,!0);const s=new Ft(new Pa(.24,12,10),new _s({color:15121803}));s.position.set(3.5,1.77,-1.22),r.add(s),i.add(r),e.add(i),e.userData.wheels=i.userData.wheels,e.userData.skin=W.selectedSkins.truck;const o=Mf(xf(n,t),n.phase);e.position.copy(o.position),e.rotation.y=o.yaw+Math.PI,e.userData.safePosition=o.position.clone(),Pe.add(e),Mr.push(e)})}function xf(n,t){const e=8+t*4.8,i=(n.route??t%3)%3,r=new A(e,0,-9),s=110+i*4;return[r,new A(e,0,-15),new A(43,0,-15),new A(90,0,-15),new A(90,0,-42),new A(s,0,-42),new A(s,0,-15),new A(90,0,-15),new A(43,0,-15),new A(e,0,-15),r]}function Mf(n,t){if(t<=0)return{position:n[0].clone(),yaw:Math.PI};const e=n.slice(1).map((s,o)=>s.distanceTo(n[o])),i=e.reduce((s,o)=>s+o,0);let r=ue.clamp(t,0,.9999)*i;for(let s=0;s<e.length;s++){if(r<=e[s]){const o=r/Math.max(.001,e[s]),a=n[s].clone().lerp(n[s+1],o),c=n[s+1].clone().sub(n[s]);return{position:a,yaw:Math.atan2(c.x,c.z)}}r-=e[s]}return{position:n.at(-1).clone(),yaw:0}}function OM(n){const t=W.fleet.map(s=>s.pending??0),e=lM(W,n);e&&va<=0&&Vt(`+$${e} · Your company is working`),At.updateMatrixWorld(!0);const i=new Cr().setFromObject(At).expandByScalar(2.2),r=s=>s.x>36&&s.x<94&&s.z>-22&&s.z<-10;W.fleet.forEach((s,o)=>{const a=Mr[o];if(!a)return;s.route??=o%3;const c=Mf(xf(s,o),s.phase),l=Mr.some((h,f)=>f!==o&&h.position.distanceTo(c.position)<4.2),u=r(c.position)&&ns!==null&&ns!==o,d=i.containsPoint(c.position.clone().setY(1));if((l||u||d)&&a.userData.safePosition)s.phase-=n/qd(s),a.position.copy(a.userData.safePosition);else{const h=a.userData.safePosition?c.position.distanceTo(a.userData.safePosition):0;a.position.copy(c.position),a.rotation.y=c.yaw+Math.PI;for(const f of a.userData.wheels??[])f.rotation.x-=h/.4;a.userData.safePosition=c.position.clone(),r(c.position)?ns=o:ns===o&&(ns=null)}}),W.fleet.some((s,o)=>(s.pending??0)>t[o])&&(zn(),Vt("An employee truck returned. Collect its income at the parking bay."),De())}function BM(n){const t=Qt?ii(new A(3,0,2)):ot.position;for(const s of[...Ua.roofs,...gr.roofs,...Bn.roofs,...ni.roofs]){const o=Math.abs(t.x-s.bounds.x)<s.bounds.w/2+1&&Math.abs(t.z-s.bounds.z)<s.bounds.d/2+1;for(const a of[s.mesh,...s.walls??[]]){const c=a.material;c.opacity=ue.damp(c.opacity,o?.035:1,6,n),c.depthWrite=c.opacity>.5,a.castShadow=c.opacity>.5}}const e=wi(ot.position),i=!Qt&&e.x>1&&e.x<5&&e.z>-.1&&e.z<Te+2.5,r=[At.userData.roof,...At.userData.cargoWalls??[]];for(const s of r){const o=s.material;o.opacity=ue.damp(o.opacity,i||Qt?.025:1,7,n),o.depthWrite=o.opacity>.5,s.castShadow=o.opacity>.5}}function zM(){if(!Ve||je)return{point:new A(-10,0,1),text:"Accept a move at your job board"};if(rr())return{point:new A(Tn+2,0,hn),text:"Choose your completion reward"};const n=ee.find(t=>t.mode==="ground");return n?{point:n.position.clone(),text:n.fallen?"Recover the fallen furniture":"Pick up the furniture"}:{point:new A(Tn-5.6,0,hn+1),text:"Unload inside the new home"}}function kM(n){if(!Qt)return n;const t=lu(),{leg:e,point:i}=Oa(),r=i.x,s=i.z;if(Math.abs(t.x-r)<10&&Math.abs(t.z-s)<10)return xr=e,Wn=[],tn=0,{point:new A(r,0,s),text:e==="yard"?"Park fully inside the yellow yard bay":`Park fully inside the yellow ${e} bay`};const o=Wn.length<2?1/0:Math.min(...Wn.slice(1).map((M,g)=>{const x=Wn[g],R=M.x-x.x,v=M.z-x.z,w=R*R+v*v,P=w?ue.clamp(((t.x-x.x)*R+(t.z-x.z)*v)/w,0,1):0;return Math.hypot(t.x-x.x-R*P,t.z-x.z-v*P)})),a=M=>mn.reduce((g,x)=>Math.abs(x-(M+12))<Math.abs(g-(M+12))?x:g),l=e==="yard"?12:a(e==="pickup"?ln:hn),u=t.x>-26&&t.x<36&&t.z>-36&&t.z<8,d=(M,g)=>Math.abs(t.x-(M+4))<12&&Math.abs(t.z-(g-2.1))<13,h=u?12:d(yn,ln)?a(ln):d(Tn,hn)?a(hn):void 0;(xr!==e||!Wn.length||o>7)&&(xr=e,tn=0,Wn=dM(t,new A(r,0,s),{startLane:h,goalLane:l}));const f=Wn;let _=0,y=1/0;for(let M=0;M<f.length-1;M++){const g=f[M],x=f[M+1],R=x.x-g.x,v=x.z-g.z,w=R*R+v*v,P=w?ue.clamp(((t.x-g.x)*R+(t.z-g.z)*v)/w,0,1):0,F=Math.hypot(t.x-g.x-R*P,t.z-g.z-v*P)+Math.max(0,tn-M-1)*2;F<y&&(y=F,_=M)}for(tn=Math.min(f.length-1,Math.max(tn,_+1));tn<f.length-1&&(t.distanceTo(f[tn])<2.5||pM(f[tn-1],f[tn],t));)tn++;const m=f[tn],p=Math.round(t.distanceTo(m)),b=f[tn+1];let T=e==="yard"?"Return to your company yard":`Continue to the ${e} house`;if(b){const M=fM(f[tn-1],m,b);T=M==="straight"?`Continue straight for ${p} m`:M==="around"?`In ${p} m turn around`:`In ${p} m turn ${M}`}else p<18&&(T=e==="yard"?"Park in your company yard":`Park at the ${e} house`);return{point:m,text:T}}function Yh(){for(;ys.children.length;){const n=ys.children.pop();n instanceof Ft&&(n.geometry.dispose(),n.material.dispose())}}function GM(){const n=Qt&&Wn.length>1,t=Oa().point;if(ji.visible=Qt,ji.position.set(t.x,0,t.z),Fa.scale.y=sf(),!n){Zo&&Yh(),Zo="";return}const e=Wn,i=`${xr}:${e.map(l=>`${l.x.toFixed(1)},${l.z.toFixed(1)}`).join(";")}`,r=()=>{const l=ys.children[0];if(!l)return;const d=l.geometry.userData.segmentEnds[Math.max(0,tn-2)]??0;l.geometry.setDrawRange(d,l.geometry.getAttribute("position").count-d)};if(i===Zo){r();return}Zo=i,Yh();const s=[],o=[];for(let l=0;l<e.length-1;l++){const u=e[l],d=e[l+1],h=d.clone().sub(u),f=h.length(),_=mn.some(T=>Math.abs(u.z-T)<.15&&Math.abs(d.z-T)<.15)||mr.some(T=>Math.abs(u.x-T)<.15&&Math.abs(d.x-T)<.15);if(f<.5||!_){o.push(s.length/3);continue}const y=h.multiplyScalar(1/f),m=new A(-y.z,0,y.x),p=4.2,b=Math.min(2.2,f*.4);for(let T=b;T<f-.45;T+=p){const M=u.clone().addScaledVector(y,T),g=M.clone().addScaledVector(y,.82),x=M.clone().addScaledVector(y,-.58),R=x.clone().addScaledVector(m,.5),v=x.clone().addScaledVector(m,-.5);s.push(g.x,.14,g.z,R.x,.14,R.z,v.x,.14,v.z)}o.push(s.length/3)}if(!s.length)return;const a=new Fe;a.setAttribute("position",new ie(s,3)),a.userData.segmentEnds=o,a.computeVertexNormals();const c=new Ft(a,new ri({color:7792592,transparent:!0,opacity:.82,side:an,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-3}));c.name="route-ground-arrows",c.renderOrder=3,ys.add(c),r()}function hu(){const n=zM(),t=kM(n),e=ee.filter(c=>c.mode==="truck").length,i=ee.filter(c=>c.mode==="delivered").length;GM(),et("#jem-count").textContent=W.test?"∞":W.jems.toLocaleString("en-US"),et("#cash").textContent=W.test?"∞":`$${Math.floor(W.cash).toLocaleString("en-US")}`,et("#cash-mode").textContent=W.test?"TEST MONEY":`$${Math.floor(W.earned).toLocaleString("en-US")} earned`,et("#job-title").textContent=je?W.finished?"Coming soon":"Move completed!":Ve?Gt.title:"Small beginnings",et("#job-label").textContent=Ve?`MOVE ${bs+1} · LEVEL ${Gt.difficulty}`:"YOUR NEXT MOVE",et("#job-step").textContent=t.text,et("#job-progress").style.width=`${Ve?(e+i*2)/ee.length/2*100:0}%`,et("#job-count").textContent=Ve?`${e} in truck  ·  ${i}/${ee.length} delivered`:"Your first customer is waiting",et("#job-score").innerHTML=Ve?`<div class="score-total"><span>CARE SCORE</span><b>${ao()}/100</b></div>${tr.length?`<ul class="damage-list">${pf()}</ul>`:"<small>No cargo damage</small>"}`:"",et("#job-value").textContent=Ve?`${je?"COLLECTED":"PAYDAY"}  $${rr()?ya():Gt.reward}`:W.finished?"You built the complete company.":"Start with a job. Build an empire.";const r=Qt?ii(new A(3,0,1)):ot.position,s=Math.round(r.distanceTo(t.point));et("#nav-distance").textContent=Qt&&s>5?`${s} m`:"",et("#status-kicker").textContent=Qt?`${Math.round(Math.abs(Ie)*3.6)} KM/H · NEXT ACTION`:"NEXT ACTION";let o="E",a=t.text;if(ze)a=`${ze.kind==="lift"?"Lifting":"Placing"} ${ze.load.item.name}`,o="···";else if(Qt)o="W/S",a=t.text;else if(zt)a=ps()?uu()?.valid?"Place in highlighted space · R rotate":"No clear space nearby · R rotate or move closer":Kn.visible?`Place ${zt.item.name} on the marked spot`:"Carry to the truck or into the delivery house";else if(Ea()){const c=Ea();a=c.key==="job"?"Stand still on the job field to accept a move":c.income!==void 0?`Collect $${W.fleet[c.income]?.pending??0} from this crew`:c.upgrade?`Stand still to upgrade ${Er[c.upgrade]}`:"Stand still to upgrade this fleet truck",o=c.key==="job"?"⏱":c.upgrade||c.fleet!==void 0?"$":"E"}else{const c=gf(),l=wi(ot.position);c?(a=`Lift ${c.item.name} · ${c.item.weight>=4?"HEAVY":c.item.fragile?"FRAGILE":"READY"}`,o="E"):Math.hypot(l.x-5.3,l.z+1)<3?(a="Enter your truck",o="F"):Math.hypot(l.x-3,l.z-Te)<4&&(ee.some(u=>u.mode==="truck")&&!Ln?(a="Secure all cargo with the net",o="Q"):(a=Bi?"Raise the rear":"Lower the rear",o="G"))}et("#hint-key").textContent=o,et("#nav-label").textContent=a,et("#company-stats").innerHTML=`<div><b>${W.jobs}</b><span>YOUR MOVES</span></div><div><b>${W.levels.hire}</b><span>CREWS</span></div><div><b>${W.fleet.length}</b><span>FLEET TRUCKS</span></div>`,et("#fleet-list").innerHTML=W.fleet.map((c,l)=>`<div class="fleet-row"><span>Truck ${l+2} · Level ${c.level}<small>${(c.pending??0)>0?`$${c.pending} ready at parking bay`:c.phase<.05?"Loading at the base":c.phase<.82?"Driving through the city tunnel":"Returning to its bay"} · ${c.completed} trips</small></span><div class="progress"><i style="width:${Math.max(0,c.phase)*100}%"></i></div></div>`).join(""),document.querySelectorAll("[data-upgrade]").forEach(c=>{const l=c.dataset.upgrade;c.textContent=`${Er[l]} · ${W.levels[l]}/${bn[l]}`})}function De(){if(!nf)try{Qi.setItem("movecraft-rewrite-v1",JSON.stringify({worldVersion:2,navPath:Wn.map(n=>n.toArray()),company:W,contract:Gt,jobActive:Ve,jobPaid:je,jobNumber:bs,routeVariant:Yn,netSecured:Ln,damageLog:tr,navLeg:xr,navIndex:tn,tutorialStep:kt,truck:{position:At.position.toArray(),yaw:At.rotation.y,trailerAngle:At.userData.trailer.rotation.y,rear:Bi},player:ot.position.toArray(),loads:ee.map(n=>({item:n.item,mode:n.mode==="hand"?"ground":n.mode,position:n.mode==="hand"?ot.position.toArray():n.position.toArray(),velocity:n.velocity.toArray(),rotation:n.mesh.rotation.toArray(),settled:n.settled,secured:n.secured,damage:n.damage,fallen:n.fallen}))}))}catch{}}function HM(){if(jt)try{Gt=jt.contract?.fromSite&&jt.contract?.toSite?jt.contract:{...nu(jt.jobNumber??W.jobs,W.levels.truck,jt.routeVariant??0),...jt.contract??{},fromSite:Gt.fromSite,toSite:Gt.toSite},yn=Gt.fromSite.x,ln=Gt.fromSite.z??0,Tn=Gt.toSite.x,hn=Gt.toSite.z??0,Ve=!!jt.jobActive,je=!!jt.jobPaid,bs=jt.jobNumber??0,Yn=jt.routeVariant??bs%3,tr.length=0,tr.push(...jt.damageLog??[]),Ln=!!jt.netSecured,xr="",tn=0,Wn=[],jt.truck&&(At.position.fromArray(jt.truck.position),At.rotation.y=jt.truck.yaw,At.userData.trailer.rotation.y=0,vr=Bi=jt.truck.rear),jt.player&&ot.position.fromArray(jt.player),Ve&&(ei(Bn.root),ei(ni.root),Bn=xs(yn,Gt.fromSite.variant+Yn,!1,ln),ni=xs(Tn,Gt.toSite.variant+Yn,!0,hn),Pe.add(Bn.root,ni.root),hf(),Dc());let n=!1;for(const t of jt.loads??[]){const e={item:t.item,mesh:Vd(t.item.model),mode:t.mode,position:new A().fromArray(t.position),velocity:new A().fromArray(t.velocity??[0,0,0]),angular:new A,hitAt:-10,settled:t.settled,secured:t.secured??!1,damage:t.damage??0,fallen:t.fallen??!1};if(t.shelf&&e.mode==="truck"&&(n=!0,e.position.y=.78,e.item.x=Math.max(0,Math.min(3,e.item.x)),e.item.z=Math.max(0,Math.min(Dn-Qe(e.item)[1],e.item.z)),e.position.x=1.4+(e.item.x+Qe(e.item)[0]/2)*Ut,e.position.z=.2+(e.item.z+Qe(e.item)[1]/2)*Ut),ee.push(e),e.mode==="ground"&&!e.fallen&&Bn.barriers.some(i=>Math.abs(e.position.x-i.x)<(e.item.w*Ut+i.w)/2+.18&&Math.abs(e.position.z-i.z)<(e.item.d*Ut+i.d)/2+.18)){const i=Gt.items.find(r=>r.id===e.item.id);i&&(e.item.pickupX=i.pickupX,e.item.pickupZ=i.pickupZ),e.position.set(yn+e.item.pickupX,.12,ln+e.item.pickupZ)}Es(e),t.rotation&&e.mode!=="truck"&&e.mesh.rotation.fromArray(t.rotation)}if(n||ee.some(t=>t.mode==="truck"&&t.item.z+Qe(t.item)[1]>Dn)){const t=[];let e=0;for(const i of ee.filter(r=>r.mode==="truck")){let r;const s=i.item.rotated;for(const o of[s,!s]){i.item.rotated=o;for(let a=0;a<Dn&&!r;a++)for(let c=0;c<4&&!r;c++)iu(t,i.item,c,a,4,Dn)&&(r={x:c,z:a,rotated:o});if(r)break}if(r){i.item.rotated=r.rotated,i.item.x=r.x,i.item.z=r.z;const[o,a]=Qe(i.item);i.position.set(1.4+(r.x+o/2)*Ut,.78,.2+(r.z+a/2)*Ut),t.push({...i.item,location:"truck"})}else i.mode="ground",i.fallen=!0,i.secured=!1,i.position.copy(ii(new A(3+e%2*1.4,.12,Te+3+Math.floor(e/2)*1.5))),e++;Es(i)}}Ve&&Dc(),Dr(),za()}catch{Vt("Saved session could not be fully restored.")}}function VM(){(!Ve||je)&&Sa(!0),Ln=!1,W.levels.truck<3&&(W.levels.truck=3,W.levels.cargo=W.levels.gear=3,oo()),zt=null,ze=null;for(const n of ee)n.mode="ground",n.item.rotated=!1;for(const n of ee){let t=!1;for(const e of[!1,!0]){if(t)break;n.item.rotated=e;for(let i=0;i<Dn&&!t;i++)for(let r=0;r<4&&!t;r++){const s=ee.map(o=>({...o.item,location:o.mode==="truck"?"truck":"pickup"}));if(iu(s,n.item,r,i,4,Dn)){n.item.x=r,n.item.z=i;const[o,a]=Qe(n.item);n.mode="truck",n.position.set(1.4+(r+o/2)*Ut,.78,.2+(i+a/2)*Ut),n.velocity.set(0,0,0),t=!0}}}Es(n)}zn(),Dr(),Vt(`${ee.filter(n=>n.mode==="truck").length}/${ee.length} packed. Test packing expands the cargo bay.`),De()}function WM(n){if(Math.abs(Ie)>.35)return Vt("Stop before using test tools.");n==="job"&&Sa(!0),n==="pack"&&VM(),n==="deliver"&&(Ve||Sa(),ee.forEach((t,e)=>{t.mode="delivered",t.position.set(Tn-8+e%3*2.5,.12,hn-3+Math.floor(e/3)*2.5),Es(t)}),zt=null,ze=null,zn(),ot.position.set(Tn-6,0,hn+6),Qt=!1,ot.visible=!0,Vt("Delivery complete. Choose your reward."),ba()),n==="home"&&(ot.position.set(-6,0,1),Qt=!1,ot.visible=!0,Vt("Test teleport: player returned. Truck and cargo stay where they are.")),n==="restart"&&(ir('<h2>Reset test career?</h2><p>This replaces your saved rewrite career with the shabby starting setup.</p><button id="confirm-reset">Reset career</button>'),et("#confirm-reset").onclick=()=>{nf=!0,Qi.removeItem("movecraft-rewrite-v1"),Qi.removeItem("movecraft-update-backup"),location.reload()}),De()}const Sf={interact:AM,cab:PM,rotate:()=>{zt&&!ze&&(zt.item.rotated=!zt.item.rotated,zt.mesh.rotation.set(0,zt.item.rotated?Math.PI/2:0,0),zt.mesh.position.z=lo(zt),oi(400))},rear:CM,secure:MM};document.querySelectorAll("[data-action]").forEach(n=>n.onclick=()=>Sf[n.dataset.action]());document.querySelectorAll("[data-test]").forEach(n=>n.onclick=()=>WM(n.dataset.test));et("#upgrade-tests").innerHTML=Object.keys(Er).filter(n=>["truck","worker","yard","hire","factory"].includes(n)).map(n=>`<button data-upgrade="${n}"></button>`).join("");document.querySelectorAll("[data-upgrade]").forEach(n=>n.onclick=()=>{if(Math.abs(Ie)>.35)return Vt("Stop before upgrading.");const t=n.dataset.upgrade;mf(t);const e=hi.find(i=>i.key===t);e&&(Qt=!1,ot.visible=!0,ot.position.copy(e.position).add(new A(0,0,2)),ot.position.y=po(ot.position),Oe.zoom=t==="yard"||t==="fleet"?.9:1.6,Oe.updateProjectionMatrix())});et("#test-toggle").onclick=()=>{et("#tests").hidden=!et("#tests").hidden};et("#company-toggle").onclick=()=>{et("#company-panel").hidden=!et("#company-panel").hidden};function XM(){const n=new Date,t=n.toISOString().slice(0,10),e=new Date(n.getTime()-864e5).toISOString().slice(0,10),i=W.daily.lastClaim===t,r=W.daily.lastClaim===e?W.daily.streak>=8?1:W.daily.streak+1:1,s=i?W.daily.streak:r,o=l=>ro(l)?`$${ro(l)}`:io(l)?`<span class="daily-jem">${ve.icon} ${io(l)} ${ve.name}</span>`:"Build worker skin",a=r===8&&W.ownedSkins.person.includes("build")?`<span class="daily-jem">${ve.icon} 15 ${ve.name}</span>`:o(r),c=Array.from({length:8},(l,u)=>{const d=u+1;return`<div class="daily-day ${d===s?"today":d<s?"collected":""} ${d===8?"daily-skin-day":""}"><span>DAY ${d}</span>${d===8?`<div class="daily-skin-preview">${ef("person","build")}</div>`:""}<strong>${o(d)}</strong><small>${d<s||i&&d===s?"✓ Collected":d===s?"Available":"Upcoming"}</small></div>`}).join("");return`<div class="daily-modal"><small>DAILY REWARD</small><h2>${i?"Come back tomorrow":`Claim ${a}`}</h2><div class="daily-days">${c}</div><p>Claim on consecutive days. A missed day restarts the series at Day 1.${W.ownedSkins.person.includes("build")?" If you already own the Day 8 skin, you receive 15 Jems instead.":""}</p>${i?"":'<button id="claim-daily">Claim reward</button>'}</div>`}let yf="daily";function Il(n,t){Ar("purchase"),De(),ir(`<div class="shop-success"><div class="shop-success-icon">✓</div><small>PURCHASE COMPLETE</small><h2>${n}</h2><p>${t}</p><button id="shop-success-close">Continue shopping</button></div>`),et("#shop-success-close").onclick=()=>Ta(yf)}function qh(n){const t=document.querySelector("#shop-error");t&&(t.textContent=n,t.hidden=!1)}function Ta(n="daily"){yf=n;const t=`<div class="shop-tabs"><button data-shop-tab="daily" class="${n==="daily"?"active":""}">Daily gifts</button><button data-shop-tab="currency" class="${n==="currency"?"active":""}">Coins & Jems</button><button data-shop-tab="skins" class="${n==="skins"?"active":""}">Skins</button></div>`;let e="";n==="daily"&&(e=XM()),n==="currency"&&(e=`<div class="shop-section"><h2>Coins & ${ve.name}</h2><p class="shop-balance">${ve.icon} ${W.test?"∞":W.jems} ${ve.name} · $${W.test?"∞":Math.floor(W.cash).toLocaleString("en-US")}</p><div class="shop-card"><span class="shop-art coins">$</span><span><b>2,000 coins</b><small>Exchange 10 ${ve.name}</small></span><button id="buy-coins">${ve.icon} 10</button></div><div class="shop-card"><span class="shop-art jems">${ve.icon}</span><span><b>10 ${ve.name}</b><small>Watch an ad to receive them</small></span><button disabled title="Ads will be available later">Coming soon</button></div><p class="shop-note">Ads are being prepared. Coins cannot be exchanged for ${ve.name}.</p></div>`),n==="skins"&&(e=`<div class="shop-section"><h2>Skins</h2><p class="shop-balance">${ve.icon} ${W.test?"∞":W.jems} ${ve.name}</p><p class="shop-note">Looks only · levels stay unchanged</p>${["truck","person"].map(r=>`<h3>${r==="truck"?"Truck":"Person"}</h3><div class="skin-grid">${wc[r].map(s=>{const o=W.ownedSkins[r].includes(s.id),a=W.selectedSkins[r]===s.id;return`<div class="skin-card"><div class="skin-preview ${r}">${ef(r,s.id)}</div><b>${s.name}</b><button data-skin-kind="${r}" data-skin-id="${s.id}" ${a?"disabled":""}>${a?"Equipped":o?"Equip":`${ve.icon} ${s.price}`}</button></div>`}).join("")}</div>`).join("")}</div>`),ir(`<div class="shop-modal"><div class="shop-heading"><span>🛒 SHOP</span><div class="shop-wealth"><span>$${W.test?"∞":Math.floor(W.cash).toLocaleString("en-US")}</span><span>${ve.icon} ${W.test?"∞":W.jems}</span></div></div>${t}<p id="shop-error" class="shop-error" hidden></p>${e}</div>`),document.querySelectorAll("[data-shop-tab]").forEach(r=>r.onclick=()=>Ta(r.dataset.shopTab));const i=document.querySelector("#claim-daily");i&&(i.onclick=()=>{const r=W.ownedSkins.person.includes("build");sM(W),De(),hu();const s=W.daily.streak,o=ro(s)?`$${ro(s)}`:io(s)?`${ve.icon} ${io(s)} ${ve.name}`:r?`${ve.icon} 15 ${ve.name}`:"Build worker skin";Il(o,"Daily reward claimed"),et("#daily-button").classList.remove("ready")}),document.querySelector("#buy-coins")?.addEventListener("click",()=>{if(!gM(W))return qh(`You need 10 ${ve.name}.`);Il("2,000 coins",`Paid 10 ${ve.name}`)}),document.querySelectorAll("[data-skin-kind]").forEach(r=>r.onclick=()=>{const s=r.dataset.skinKind,o=r.dataset.skinId;if(W.ownedSkins[s].includes(o)){W.selectedSkins[s]=o,s==="truck"?(oo(),co()):ga(),De(),Ta("skins");return}if(!_M(W,s,o))return qh(`Not enough ${ve.name} for this skin.`);s==="truck"?(oo(),co()):ga();const a=wc[s].find(c=>c.id===o);Il(`${a.name} ${s==="truck"?"truck":"person"} skin`,"Purchased and equipped · Upgrade level unchanged")})}et("#daily-button").onclick=()=>Ta();et("#job-toggle").onclick=()=>et("#job-body").classList.toggle("collapsed");function bf(){et("#mode-toggle").textContent=W.test?"DEV":"NORMAL",et("#mode-toggle").classList.toggle("development",W.test),et("#test-toggle").hidden=!W.test,W.test||(et("#tests").hidden=!0)}et("#mode-toggle").onclick=()=>{W.test=!W.test,Mn=0,ra="",sa="",bf(),zn(),De(),Vt(W.test?"Development mode: unlimited money and test tools enabled.":"Normal mode: purchases now use company cash.")};bf();et("#camera-follow").onclick=()=>{Oe.zoom=.78,Oe.updateProjectionMatrix()};for(const[n,t]of[["zoom-in",1.2],["zoom-out",1/1.2]])et(`#${n}`).onclick=()=>{Oe.zoom=ue.clamp(Oe.zoom*t,gn.minZoom,gn.maxZoom),Oe.updateProjectionMatrix()};et("#settings").onclick=()=>{au(),ir(`<div class="settings-panel"><h2>Settings</h2><section><h3>Audio</h3><label><span>Sound effects</span><input id="sound" type="checkbox" ${wr?"checked":""}></label><label><span>City & nature</span><input id="ambient" type="checkbox" ${Tr?"checked":""}></label><label><span>Background music</span><input id="music" type="checkbox" ${Ms?"checked":""}></label><label><span>Vehicle sound</span><input id="vehicle-sound" type="checkbox" ${Ss?"checked":""}></label><label><span>Volume</span><input id="volume" type="range" min="0" max="1" step=".05" value="${vi}"></label></section><section><h3>Game & display</h3><label><span>Soft shadows</span><input id="shadows" type="checkbox" ${Rl?"checked":""}></label><button id="rescue-now">Got stuck? Move to a clear spot</button><button id="replay-tutorial">Replay tutorial</button></section><section><h3>Progress</h3><button id="update-game">Update game safely</button><p class="fine">${If()}</p></section></div>`),et("#sound").onchange=n=>{wr=n.target.checked,Bs()},et("#ambient").onchange=n=>{Tr=n.target.checked,Bs()},et("#music").onchange=n=>{Ms=n.target.checked,Bs()},et("#vehicle-sound").onchange=n=>{Ss=n.target.checked,Bs()},et("#volume").oninput=n=>{vi=+n.target.value,Bs()},et("#shadows").onchange=n=>{Rl=n.target.checked,Ei.shadowMap.enabled=Rl},et("#rescue-now").onclick=()=>{et("#dialog").close(),Qt?vf():mo()},et("#replay-tutorial").onclick=()=>{kt=0,et("#dialog").close(),fi(Jn[0][0],Jn[0][1],"Got it",Jn[0][2]),De()},et("#update-game").onclick=()=>{De();const n=Qi.getItem("movecraft-rewrite-v1");n&&Qi.setItem("movecraft-update-backup",n);const t=new URL(location.href);t.searchParams.set("update",Date.now().toString()),location.replace(t)}};et("#stuck-button").onclick=()=>Qt?vf():mo();et("#help").onclick=()=>ir("<h2>Moving controls</h2><p>WASD / arrows move. Shift sprints. Space jumps. Drag to orbit, scroll or pinch to zoom.</p><p>E lifts and places. R rotates. Stand at the rear and press Q once to secure the entire load with a net. F enters/exits the cab. W/S drives/brakes; A/D steer. G raises or lowers the rear.</p><p>Unsecured furniture can be damaged or fall through an open rear. Stand still on an upgrade field to invest automatically.</p>");document.addEventListener("wheel",n=>{(n.ctrlKey||n.metaKey)&&n.preventDefault()},{passive:!1});for(const n of["gesturestart","gesturechange","gestureend"])document.addEventListener(n,t=>t.preventDefault(),{passive:!1});document.addEventListener("touchmove",n=>{n.touches.length>1&&!(n.target instanceof HTMLCanvasElement)&&n.preventDefault()},{passive:!1});window.addEventListener("keydown",n=>{(n.ctrlKey||n.metaKey)&&["Equal","Minus","Digit0","NumpadAdd","NumpadSubtract","Numpad0"].includes(n.code)&&n.preventDefault()},{capture:!0});window.addEventListener("keydown",n=>{if(et("#dialog").open||(["KeyW","KeyA","KeyS","KeyD","ArrowUp","ArrowDown","ArrowLeft","ArrowRight","ShiftLeft","Space"].includes(n.code)&&(Ne.add(n.code),n.preventDefault()),n.repeat))return;n.code==="Space"&&NM();const t={KeyE:"interact",KeyF:"cab",KeyR:"rotate",KeyG:"rear",KeyQ:"secure"};t[n.code]&&Sf[t[n.code]]()});window.addEventListener("keyup",n=>Ne.delete(n.code));window.addEventListener("blur",()=>Ne.clear());document.querySelectorAll("[data-key]").forEach(n=>{n.onpointerdown=t=>{n.setPointerCapture(t.pointerId),Ne.add(n.dataset.key)},n.onpointerup=n.onpointercancel=()=>Ne.delete(n.dataset.key)});function ka(){const n=Math.max(1,et("#world").clientWidth),t=Math.max(1,et("#world").clientHeight);Ei.setSize(n,t,!1);const e=n/t;Oe.left=-12*e,Oe.right=12*e,Oe.top=12,Oe.bottom=-12,gn.minZoom=Math.max(.55,e/4),Oe.zoom=Math.max(Oe.zoom,gn.minZoom),Oe.updateProjectionMatrix()}window.addEventListener("resize",ka);window.visualViewport?.addEventListener("resize",ka);new ResizeObserver(ka).observe(et("#world"));oo();HM();af.copy(At.position);co();zn();ka();hu();et("#daily-button").classList.toggle("ready",W.daily.lastClaim!==new Date().toISOString().slice(0,10));kt===0&&W.jobs===0&&fi(Jn[0][0],Jn[0][1],"Got it",Jn[0][2]);ho();rr()&&!je&&(Ys=.8);gn.target.copy(ot.position);Oe.position.add(ot.position);gn.update();let Kh=!1,Zh=performance.now(),Nl=0;function Ef(n){const t=Math.min((n-Zh)/1e3,.1);Zh=n,we+=t,Ys>0?(Ys-=t,Ys<=0&&ba()):rr()&&!je&&et("#tutorial-card").hidden&&!et("#dialog").open&&ba(),DM(t),vr=ue.damp(vr,Bi,3,t),Tc=ue.damp(Tc,_a,8,t),uf();const e=IM(t);UM(t);const i=Qt?Cc:Pc,r=Qt?lu():ot.position;for((!i.length||we-i[i.length-1].t>=.35)&&i.push({t:we,x:r.x,z:r.z});i.length&&we-i[0].t>10;)i.shift();const s=i.length>1&&we-i[0].t>=9.5&&i.every(d=>Math.hypot(d.x-i[0].x,d.z-i[0].z)<(Qt?4:1.5));for(;Zi.length&&we-Zi[0]>10;)Zi.shift();const o=Qt&&Zi.length>=3,a=!et("#tutorial-card").hidden||et("#dialog").open||!et("#tests").hidden||!et("#company-panel").hidden;for(a&&(i.length=0,Zi.length=0),et("#stuck-button").hidden=!!xe||a||!(s||o),et("#stuck-button").textContent=Qt?"Truck stuck?":"Got stuck?",Qt?Pc.length=0:(Cc.length=0,Zi.length=0),xe||_r.animate(we,e,!!zt||!!ze,es),RM(t),zt&&(zt.mesh.rotation.y=ue.damp(zt.mesh.rotation.y,zt.item.rotated?Math.PI/2:0,12,t)),Nl+=t;Nl>=1/60;){const d=FM(.016666666666666666);hM(ee,1/60,{truck:At,back:Te,speed:Ie,yawRate:d.yawRate,acceleration:d.acceleration,rearOpen:vr>.9,enclosed:!!At.userData.enclosed,gear:W.levels.truck,now:we,onDamage:(h,f,_)=>{const y=Math.min(f,100-(h.damage??0));h.damage=(h.damage??0)+y,y>0&&tr.push({item:h.item.name,reason:_,points:y}),we-os>.7&&(os=we,Vt(`−${y} points · ${h.item.name}: ${_}`))},onFall:h=>{Vt(`${h.item.name} fell out. Stop and recover it.`),oi(140,.25)}}),Nl-=1/60}if(OM(t),bM(t),lf(),BM(t),ji.visible){const d=cu(ji.position),h=d?6808973:16768099;of.color.setHex(h)}const c=Qt?ii(new A(3,.6,(Te-2)/2)):ot.position.clone().add(new A(0,.6,0)),l=c.clone().sub(gn.target);if(gn.target.copy(c),Oe.position.add(l),ki.position.copy(c).add(new A(-25,45,20)),ki.target.position.copy(c),gn.update(),Fn.visible=!!zt&&ps(),Fn.visible){const d=uu();Fn.scale.set(d.w*Ut,1,d.d*Ut),Fn.position.copy(ii(new A(1.4+(d.x+d.w/2)*Ut,.82,.2+(d.z+d.d/2)*Ut))),Fn.rotation.y=At.rotation.y,Fn.material.color.set(d.valid?2386770:13974845),Fn.material.opacity=d.valid?.62:.82,ou.material.color.set(d.valid?1195825:7282464)}const u=zt&&!ps()?df(zt):null;if(Kn.visible=!!u&&ot.position.distanceTo(u.target)<18,u&&zt&&(Kn.position.x=u.target.x,Kn.position.z=u.target.z,Kn.scale.set(zt.item.w*Ut,zt.item.d*Ut,1),Kn.material.color.setHex(u.close?4828784:15321180)),Ni.visible=!!zt&&!ps()&&ff(ot.position)&&!u?.close,Ni.visible&&zt){const d=ot.position.clone().add(new A(0,0,1.1).applyQuaternion(ot.quaternion));Ni.position.set(d.x,.105,d.z),Ni.scale.set(zt.item.w*Ut,zt.item.d*Ut,1)}va-=t,va<=0&&et("#status-bar").classList.remove("show-notice"),Dl+=t,Pl+=t,Dl>.18&&(hu(),Dl=0),Pl>5&&(De(),Pl=0),Ei.render(Pe,Oe),Kh||(Kh=!0,document.getElementById("loading-screen")?.remove()),!et("#dialog").open&&et("#tests").hidden&&et("#company-panel").hidden&&(et("#tutorial-card").hidden||kt>0),requestAnimationFrame(Ef)}requestAnimationFrame(Ef);window.addEventListener("pagehide",De);
