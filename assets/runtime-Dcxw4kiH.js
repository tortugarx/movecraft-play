...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function E_(n,t,e){return new Mi({name:"SphericalGaussianBlur",defines:{SAMPLES:x_,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:ya(),fragmentShader:`
	...
	`}class Td extends jn{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const i={width:t,height:t,depth:1},r=[i,i,i,i,i,i];this.texture=new md(r),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new er(5,5,5),s=new Mi({name:"CubemapFromEquirect",uniforms:hs(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:En,blending:Li});s.uniforms.tEquirect.value=e;const o=new Ot(r,s),a=e.minFilter;return e.minFilter===dr&&(e.minFilter=ln),new Am(1,10,this).update(t,o),e.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(t,e=!0,i=!0,r=!0){const s=t.getRenderTarget();for(let o=0;o<6;o++)t.setRenderTarget(this,o),t.clear(e,i,r);t.setRenderTarget(s)}}function w_(n){let t=new WeakMap,e=new WeakMap,i=null;function r(d,f=!1){return d==null?null:f?o(d):s(d)}function s(d){if(d&&d.isTexture){const f=d.mapping;if(f===Da||f===La)if(t.has(d)){const g=t.get(d).texture;return a(g,d.mapping)}else{const g=d.image;if(g&&g.height>0){const S=new Td(g.height);return S.fromEquirectangularTexture(n,d),t.set(d,S),d.addEventListener("dispose",l),a(S.texture,d.mapping)}else return null}}return d}function o(d){if(d&&d.isTexture){const f=d.mapping,g=f===Da||f===La,S=f===Mr||f===us;if(g||S){let m=e.get(d);const p=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==p)return i===null&&(i=new sh(n)),m=g?i.fromEquirectangular(d,m):i.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,e.set(d,m),m.texture;if(m!==void 0)return m.texture;{const b=d.image;return g&&b&&b.height>0||S&&b&&c(b)?(i===null&&(i=new sh(n)),m=g?i.fromEquirectangular(d):i.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,e.set(d,m),d.addEventListener("dispose",u),m.texture):null}}}return d}function a(d,f){return f===Da?d.mapping=Mr:f===La&&(d.mapping=us),d}function c(d){let f=0;const g=6;for(let S=0;S<g;S++)d[S]!==void 0&&f++;return f===g}function l(d){const f=d.target;f.removeEventListener("dispose",l);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function u(d){const f=d.target;f.removeEventListener("dispose",u);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function h(){t=new WeakMap,e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function T_(n){const t={};function e(i){if(t[i]!==void 0)return t[i];const r=n.getExtension(i);return t[i]=r,r}return{has:function(i){return e(i)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(i){const r=e(i);return r===null&&es("WebGLRenderer: "+i+" extension not supported."),r}}}function A_(n,t,e,i){const r={},s=new WeakMap;function o(h){const d=h.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete r[d.id];const f=s.get(d);f&&(t.remove(f),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(h,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,e.memory.geometries++),d}function c(h){const d=h.attributes;for(const f in d)t.update(d[f],n.ARRAY_BUFFER)}function l(h){const d=[],f=h.index,g=h.attributes.position;let S=0;if(g===void 0)return;if(f!==null){const b=f.array;S=f.version;for(let w=0,x=b.length;w<x;w+=3){const _=b[w+0],M=b[w+1],R=b[w+2];d.push(_,M,M,R,R,_)}}else{const b=g.array;S=g.version;for(let w=0,x=b.length/3-1;w<x;w+=3){const _=w+0,M=w+1,R=w+2;d.push(_,M,M,R,R,_)}}const m=new(g.count>=65535?dd:hd)(d,1);m.version=S;const p=s.get(h);p&&t.remove(p),s.set(h,m)}function u(h){const d=s.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&l(h)}else l(h);return s.get(h)}return{get:a,update:c,getWireframeAttribute:u}}function R_(n,t,e){let i;function r(h){i=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function c(h,d){n.drawElements(i,d,s,h*o),e.update(d,i,1)}function l(h,d,f){f!==0&&(n.drawElementsInstanced(i,d,s,h*o,f),e.update(d,i,f))}function u(h,d,f){if(f===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,s,h,0,f);let S=0;for(let m=0;m<f;m++)S+=d[m];e.update(S,i,1)}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u}function C_(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(e.calls++,o){case n.TRIANGLES:e.triangles+=a*(s/3);break;case n.LINES:e.lines+=a*(s/2);break;case n.LINE_STRIP:e.lines+=a*(s-1);break;case n.LINE_LOOP:e.lines+=a*s;break;case n.POINTS:e.points+=a*s;break;default:ie("WebGLInfo: Unknown draw mode:",o);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:i}}function P_(n,t,e){const i=new WeakMap,r=new Le;function s(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=i.get(a);if(d===void 0||d.count!==h){let T=function(){R.dispose(),i.delete(a),a.removeEventListener("dispose",T)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,S=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],b=a.morphAttributes.color||[];let w=0;f===!0&&(w=1),g===!0&&(w=2),S===!0&&(w=3);let x=a.attributes.position.count*w,_=1;x>t.maxTextureSize&&(_=Math.ceil(x/t.maxTextureSize),x=t.maxTextureSize);const M=new Float32Array(x*_*4*h),R=new ld(M,x,_,h);R.type=hi,R.needsUpdate=!0;const v=w*4;for(let D=0;D<h;D++){const L=m[D],O=p[D],k=b[D],I=x*_*4*D;for(let G=0;G<L.count;G++){const $=G*v;f===!0&&(r.fromBufferAttribute(L,G),M[I+$+0]=r.x,M[I+$+1]=r.y,M[I+$+2]=r.z,M[I+$+3]=0),g===!0&&(r.fromBufferAttribute(O,G),M[I+$+4]=r.x,M[I+$+5]=r.y,M[I+$+6]=r.z,M[I+$+7]=0),S===!0&&(r.fromBufferAttribute(k,G),M[I+$+8]=r.x,M[I+$+9]=r.y,M[I+$+10]=r.z,M[I+$+11]=k.itemSize===4?r.w:1)}}d={count:h,texture:R,size:new ct(x,_)},i.set(a,d),a.addEventListener("dispose",T)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,e);else{let f=0;for(let S=0;S<l.length;S++)f+=l[S];const g=a.morphTargetsRelative?1:1-f;c.getUniforms().setValue(n,"morphTargetBaseInfluence",g),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",d.texture,e),c.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:s}}function D_(n,t,e,i,r){let s=new WeakMap;function o(l){const u=r.render.frame,h=l.geometry,d=t.get(l,h);if(s.get(d)!==u&&(t.update(d),s.set(d,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==u&&(e.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,n.ARRAY_BUFFER),s.set(l,u))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==u&&(f.update(),s.set(f,u))}return d}function a(){s=new WeakMap}function c(l){const u=l.target;u.removeEventListener("dispose",c),i.releaseStatesOfObject(u),e.remove(u.instanceMatrix),u.instanceColor!==null&&e.remove(u.instanceColor)}return{update:o,dispose:a}}const L_={[$h]:"LINEAR_TONE_MAPPING",[Yh]:"REINHARD_TONE_MAPPING",[qh]:"CINEON_TONE_MAPPING",[Cc]:"ACES_FILMIC_TONE_MAPPING",[Zh]:"AGX_TONE_MAPPING",[Jh]:"NEUTRAL_TONE_MAPPING",[Kh]:"CUSTOM_TONE_MAPPING"};function I_(n,t,e,i,r,s){const o=new jn(t,e,{type:n,depthBuffer:r,stencilBuffer:s,samples:i?4:0,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,resolveDepthBuffer:!1,resolveStencilBuffer:!1});let a=null,c=null;const l=new Oe;l.setAttribute("position",new se([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new se([0,2,0,0,2,0],2));const u=new Mm({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new Ot(l,u),d=new Ma(-1,1,1,-1,0,1);let f=null,g=null,S=!1,m,p=null,b=[],w=!1;this.setSize=function(x,_){o.setSize(x,_),a!==null&&a.setSize(x,_),c!==null&&c.setSize(x,_);for(let M=0;M<b.length;M++){const R=b[M];R.setSize&&R.setSize(x,_)}},this.setEffects=function(x){b=x,w=b.length>0&&b[0].isRenderPass===!0;const _=o.width,M=o.height;b.length>0&&a===null&&(a=new jn(_,M,{type:_i,depthBuffer:!1,stencilBuffer:!1}),c=new jn(_,M,{type:_i,depthBuffer:!1,stencilBuffer:!1}));for(let R=0;R<b.length;R++){const v=b[R];v.setSize&&v.setSize(_,M)}},this.begin=function(x,_){if(S||x.toneMapping===pi&&b.length===0)return!1;if(p=_,_!==null){const M=_.width,R=_.height;(o.width!==M||o.height!==R)&&this.setSize(M,R)}return w===!1&&x.setRenderTarget(o),m=x.toneMapping,x.toneMapping=pi,!0},this.hasRenderPass=function(){return w},this.end=function(x,_){x.toneMapping=m,S=!0;let M=o,R=a;for(let v=0;v<b.length;v++){const T=b[v];T.enabled!==!1&&(T.render(x,R,M,_),T.needsSwap!==!1&&(M=R,R=R===a?c:a))}if(f!==x.outputColorSpace||g!==x.toneMapping){f=x.outputColorSpace,g=x.toneMapping,u.defines={},jt.getTransfer(f)===de&&(u.defines.SRGB_TRANSFER="");const v=L_[g];v&&(u.defines[v]=""),u.needsUpdate=!0}u.uniforms.tDiffuse.value=M.texture,x.setRenderTarget(p),x.render(h,d),p=null,S=!1},this.isCompositing=function(){return S},this.dispose=function(){o.dispose(),a!==null&&a.dispose(),c!==null&&c.dispose(),l.dispose(),u.dispose()}}const Ad=new cn,hc=new Ks(1,1),Rd=new ld,Cd=new Pp,Pd=new md,ch=[],uh=[],hh=new Float32Array(16),dh=new Float32Array(9),fh=new Float32Array(4);function xs(n,t,e){const i=n[0];if(i<=0||i>0)return n;const r=t*e;let s=ch[r];if(s===void 0&&(s=new Float32Array(r),ch[r]=s),t!==0){i.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,n[o].toArray(s,a)}return s}function qe(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function Ke(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function Sa(n,t){let e=uh[t];e===void 0&&(e=new Int32Array(t),uh[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function N_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function U_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;n.uniform2fv(this.addr,t),Ke(e,t)}}function F_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(qe(e,t))return;n.uniform3fv(this.addr,t),Ke(e,t)}}function O_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;n.uniform4fv(this.addr,t),Ke(e,t)}}function B_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(qe(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),Ke(e,t)}else{if(qe(e,i))return;fh.set(i),n.uniformMatrix2fv(this.addr,!1,fh),Ke(e,i)}}function z_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(qe(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),Ke(e,t)}else{if(qe(e,i))return;dh.set(i),n.uniformMatrix3fv(this.addr,!1,dh),Ke(e,i)}}function k_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(qe(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),Ke(e,t)}else{if(qe(e,i))return;hh.set(i),n.uniformMatrix4fv(this.addr,!1,hh),Ke(e,i)}}function G_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function H_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;n.uniform2iv(this.addr,t),Ke(e,t)}}function V_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(qe(e,t))return;n.uniform3iv(this.addr,t),Ke(e,t)}}function W_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;n.uniform4iv(this.addr,t),Ke(e,t)}}function X_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function $_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;n.uniform2uiv(this.addr,t),Ke(e,t)}}function Y_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(qe(e,t))return;n.uniform3uiv(this.addr,t),Ke(e,t)}}function q_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;n.uniform4uiv(this.addr,t),Ke(e,t)}}function K_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(hc.compareFunction=e.isReversedDepthBuffer()?Oc:Fc,s=hc):s=Ad,e.setTexture2D(t||s,r)}function Z_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture3D(t||Cd,r)}function J_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTextureCube(t||Pd,r)}function Q_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture2DArray(t||Rd,r)}function j_(n){switch(n){case 5126:return N_;case 35664:return U_;case 35665:return F_;case 35666:return O_;case 35674:return B_;case 35675:return z_;case 35676:return k_;case 5124:case 35670:return G_;case 35667:case 35671:return H_;case 35668:case 35672:return V_;case 35669:case 35673:return W_;case 5125:return X_;case 36294:return $_;case 36295:return Y_;case 36296:return q_;case 35678:case 36198:case 36298:case 36306:case 35682:return K_;case 35679:case 36299:case 36307:return Z_;case 35680:case 36300:case 36308:case 36293:return J_;case 36289:case 36303:case 36311:case 36292:return Q_}}function tv(n,t){n.uniform1fv(this.addr,t)}function ev(n,t){const e=xs(t,this.size,2);n.uniform2fv(this.addr,e)}function nv(n,t){const e=xs(t,this.size,3);n.uniform3fv(this.addr,e)}function iv(n,t){const e=xs(t,this.size,4);n.uniform4fv(this.addr,e)}function rv(n,t){const e=xs(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function sv(n,t){const e=xs(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function ov(n,t){const e=xs(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function av(n,t){n.uniform1iv(this.addr,t)}function lv(n,t){n.uniform2iv(this.addr,t)}function cv(n,t){n.uniform3iv(this.addr,t)}function uv(n,t){n.uniform4iv(this.addr,t)}function hv(n,t){n.uniform1uiv(this.addr,t)}function dv(n,t){n.uniform2uiv(this.addr,t)}function fv(n,t){n.uniform3uiv(this.addr,t)}function pv(n,t){n.uniform4uiv(this.addr,t)}function mv(n,t,e){const i=this.cache,r=t.length,s=Sa(e,r);qe(i,s)||(n.uniform1iv(this.addr,s),Ke(i,s));let o;this.type===n.SAMPLER_2D_SHADOW?o=hc:o=Ad;for(let a=0;a!==r;++a)e.setTexture2D(t[a]||o,s[a])}function gv(n,t,e){const i=this.cache,r=t.length,s=Sa(e,r);qe(i,s)||(n.uniform1iv(this.addr,s),Ke(i,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||Cd,s[o])}function _v(n,t,e){const i=this.cache,r=t.length,s=Sa(e,r);qe(i,s)||(n.uniform1iv(this.addr,s),Ke(i,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||Pd,s[o])}function vv(n,t,e){const i=this.cache,r=t.length,s=Sa(e,r);qe(i,s)||(n.uniform1iv(this.addr,s),Ke(i,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||Rd,s[o])}function xv(n){switch(n){case 5126:return tv;case 35664:return ev;case 35665:return nv;case 35666:return iv;case 35674:return rv;case 35675:return sv;case 35676:return ov;case 5124:case 35670:return av;case 35667:case 35671:return lv;case 35668:case 35672:return cv;case 35669:case 35673:return uv;case 5125:return hv;case 36294:return dv;case 36295:return fv;case 36296:return pv;case 35678:case 36198:case 36298:case 36306:case 35682:return mv;case 35679:case 36299:case 36307:return gv;case 35680:case 36300:case 36308:case 36293:return _v;case 36289:case 36303:case 36311:case 36292:return vv}}class Mv{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=j_(e.type)}}class yv{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=xv(e.type)}}class Sv{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(t,e[a.id],i)}}}const dl=/(\w+)(\])?(\[|\.)?/g;function ph(n,t){n.seq.push(t),n.map[t.id]=t}function bv(n,t,e){const i=n.name,r=i.length;for(dl.lastIndex=0;;){const s=dl.exec(i),o=dl.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){ph(e,l===void 0?new Mv(a,n,t):new yv(a,n,t));break}else{let h=e.map[a];h===void 0&&(h=new Sv(a),ph(e,h)),e=h}}}class Yo{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=t.getActiveUniform(e,o),c=t.getUniformLocation(e,a.name);bv(a,c,this)}const r=[],s=[];for(const o of this.seq)o.type===t.SAMPLER_2D_SHADOW||o.type===t.SAMPLER_CUBE_SHADOW||o.type===t.SAMPLER_2D_ARRAY_SHADOW?r.push(o):s.push(o);r.length>0&&(this.seq=r.concat(s))}setValue(t,e,i,r){const s=this.map[e];s!==void 0&&s.setValue(t,i,r)}setOptional(t,e,i){const r=e[i];r!==void 0&&this.setValue(t,i,r)}static upload(t,e,i,r){for(let s=0,o=e.length;s!==o;++s){const a=e[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,r)}}static seqWithValue(t,e){const i=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&i.push(o)}return i}}function mh(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const Ev=37297;let wv=0;function Tv(n,t){const e=n.split(`
`),i=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return i.join(`
`)}const gh=new zt;function Av(n){jt._getMatrix(gh,jt.workingColorSpace,n);const t=`mat3( ${gh.elements.map(e=>e.toFixed(4))} )`;switch(jt.getTransfer(n)){case ta:return[t,"LinearTransferOETF"];case de:return[t,"sRGBTransferOETF"];default:return Nt("WebGLProgram: Unsupported color space: ",n),[t,"LinearTransferOETF"]}}function _h(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),s=(n.getShaderInfoLog(t)||"").trim();if(i&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return e.toUpperCase()+`

`+s+`

`+Tv(n.getShaderSource(t),a)}else return s}function Rv(n,t){const e=Av(t);return[`vec4 ${n}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}const Cv={[$h]:"Linear",[Yh]:"Reinhard",[qh]:"Cineon",[Cc]:"ACESFilmic",[Zh]:"AgX",[Jh]:"Neutral",[Kh]:"Custom"};function Pv(n,t){const e=Cv[t];return e===void 0?(Nt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Bo=new A;function Dv(){jt.getLuminanceCoefficients(Bo);const n=Bo.x.toFixed(4),t=Bo.y.toFixed(4),e=Bo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Lv(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ns).join(`
`)}function Iv(n){const t=[];for(const e in n){const i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function Nv(n,t){const e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(t,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:n.getAttribLocation(t,o),locationSize:a}}return e}function Ns(n){return n!==""}function vh(n,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_SUN_LIGHTS/g,t.numSunLights).replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_SUN_LIGHT_SHADOWS/g,t.numSunLightShadows).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function xh(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Uv=/^[ \t]*#include +<([\w\d./]+)>/gm;function dc(n){return n.replace(Uv,Ov)}const Fv=new Map;function Ov(n,t){let e=Wt[t];if(e===void 0){const i=Fv.get(t);if(i!==void 0)e=Wt[i],Nt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+t+">")}return dc(e)}const Bv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Mh(n){return n.replace(Bv,zv)}function zv(n,t,e,i){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function yh(n){let t=`precision ${n.precision} float;
...
#define LOW_PRECISION`),t}const kv={[Ho]:"SHADOWMAP_TYPE_PCF",[Is]:"SHADOWMAP_TYPE_VSM"};function Gv(n){return kv[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Hv={[Mr]:"ENVMAP_TYPE_CUBE",[us]:"ENVMAP_TYPE_CUBE",[va]:"ENVMAP_TYPE_CUBE_UV"};function Vv(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":Hv[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const Wv={[us]:"ENVMAP_MODE_REFRACTION"};function Xv(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":Wv[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const $v={[Xh]:"ENVMAP_BLENDING_MULTIPLY",[Yf]:"ENVMAP_BLENDING_MIX",[qf]:"ENVMAP_BLENDING_ADD"};function Yv(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":$v[n.combine]||"ENVMAP_BLENDING_NONE"}function qv(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function Kv(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=Gv(e),l=Vv(e),u=Xv(e),h=Yv(e),d=qv(e),f=Lv(e),g=Iv(s),S=r.createProgram();let m,p,b=e.glslVersion?"#version "+e.glslVersion+`
...
}`,dx=[new A(1,0,0),new A(-1,0,0),new A(0,1,0),new A(0,-1,0),new A(0,0,1),new A(0,0,-1)],fx=[new A(0,-1,0),new A(0,-1,0),new A(0,0,1),new A(0,0,-1),new A(0,-1,0),new A(0,-1,0)],wh=new Re,Ps=new A,fl=new A;function px(n,t,e){let i=new Hc;const r=new ct,s=new ct,o=new Le,a=new ym,c=new Sm,l={},u=e.maxTextureSize,h={[xr]:En,[En]:xr,[gn]:gn},d=new Mi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ct},radius:{value:4}},vertexShader:ux,fragmentShader:hx}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Oe;g.setAttribute("position",new ti(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new Ot(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ho;let p=this.type;this.render=function(M,R,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||M.length===0)return;this.type===Hh&&(Nt("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=Ho);const T=n.getRenderTarget(),D=n.getActiveCubeFace(),L=n.getActiveMipmapLevel(),O=n.state;O.setBlending(Li),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const k=p!==this.type;k&&R.traverse(function(I){I.material&&(Array.isArray(I.material)?I.material.forEach(G=>G.needsUpdate=!0):I.material.needsUpdate=!0)});for(let I=0,G=M.length;I<G;I++){const $=M[I],K=$.shadow;if(K===void 0){Nt("WebGLShadowMap:",$,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;r.copy(K.mapSize);const nt=K.getFrameExtents();r.multiply(nt),s.copy(K.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/nt.x),r.x=s.x*nt.x,K.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/nt.y),r.y=s.y*nt.y,K.mapSize.y=s.y));const Y=n.state.buffers.depth.getReversed();if(K.camera._reversedDepth=Y,K.map===null||k===!0){if(K.map!==null&&(K.map.depthTexture!==null&&(K.map.depthTexture.dispose(),K.map.depthTexture=null),K.map.dispose()),this.type===Is){if($.isPointLight){Nt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}K.map=new jn(r.x,r.y,{format:yr,type:_i,minFilter:ln,magFilter:ln,generateMipmaps:!1}),K.map.texture.name=$.name+".shadowMap",K.map.depthTexture=new Ks(r.x,r.y,hi),K.map.depthTexture.name=$.name+".shadowMapDepth",K.map.depthTexture.format=Fi,K.map.depthTexture.compareFunction=null,K.map.depthTexture.minFilter=en,K.map.depthTexture.magFilter=en}else $.isPointLight?(K.map=new Td(r.x),K.map.depthTexture=new jp(r.x,gi)):(K.map=new jn(r.x,r.y),K.map.depthTexture=new Ks(r.x,r.y,gi)),K.map.depthTexture.name=$.name+".shadowMap",K.map.depthTexture.format=Fi,this.type===Ho?(K.map.depthTexture.compareFunction=Y?Oc:Fc,K.map.depthTexture.minFilter=ln,K.map.depthTexture.magFilter=ln):(K.map.depthTexture.compareFunction=null,K.map.depthTexture.minFilter=en,K.map.depthTexture.magFilter=en);K.camera.updateProjectionMatrix()}K.map.isWebGLCubeRenderTarget!==!0&&(K.map.width!==r.x||K.map.height!==r.y)&&K.map.setSize(r.x,r.y);const tt=K.map.isWebGLCubeRenderTarget?6:K.getViewportCount();$.isPointLight!==!0&&K.updateMatrices($,v);for(let rt=0;rt<tt;rt++){const lt=K.getCamera(rt);if($.isPointLight){const bt=K.camera,Me=K.matrix,ee=$.distance||bt.far;ee!==bt.far&&(bt.far=ee,bt.updateProjectionMatrix()),Ps.setFromMatrixPosition($.matrixWorld),bt.position.copy(Ps),fl.copy(bt.position),fl.add(dx[rt]),bt.up.copy(fx[rt]),bt.lookAt(fl),bt.updateMatrixWorld(),Me.makeTranslation(-Ps.x,-Ps.y,-Ps.z),wh.multiplyMatrices(bt.projectionMatrix,bt.matrixWorldInverse),K._frustum.setFromProjectionMatrix(wh,bt.coordinateSystem,bt.reversedDepth)}if(K.map.isWebGLCubeRenderTarget)n.setRenderTarget(K.map,rt),n.clear();else{rt===0&&(n.setRenderTarget(K.map),n.clear());const bt=K.getViewport(rt);o.set(s.x*bt.x,s.y*bt.y,s.x*bt.z,s.y*bt.w),O.viewport(o)}i=K.getFrustum(rt),x(R,v,lt,$,this.type)}K.isPointLightShadow!==!0&&this.type===Is&&b(K,v),K.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(T,D,L)};function b(M,R){const v=t.update(S);d.defines.VSM_SAMPLES!==M.blurSamples&&(d.defines.VSM_SAMPLES=M.blurSamples,f.defines.VSM_SAMPLES=M.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),M.mapPass===null?M.mapPass=new jn(r.x,r.y,{format:yr,type:_i}):(M.mapPass.width!==M.map.width||M.mapPass.height!==M.map.height)&&M.mapPass.setSize(M.map.width,M.map.height),d.uniforms.shadow_pass.value=M.map.depthTexture,d.uniforms.resolution.value.set(M.map.width,M.map.height),d.uniforms.radius.value=M.radius,n.setRenderTarget(M.mapPass),n.clear(),n.renderBufferDirect(R,null,v,d,S,null),f.uniforms.shadow_pass.value=M.mapPass.texture,f.uniforms.resolution.value.set(M.map.width,M.map.height),f.uniforms.radius.value=M.radius,n.setRenderTarget(M.map),n.clear(),n.renderBufferDirect(R,null,v,f,S,null)}function w(M,R,v,T){let D=null;const L=v.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(L!==void 0)D=L;else if(D=v.isPointLight===!0?c:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const O=D.uuid,k=R.uuid;let I=l[O];I===void 0&&(I={},l[O]=I);let G=I[k];G===void 0&&(G=D.clone(),I[k]=G,R.addEventListener("dispose",_)),D=G}if(D.visible=R.visible,D.wireframe=R.wireframe,T===Is?D.side=R.shadowSide!==null?R.shadowSide:R.side:D.side=R.shadowSide!==null?R.shadowSide:h[R.side],D.alphaMap=R.alphaMap,D.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,D.map=R.map,D.clipShadows=R.clipShadows,D.clippingPlanes=R.clippingPlanes,D.clipIntersection=R.clipIntersection,D.displacementMap=R.displacementMap,D.displacementScale=R.displacementScale,D.displacementBias=R.displacementBias,D.wireframeLinewidth=R.wireframeLinewidth,D.linewidth=R.linewidth,v.isPointLight===!0&&D.isMeshDistanceMaterial===!0){const O=n.properties.get(D);O.light=v}return D}function x(M,R,v,T,D){if(M.visible===!1)return;if(M.layers.test(R.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&D===Is)&&(!M.frustumCulled||M.intersectsFrustum(i))){M.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,M.matrixWorld);const k=t.update(M),I=M.material;if(Array.isArray(I)){const G=k.groups;for(let $=0,K=G.length;$<K;$++){const nt=G[$],Y=I[nt.materialIndex];if(Y&&Y.visible){const tt=w(M,Y,T,D);M.onBeforeShadow(n,M,R,v,k,tt,nt),n.renderBufferDirect(v,null,k,tt,M,nt),M.onAfterShadow(n,M,R,v,k,tt,nt)}}}else if(I.visible){const G=w(M,I,T,D);M.onBeforeShadow(n,M,R,v,k,G,null),n.renderBufferDirect(v,null,k,G,M,null),M.onAfterShadow(n,M,R,v,k,G,null)}}const O=M.children;for(let k=0,I=O.length;k<I;k++)x(O[k],R,v,T,D)}function _(M){M.target.removeEventListener("dispose",_);for(const v in l){const T=l[v],D=M.target.uuid;D in T&&(T[D].dispose(),delete T[D])}}}function mx(n,t){function e(){let U=!1;const ft=new Le;let j=null;const pt=new Le(0,0,0,0);return{setMask:function(xt){j!==xt&&!U&&(n.colorMask(xt,xt,xt,xt),j=xt)},setLocked:function(xt){U=xt},setClear:function(xt,st,Dt,At,Se){Se===!0&&(xt*=At,st*=At,Dt*=At),ft.set(xt,st,Dt,At),pt.equals(ft)===!1&&(n.clearColor(xt,st,Dt,At),pt.copy(ft))},reset:function(){U=!1,j=null,pt.set(-1,0,0,0)}}}function i(){let U=!1,ft=!1,j=null,pt=null,xt=null;return{setReversed:function(st){if(ft!==st){const Dt=t.get("EXT_clip_control");st?Dt.clipControlEXT(Dt.LOWER_LEFT_EXT,Dt.ZERO_TO_ONE_EXT):Dt.clipControlEXT(Dt.LOWER_LEFT_EXT,Dt.NEGATIVE_ONE_TO_ONE_EXT),ft=st;const At=xt;xt=null,this.setClear(At)}},getReversed:function(){return ft},setTest:function(st){st?it(n.DEPTH_TEST):Et(n.DEPTH_TEST)},setMask:function(st){j!==st&&!U&&(n.depthMask(st),j=st)},setFunc:function(st){if(ft&&(st=lp[st]),pt!==st){switch(st){case wl:n.depthFunc(n.NEVER);break;case Tl:n.depthFunc(n.ALWAYS);break;case Al:n.depthFunc(n.LESS);break;case Ws:n.depthFunc(n.LEQUAL);break;case Rl:n.depthFunc(n.EQUAL);break;case Cl:n.depthFunc(n.GEQUAL);break;case Pl:n.depthFunc(n.GREATER);break;case Dl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}pt=st}},setLocked:function(st){U=st},setClear:function(st){xt!==st&&(xt=st,ft&&(st=1-st),n.clearDepth(st))},reset:function(){U=!1,j=null,pt=null,xt=null,ft=!1}}}function r(){let U=!1,ft=null,j=null,pt=null,xt=null,st=null,Dt=null,At=null,Se=null;return{setTest:function(ae){U||(ae?it(n.STENCIL_TEST):Et(n.STENCIL_TEST))},setMask:function(ae){ft!==ae&&!U&&(n.stencilMask(ae),ft=ae)},setFunc:function(ae,kn,ri){(j!==ae||pt!==kn||xt!==ri)&&(n.stencilFunc(ae,kn,ri),j=ae,pt=kn,xt=ri)},setOp:function(ae,kn,ri){(st!==ae||Dt!==kn||At!==ri)&&(n.stencilOp(ae,kn,ri),st=ae,Dt=kn,At=ri)},setLocked:function(ae){U=ae},setClear:function(ae){Se!==ae&&(n.clearStencil(ae),Se=ae)},reset:function(){U=!1,ft=null,j=null,pt=null,xt=null,st=null,Dt=null,At=null,Se=null}}}const s=new e,o=new i,a=new r,c=new WeakMap,l=new WeakMap;let u={},h={},d={},f=new WeakMap,g=[],S=null,m=!1,p=null,b=null,w=null,x=null,_=null,M=null,R=null,v=new $t(0,0,0),T=0,D=!1,L=null,O=null,k=null,I=null,G=null;const $=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,nt=0;const Y=n.getParameter(n.VERSION);Y.indexOf("WebGL")!==-1?(nt=parseFloat(/^WebGL (\d)/.exec(Y)[1]),K=nt>=1):Y.indexOf("OpenGL ES")!==-1&&(nt=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),K=nt>=2);let tt=null,rt={};const lt=n.getParameter(n.SCISSOR_BOX),bt=n.getParameter(n.VIEWPORT),Me=new Le().fromArray(lt),ee=new Le().fromArray(bt);function oe(U,ft,j,pt){const xt=new Uint8Array(4),st=n.createTexture();n.bindTexture(U,st),n.texParameteri(U,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(U,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Dt=0;Dt<j;Dt++)U===n.TEXTURE_3D||U===n.TEXTURE_2D_ARRAY?n.texImage3D(ft,0,n.RGBA,1,1,pt,0,n.RGBA,n.UNSIGNED_BYTE,xt):n.texImage2D(ft+Dt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,xt);return st}const Z={};Z[n.TEXTURE_2D]=oe(n.TEXTURE_2D,n.TEXTURE_2D,1),Z[n.TEXTURE_CUBE_MAP]=oe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[n.TEXTURE_2D_ARRAY]=oe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Z[n.TEXTURE_3D]=oe(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),it(n.DEPTH_TEST),o.setFunc(Ws),Jt(!1),Ce(Mu),it(n.CULL_FACE),re(Li);function it(U){u[U]!==!0&&(n.enable(U),u[U]=!0)}function Et(U){u[U]!==!1&&(n.disable(U),u[U]=!1)}function Bt(U,ft){return d[U]!==ft?(n.bindFramebuffer(U,ft),d[U]=ft,U===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=ft),U===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=ft),!0):!1}function yt(U,ft){let j=g,pt=!1;if(U){j=f.get(ft),j===void 0&&(j=[],f.set(ft,j));const xt=U.textures;if(j.length!==xt.length||j[0]!==n.COLOR_ATTACHMENT0){for(let st=0,Dt=xt.length;st<Dt;st++)j[st]=n.COLOR_ATTACHMENT0+st;j.length=xt.length,pt=!0}}else j[0]!==n.BACK&&(j[0]=n.BACK,pt=!0);pt&&n.drawBuffers(j)}function Yt(U){return S!==U?(n.useProgram(U),S=U,!0):!1}const Xe={[Zr]:n.FUNC_ADD,[Pf]:n.FUNC_SUBTRACT,[Df]:n.FUNC_REVERSE_SUBTRACT};Xe[Lf]=n.MIN,Xe[If]=n.MAX;const Kt={[Nf]:n.ZERO,[Uf]:n.ONE,[Ff]:n.SRC_COLOR,[Vh]:n.SRC_ALPHA,[Hf]:n.SRC_ALPHA_SATURATE,[kf]:n.DST_COLOR,[Bf]:n.DST_ALPHA,[Of]:n.ONE_MINUS_SRC_COLOR,[Wh]:n.ONE_MINUS_SRC_ALPHA,[Gf]:n.ONE_MINUS_DST_COLOR,[zf]:n.ONE_MINUS_DST_ALPHA,[Vf]:n.CONSTANT_COLOR,[Wf]:n.ONE_MINUS_CONSTANT_COLOR,[Xf]:n.CONSTANT_ALPHA,[$f]:n.ONE_MINUS_CONSTANT_ALPHA};function re(U,ft,j,pt,xt,st,Dt,At,Se,ae){if(U===Li){m===!0&&(Et(n.BLEND),m=!1);return}if(m===!1&&(it(n.BLEND),m=!0),U!==Cf){if(U!==p||ae!==D){if((b!==Zr||_!==Zr)&&(n.blendEquation(n.FUNC_ADD),b=Zr,_=Zr),ae)switch(U){case Fs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case yu:n.blendFunc(n.ONE,n.ONE);break;case Su:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case bu:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:ie("WebGLState: Invalid blending: ",U);break}else switch(U){case Fs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case yu:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Su:ie("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case bu:ie("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ie("WebGLState: Invalid blending: ",U);break}w=null,x=null,M=null,R=null,v.set(0,0,0),T=0,p=U,D=ae}return}xt=xt||ft,st=st||j,Dt=Dt||pt,(ft!==b||xt!==_)&&(n.blendEquationSeparate(Xe[ft],Xe[xt]),b=ft,_=xt),(j!==w||pt!==x||st!==M||Dt!==R)&&(n.blendFuncSeparate(Kt[j],Kt[pt],Kt[st],Kt[Dt]),w=j,x=pt,M=st,R=Dt),(At.equals(v)===!1||Se!==T)&&(n.blendColor(At.r,At.g,At.b,Se),v.copy(At),T=Se),p=U,D=!1}function ye(U,ft){U.side===gn?Et(n.CULL_FACE):it(n.CULL_FACE);let j=U.side===En;ft&&(j=!j),Jt(j),U.blending===Fs&&U.transparent===!1?re(Li):re(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const pt=U.stencilWrite;a.setTest(pt),pt&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),vn(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?it(n.SAMPLE_ALPHA_TO_COVERAGE):Et(n.SAMPLE_ALPHA_TO_COVERAGE)}function Jt(U){L!==U&&(U?n.frontFace(n.CW):n.frontFace(n.CCW),L=U)}function Ce(U){U!==Af?(it(n.CULL_FACE),U!==O&&(U===Mu?n.cullFace(n.BACK):U===Rf?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Et(n.CULL_FACE),O=U}function Ze(U){U!==k&&(K&&n.lineWidth(U),k=U)}function vn(U,ft,j){U?(it(n.POLYGON_OFFSET_FILL),(I!==ft||G!==j)&&(I=ft,G=j,o.getReversed()&&(ft=-ft),n.polygonOffset(ft,j))):Et(n.POLYGON_OFFSET_FILL)}function De(U){U?it(n.SCISSOR_TEST):Et(n.SCISSOR_TEST)}function Be(U){U===void 0&&(U=n.TEXTURE0+$-1),tt!==U&&(n.activeTexture(U),tt=U)}function F(U,ft,j){j===void 0&&(tt===null?j=n.TEXTURE0+$-1:j=tt);let pt=rt[j];pt===void 0&&(pt={type:void 0,texture:void 0},rt[j]=pt),(pt.type!==U||pt.texture!==ft)&&(tt!==j&&(n.activeTexture(j),tt=j),n.bindTexture(U,ft||Z[U]),pt.type=U,pt.texture=ft)}function nn(){const U=rt[tt];U!==void 0&&U.type!==void 0&&(n.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function he(){try{n.compressedTexImage2D(...arguments)}catch(U){ie("WebGLState:",U)}}function C(){try{n.compressedTexImage3D(...arguments)}catch(U){ie("WebGLState:",U)}}function y(){try{n.texSubImage2D(...arguments)}catch(U){ie("WebGLState:",U)}}function z(){try{n.texSubImage3D(...arguments)}catch(U){ie("WebGLState:",U)}}function W(){try{n.compressedTexSubImage2D(...arguments)}catch(U){ie("WebGLState:",U)}}function q(){try{n.compressedTexSubImage3D(...arguments)}catch(U){ie("WebGLState:",U)}}function at(){try{n.texStorage2D(...arguments)}catch(U){ie("WebGLState:",U)}}function ut(){try{n.texStorage3D(...arguments)}catch(U){ie("WebGLState:",U)}}function J(){try{n.texImage2D(...arguments)}catch(U){ie("WebGLState:",U)}}function et(){try{n.texImage3D(...arguments)}catch(U){ie("WebGLState:",U)}}function ht(U){return h[U]!==void 0?h[U]:n.getParameter(U)}function Ct(U,ft){h[U]!==ft&&(n.pixelStorei(U,ft),h[U]=ft)}function mt(U){Me.equals(U)===!1&&(n.scissor(U.x,U.y,U.z,U.w),Me.copy(U))}function dt(U){ee.equals(U)===!1&&(n.viewport(U.x,U.y,U.z,U.w),ee.copy(U))}function Pt(U,ft){let j=l.get(ft);j===void 0&&(j=new WeakMap,l.set(ft,j));let pt=j.get(U);pt===void 0&&(pt=n.getUniformBlockIndex(ft,U.name),j.set(U,pt))}function It(U,ft){const pt=l.get(ft).get(U);c.get(ft)!==pt&&(n.uniformBlockBinding(ft,pt,U.__bindingPointIndex),c.set(ft,pt))}function Ht(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},h={},tt=null,rt={},d={},f=new WeakMap,g=[],S=null,m=!1,p=null,b=null,w=null,x=null,_=null,M=null,R=null,v=new $t(0,0,0),T=0,D=!1,L=null,O=null,k=null,I=null,G=null,Me.set(0,0,n.canvas.width,n.canvas.height),ee.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:it,disable:Et,bindFramebuffer:Bt,drawBuffers:yt,useProgram:Yt,setBlending:re,setMaterial:ye,setFlipSided:Jt,setCullFace:Ce,setLineWidth:Ze,setPolygonOffset:vn,setScissorTest:De,activeTexture:Be,bindTexture:F,unbindTexture:nn,compressedTexImage2D:he,compressedTexImage3D:C,texImage2D:J,texImage3D:et,pixelStorei:Ct,getParameter:ht,updateUBOMapping:Pt,uniformBlockBinding:It,texStorage2D:at,texStorage3D:ut,texSubImage2D:y,texSubImage3D:z,compressedTexSubImage2D:W,compressedTexSubImage3D:q,scissor:mt,viewport:dt,reset:Ht}}function gx(n,t,e,i,r,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ct,u=new WeakMap,h=new Set;let d;const f=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(C,y){return g?new OffscreenCanvas(C,y):ea("canvas")}function m(C,y,z){let W=1;const q=he(C);if((q.width>z||q.height>z)&&(W=z/Math.max(q.width,q.height)),W<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const at=Math.floor(W*q.width),ut=Math.floor(W*q.height);d===void 0&&(d=S(at,ut));const J=y?S(at,ut):d;return J.width=at,J.height=ut,J.getContext("2d").drawImage(C,0,0,at,ut),Nt("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+at+"x"+ut+")."),J}else return"data"in C&&Nt("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),C;return C}function p(C){return C.generateMipmaps}function b(C){n.generateMipmap(C)}function w(C){return C.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?n.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function x(C,y,z,W,q,at=!1){if(C!==null){if(n[C]!==void 0)return n[C];Nt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let ut;W&&(ut=t.get("EXT_texture_norm16"),ut||Nt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let J=y;if(y===n.RED&&(z===n.FLOAT&&(J=n.R32F),z===n.HALF_FLOAT&&(J=n.R16F),z===n.UNSIGNED_BYTE&&(J=n.R8),z===n.UNSIGNED_SHORT&&ut&&(J=ut.R16_EXT),z===n.SHORT&&ut&&(J=ut.R16_SNORM_EXT)),y===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(J=n.R8UI),z===n.UNSIGNED_SHORT&&(J=n.R16UI),z===n.UNSIGNED_INT&&(J=n.R32UI),z===n.BYTE&&(J=n.R8I),z===n.SHORT&&(J=n.R16I),z===n.INT&&(J=n.R32I)),y===n.RG&&(z===n.FLOAT&&(J=n.RG32F),z===n.HALF_FLOAT&&(J=n.RG16F),z===n.UNSIGNED_BYTE&&(J=n.RG8),z===n.UNSIGNED_SHORT&&ut&&(J=ut.RG16_EXT),z===n.SHORT&&ut&&(J=ut.RG16_SNORM_EXT)),y===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(J=n.RG8UI),z===n.UNSIGNED_SHORT&&(J=n.RG16UI),z===n.UNSIGNED_INT&&(J=n.RG32UI),z===n.BYTE&&(J=n.RG8I),z===n.SHORT&&(J=n.RG16I),z===n.INT&&(J=n.RG32I)),y===n.RGB_INTEGER&&(z===n.UNSIGNED_BYTE&&(J=n.RGB8UI),z===n.UNSIGNED_SHORT&&(J=n.RGB16UI),z===n.UNSIGNED_INT&&(J=n.RGB32UI),z===n.BYTE&&(J=n.RGB8I),z===n.SHORT&&(J=n.RGB16I),z===n.INT&&(J=n.RGB32I)),y===n.RGBA_INTEGER&&(z===n.UNSIGNED_BYTE&&(J=n.RGBA8UI),z===n.UNSIGNED_SHORT&&(J=n.RGBA16UI),z===n.UNSIGNED_INT&&(J=n.RGBA32UI),z===n.BYTE&&(J=n.RGBA8I),z===n.SHORT&&(J=n.RGBA16I),z===n.INT&&(J=n.RGBA32I)),y===n.RGB&&(z===n.UNSIGNED_SHORT&&ut&&(J=ut.RGB16_EXT),z===n.SHORT&&ut&&(J=ut.RGB16_SNORM_EXT),z===n.UNSIGNED_INT_5_9_9_9_REV&&(J=n.RGB9_E5),z===n.UNSIGNED_INT_10F_11F_11F_REV&&(J=n.R11F_G11F_B10F)),y===n.RGBA){const et=at?ta:jt.getTransfer(q);z===n.FLOAT&&(J=n.RGBA32F),z===n.HALF_FLOAT&&(J=n.RGBA16F),z===n.UNSIGNED_BYTE&&(J=et===de?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT&&ut&&(J=ut.RGBA16_EXT),z===n.SHORT&&ut&&(J=ut.RGBA16_SNORM_EXT),z===n.UNSIGNED_SHORT_4_4_4_4&&(J=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(J=n.RGB5_A1)}return(J===n.R16F||J===n.R32F||J===n.RG16F||J===n.RG32F||J===n.RGBA16F||J===n.RGBA32F)&&t.get("EXT_color_buffer_float"),J}function _(C,y){let z;return C?y===null||y===gi||y===$s?z=n.DEPTH24_STENCIL8:y===hi?z=n.DEPTH32F_STENCIL8:y===Xs&&(z=n.DEPTH24_STENCIL8,Nt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===gi||y===$s?z=n.DEPTH_COMPONENT24:y===hi?z=n.DEPTH_COMPONENT32F:y===Xs&&(z=n.DEPTH_COMPONENT16),z}function M(C,y){return p(C)===!0||C.isFramebufferTexture&&C.minFilter!==en&&C.minFilter!==ln?Math.log2(Math.max(y.width,y.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?y.mipmaps.length:1}function R(C){const y=C.target;y.removeEventListener("dispose",R),T(y),y.isVideoTexture&&u.delete(y),y.isHTMLTexture&&h.delete(y)}function v(C){const y=C.target;y.removeEventListener("dispose",v),L(y)}function T(C){const y=i.get(C);if(y.__webglInit===void 0)return;const z=C.source,W=f.get(z);if(W){const q=W[y.__cacheKey];q.usedTimes--,q.usedTimes===0&&D(C),Object.keys(W).length===0&&f.delete(z)}i.remove(C)}function D(C){const y=i.get(C);n.deleteTexture(y.__webglTexture);const z=C.source,W=f.get(z);delete W[y.__cacheKey],o.memory.textures--}function L(C){const y=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(y.__webglFramebuffer[W]))for(let q=0;q<y.__webglFramebuffer[W].length;q++)n.deleteFramebuffer(y.__webglFramebuffer[W][q]);else n.deleteFramebuffer(y.__webglFramebuffer[W]);y.__webglDepthbuffer&&n.deleteRenderbuffer(y.__webglDepthbuffer[W])}else{if(Array.isArray(y.__webglFramebuffer))for(let W=0;W<y.__webglFramebuffer.length;W++)n.deleteFramebuffer(y.__webglFramebuffer[W]);else n.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&n.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&n.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let W=0;W<y.__webglColorRenderbuffer.length;W++)y.__webglColorRenderbuffer[W]&&n.deleteRenderbuffer(y.__webglColorRenderbuffer[W]);y.__webglDepthRenderbuffer&&n.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const z=C.textures;for(let W=0,q=z.length;W<q;W++){const at=i.get(z[W]);at.__webglTexture&&(n.deleteTexture(at.__webglTexture),o.memory.textures--),i.remove(z[W])}i.remove(C)}let O=0;function k(){O=0}function I(){return O}function G(C){O=C}function $(){const C=O;return C>=r.maxTextures&&Nt("WebGLTextures: Trying to use "+(C+1)+" texture units while this GPU supports only "+r.maxTextures),O+=1,C}function K(C){const y=[];return y.push(C.wrapS),y.push(C.wrapT),y.push(C.wrapR||0),y.push(C.magFilter),y.push(C.minFilter),y.push(C.anisotropy),y.push(C.internalFormat),y.push(C.format),y.push(C.type),y.push(C.generateMipmaps),y.push(C.premultiplyAlpha),y.push(C.flipY),y.push(C.unpackAlignment),y.push(C.colorSpace),y.join()}function nt(C,y){const z=i.get(C);if(C.isVideoTexture&&F(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&z.__version!==C.version){const W=C.image;if(W===null)Nt("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Nt("WebGLRenderer: Texture marked for update but image is incomplete");else{Et(z,C,y);return}}else C.isExternalTexture&&(z.__webglTexture=C.sourceTexture?C.sourceTexture:null);e.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+y)}function Y(C,y){const z=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&z.__version!==C.version){Et(z,C,y);return}else C.isExternalTexture&&(z.__webglTexture=C.sourceTexture?C.sourceTexture:null);e.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+y)}function tt(C,y){const z=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&z.__version!==C.version){Et(z,C,y);return}e.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+y)}function rt(C,y){const z=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&z.__version!==C.version){Bt(z,C,y);return}e.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+y)}const lt={[Ll]:n.REPEAT,[Pi]:n.CLAMP_TO_EDGE,[Il]:n.MIRRORED_REPEAT},bt={[en]:n.NEAREST,[Kf]:n.NEAREST_MIPMAP_NEAREST,[lo]:n.NEAREST_MIPMAP_LINEAR,[ln]:n.LINEAR,[Ia]:n.LINEAR_MIPMAP_NEAREST,[dr]:n.LINEAR_MIPMAP_LINEAR},Me={[jf]:n.NEVER,[rp]:n.ALWAYS,[tp]:n.LESS,[Fc]:n.LEQUAL,[ep]:n.EQUAL,[Oc]:n.GEQUAL,[np]:n.GREATER,[ip]:n.NOTEQUAL};function ee(C,y){if(y.type===hi&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===ln||y.magFilter===Ia||y.magFilter===lo||y.magFilter===dr||y.minFilter===ln||y.minFilter===Ia||y.minFilter===lo||y.minFilter===dr)&&Nt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(C,n.TEXTURE_WRAP_S,lt[y.wrapS]),n.texParameteri(C,n.TEXTURE_WRAP_T,lt[y.wrapT]),(C===n.TEXTURE_3D||C===n.TEXTURE_2D_ARRAY)&&n.texParameteri(C,n.TEXTURE_WRAP_R,lt[y.wrapR]),n.texParameteri(C,n.TEXTURE_MAG_FILTER,bt[y.magFilter]),n.texParameteri(C,n.TEXTURE_MIN_FILTER,bt[y.minFilter]),y.compareFunction&&(n.texParameteri(C,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(C,n.TEXTURE_COMPARE_FUNC,Me[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===en||y.minFilter!==lo&&y.minFilter!==dr||y.type===hi&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||i.get(y).__currentAnisotropy){const z=t.get("EXT_texture_filter_anisotropic");n.texParameterf(C,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,r.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy}}}function oe(C,y){let z=!1;C.__webglInit===void 0&&(C.__webglInit=!0,y.addEventListener("dispose",R));const W=y.source;let q=f.get(W);q===void 0&&(q={},f.set(W,q));const at=K(y);if(at!==C.__cacheKey){q[at]===void 0&&(q[at]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,z=!0),q[at].usedTimes++;const ut=q[C.__cacheKey];ut!==void 0&&(q[C.__cacheKey].usedTimes--,ut.usedTimes===0&&D(y)),C.__cacheKey=at,C.__webglTexture=q[at].texture}return z}function Z(C,y,z){return Math.floor(Math.floor(C/z)/y)}function it(C,y,z,W){const at=C.updateRanges;if(at.length===0)e.texSubImage2D(n.TEXTURE_2D,0,0,0,y.width,y.height,z,W,y.data);else{at.sort((Ct,mt)=>Ct.start-mt.start);let ut=0;for(let Ct=1;Ct<at.length;Ct++){const mt=at[ut],dt=at[Ct],Pt=mt.start+mt.count,It=Z(dt.start,y.width,4),Ht=Z(mt.start,y.width,4);dt.start<=Pt+1&&It===Ht&&Z(dt.start+dt.count-1,y.width,4)===It?mt.count=Math.max(mt.count,dt.start+dt.count-mt.start):(++ut,at[ut]=dt)}at.length=ut+1;const J=e.getParameter(n.UNPACK_ROW_LENGTH),et=e.getParameter(n.UNPACK_SKIP_PIXELS),ht=e.getParameter(n.UNPACK_SKIP_ROWS);e.pixelStorei(n.UNPACK_ROW_LENGTH,y.width);for(let Ct=0,mt=at.length;Ct<mt;Ct++){const dt=at[Ct],Pt=Math.floor(dt.start/4),It=Math.ceil(dt.count/4),Ht=Pt%y.width,U=Math.floor(Pt/y.width),ft=It,j=1;e.pixelStorei(n.UNPACK_SKIP_PIXELS,Ht),e.pixelStorei(n.UNPACK_SKIP_ROWS,U),e.texSubImage2D(n.TEXTURE_2D,0,Ht,U,ft,j,z,W,y.data)}C.clearUpdateRanges(),e.pixelStorei(n.UNPACK_ROW_LENGTH,J),e.pixelStorei(n.UNPACK_SKIP_PIXELS,et),e.pixelStorei(n.UNPACK_SKIP_ROWS,ht)}}function Et(C,y,z){let W=n.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(W=n.TEXTURE_2D_ARRAY),y.isData3DTexture&&(W=n.TEXTURE_3D);const q=oe(C,y),at=y.source;e.bindTexture(W,C.__webglTexture,n.TEXTURE0+z);const ut=i.get(at);if(at.version!==ut.__version||q===!0){if(e.activeTexture(n.TEXTURE0+z),(typeof ImageBitmap<"u"&&y.image instanceof ImageBitmap)===!1){const j=jt.getPrimaries(jt.workingColorSpace),pt=y.colorSpace===Ki?null:jt.getPrimaries(y.colorSpace),xt=y.colorSpace===Ki||j===pt?n.NONE:n.BROWSER_DEFAULT_WEBGL;e.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,y.flipY),e.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),e.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,xt)}e.pixelStorei(n.UNPACK_ALIGNMENT,y.unpackAlignment);let et=m(y.image,!1,r.maxTextureSize);et=nn(y,et);const ht=s.convert(y.format,y.colorSpace),Ct=s.convert(y.type);let mt=x(y.internalFormat,ht,Ct,y.normalized,y.colorSpace,y.isVideoTexture);ee(W,y);let dt;const Pt=y.mipmaps,It=y.isVideoTexture!==!0,Ht=ut.__version===void 0||q===!0,U=at.dataReady,ft=M(y,et);if(y.isDepthTexture)mt=_(y.format===fr,y.type),Ht&&(It?e.texStorage2D(n.TEXTURE_2D,1,mt,et.width,et.height):e.texImage2D(n.TEXTURE_2D,0,mt,et.width,et.height,0,ht,Ct,null));else if(y.isDataTexture)if(Pt.length>0){It&&Ht&&e.texStorage2D(n.TEXTURE_2D,ft,mt,Pt[0].width,Pt[0].height);for(let j=0,pt=Pt.length;j<pt;j++)dt=Pt[j],It?U&&e.texSubImage2D(n.TEXTURE_2D,j,0,0,dt.width,dt.height,ht,Ct,dt.data):e.texImage2D(n.TEXTURE_2D,j,mt,dt.width,dt.height,0,ht,Ct,dt.data);y.generateMipmaps=!1}else It?(Ht&&e.texStorage2D(n.TEXTURE_2D,ft,mt,et.width,et.height),U&&it(y,et,ht,Ct)):e.texImage2D(n.TEXTURE_2D,0,mt,et.width,et.height,0,ht,Ct,et.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){It&&Ht&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ft,mt,Pt[0].width,Pt[0].height,et.depth);for(let j=0,pt=Pt.length;j<pt;j++)if(dt=Pt[j],y.format!==Qn)if(ht!==null)if(It){if(U)if(y.layerUpdates.size>0){const xt=ih(dt.width,dt.height,y.format,y.type);for(const st of y.layerUpdates){const Dt=dt.data.subarray(st*xt/dt.data.BYTES_PER_ELEMENT,(st+1)*xt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,j,0,0,st,dt.width,dt.height,1,ht,Dt)}}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,j,0,0,0,dt.width,dt.height,et.depth,ht,dt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,j,mt,dt.width,dt.height,et.depth,0,dt.data,0,0);else Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else It?U&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,j,0,0,0,dt.width,dt.height,et.depth,ht,Ct,dt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,j,mt,dt.width,dt.height,et.depth,0,ht,Ct,dt.data);y.layerUpdates.size>0&&y.clearLayerUpdates()}else{It&&Ht&&e.texStorage2D(n.TEXTURE_2D,ft,mt,Pt[0].width,Pt[0].height);for(let j=0,pt=Pt.length;j<pt;j++)dt=Pt[j],y.format!==Qn?ht!==null?It?U&&e.compressedTexSubImage2D(n.TEXTURE_2D,j,0,0,dt.width,dt.height,ht,dt.data):e.compressedTexImage2D(n.TEXTURE_2D,j,mt,dt.width,dt.height,0,dt.data):Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?U&&e.texSubImage2D(n.TEXTURE_2D,j,0,0,dt.width,dt.height,ht,Ct,dt.data):e.texImage2D(n.TEXTURE_2D,j,mt,dt.width,dt.height,0,ht,Ct,dt.data)}else if(y.isDataArrayTexture)if(It){if(Ht&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ft,mt,et.width,et.height,et.depth),U)if(y.layerUpdates.size>0){const j=ih(et.width,et.height,y.format,y.type);for(const pt of y.layerUpdates){const xt=et.data.subarray(pt*j/et.data.BYTES_PER_ELEMENT,(pt+1)*j/et.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,pt,et.width,et.height,1,ht,Ct,xt)}y.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,et.width,et.height,et.depth,ht,Ct,et.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,mt,et.width,et.height,et.depth,0,ht,Ct,et.data);else if(y.isData3DTexture)It?(Ht&&e.texStorage3D(n.TEXTURE_3D,ft,mt,et.width,et.height,et.depth),U&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,et.width,et.height,et.depth,ht,Ct,et.data)):e.texImage3D(n.TEXTURE_3D,0,mt,et.width,et.height,et.depth,0,ht,Ct,et.data);else if(y.isFramebufferTexture){if(Ht)if(It)e.texStorage2D(n.TEXTURE_2D,ft,mt,et.width,et.height);else{let j=et.width,pt=et.height;for(let xt=0;xt<ft;xt++)e.texImage2D(n.TEXTURE_2D,xt,mt,j,pt,0,ht,Ct,null),j>>=1,pt>>=1}}else if(y.isHTMLTexture){if("texElementImage2D"in n){const j=n.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),et.parentNode!==j){j.appendChild(et),h.add(y),j.onpaint=pt=>{const xt=pt.changedElements;for(const st of h)xt.includes(st.image)&&(st.needsUpdate=!0)},j.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,et);else{const xt=n.RGBA,st=n.RGBA,Dt=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,xt,st,Dt,et)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Pt.length>0){if(It&&Ht){const j=he(Pt[0]);e.texStorage2D(n.TEXTURE_2D,ft,mt,j.width,j.height)}for(let j=0,pt=Pt.length;j<pt;j++)dt=Pt[j],It?U&&e.texSubImage2D(n.TEXTURE_2D,j,0,0,ht,Ct,dt):e.texImage2D(n.TEXTURE_2D,j,mt,ht,Ct,dt);y.generateMipmaps=!1}else if(It){if(Ht){const j=he(et);e.texStorage2D(n.TEXTURE_2D,ft,mt,j.width,j.height)}U&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,ht,Ct,et)}else e.texImage2D(n.TEXTURE_2D,0,mt,ht,Ct,et);p(y)&&b(W),ut.__version=at.version,y.onUpdate&&y.onUpdate(y)}C.__version=y.version}function Bt(C,y,z){if(y.image.length!==6)return;const W=oe(C,y),q=y.source;e.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+z);const at=i.get(q);if(q.version!==at.__version||W===!0){e.activeTexture(n.TEXTURE0+z);const ut=jt.getPrimaries(jt.workingColorSpace),J=y.colorSpace===Ki?null:jt.getPrimaries(y.colorSpace),et=y.colorSpace===Ki||ut===J?n.NONE:n.BROWSER_DEFAULT_WEBGL;e.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,y.flipY),e.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),e.pixelStorei(n.UNPACK_ALIGNMENT,y.unpackAlignment),e.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,et);const ht=y.isCompressedTexture||y.image[0].isCompressedTexture,Ct=y.image[0]&&y.image[0].isDataTexture,mt=[];for(let st=0;st<6;st++)!ht&&!Ct?mt[st]=m(y.image[st],!0,r.maxCubemapSize):mt[st]=Ct?y.image[st].image:y.image[st],mt[st]=nn(y,mt[st]);const dt=mt[0],Pt=s.convert(y.format,y.colorSpace),It=s.convert(y.type),Ht=x(y.internalFormat,Pt,It,y.normalized,y.colorSpace),U=y.isVideoTexture!==!0,ft=at.__version===void 0||W===!0,j=q.dataReady;let pt=M(y,dt);ee(n.TEXTURE_CUBE_MAP,y);let xt;if(ht){U&&ft&&e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Ht,dt.width,dt.height);for(let st=0;st<6;st++){xt=mt[st].mipmaps;for(let Dt=0;Dt<xt.length;Dt++){const At=xt[Dt];y.format!==Qn?Pt!==null?U?j&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Dt,0,0,At.width,At.height,Pt,At.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Dt,Ht,At.width,At.height,0,At.data):Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?j&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Dt,0,0,At.width,At.height,Pt,It,At.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Dt,Ht,At.width,At.height,0,Pt,It,At.data)}}}else{if(xt=y.mipmaps,U&&ft){xt.length>0&&pt++;const st=he(mt[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Ht,st.width,st.height)}for(let st=0;st<6;st++)if(Ct){U?j&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,mt[st].width,mt[st].height,Pt,It,mt[st].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Ht,mt[st].width,mt[st].height,0,Pt,It,mt[st].data);for(let Dt=0;Dt<xt.length;Dt++){const Se=xt[Dt].image[st].image;U?j&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Dt+1,0,0,Se.width,Se.height,Pt,It,Se.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Dt+1,Ht,Se.width,Se.height,0,Pt,It,Se.data)}}else{U?j&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,Pt,It,mt[st]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Ht,Pt,It,mt[st]);for(let Dt=0;Dt<xt.length;Dt++){const At=xt[Dt];U?j&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Dt+1,0,0,Pt,It,At.image[st]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Dt+1,Ht,Pt,It,At.image[st])}}}p(y)&&b(n.TEXTURE_CUBE_MAP),at.__version=q.version,y.onUpdate&&y.onUpdate(y)}C.__version=y.version}function yt(C,y,z,W,q,at){const ut=s.convert(z.format,z.colorSpace),J=s.convert(z.type),et=x(z.internalFormat,ut,J,z.normalized,z.colorSpace),ht=i.get(y),Ct=i.get(z);if(Ct.__renderTarget=y,!ht.__hasExternalTextures){const mt=Math.max(1,y.width>>at),dt=Math.max(1,y.height>>at);q===n.TEXTURE_3D||q===n.TEXTURE_2D_ARRAY?e.texImage3D(q,at,et,mt,dt,y.depth,0,ut,J,null):e.texImage2D(q,at,et,mt,dt,0,ut,J,null)}e.bindFramebuffer(n.FRAMEBUFFER,C),Be(y)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,W,q,Ct.__webglTexture,0,De(y)):(q===n.TEXTURE_2D||q>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,W,q,Ct.__webglTexture,at),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Yt(C,y,z){if(n.bindRenderbuffer(n.RENDERBUFFER,C),y.depthBuffer){const W=y.depthTexture,q=W&&W.isDepthTexture?W.type:null,at=_(y.stencilBuffer,q),ut=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Be(y)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,De(y),at,y.width,y.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,De(y),at,y.width,y.height):n.renderbufferStorage(n.RENDERBUFFER,at,y.width,y.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ut,n.RENDERBUFFER,C)}else{const W=y.textures;for(let q=0;q<W.length;q++){const at=W[q],ut=s.convert(at.format,at.colorSpace),J=s.convert(at.type),et=x(at.internalFormat,ut,J,at.normalized,at.colorSpace);Be(y)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,De(y),et,y.width,y.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,De(y),et,y.width,y.height):n.renderbufferStorage(n.RENDERBUFFER,et,y.width,y.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Xe(C,y,z){const W=y.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(n.FRAMEBUFFER,C),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const q=i.get(y.depthTexture);if(q.__renderTarget=y,(!q.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),W){if(q.__webglInit===void 0&&(q.__webglInit=!0,y.depthTexture.addEventListener("dispose",R)),q.__webglTexture===void 0){q.__webglTexture=n.createTexture(),e.bindTexture(n.TEXTURE_CUBE_MAP,q.__webglTexture),ee(n.TEXTURE_CUBE_MAP,y.depthTexture);const ht=s.convert(y.depthTexture.format),Ct=s.convert(y.depthTexture.type);let mt;y.depthTexture.format===Fi?mt=n.DEPTH_COMPONENT24:y.depthTexture.format===fr&&(mt=n.DEPTH24_STENCIL8);for(let dt=0;dt<6;dt++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0,mt,y.width,y.height,0,ht,Ct,null)}}else nt(y.depthTexture,0);const at=q.__webglTexture,ut=De(y),J=W?n.TEXTURE_CUBE_MAP_POSITIVE_X+z:n.TEXTURE_2D,et=y.depthTexture.format===fr?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(y.depthTexture.format===Fi)Be(y)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,et,J,at,0,ut):n.framebufferTexture2D(n.FRAMEBUFFER,et,J,at,0);else if(y.depthTexture.format===fr)Be(y)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,et,J,at,0,ut):n.framebufferTexture2D(n.FRAMEBUFFER,et,J,at,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Kt(C){const y=i.get(C),z=C.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==C.depthTexture){const W=C.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),W){const q=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,W.removeEventListener("dispose",q)};W.addEventListener("dispose",q),y.__depthDisposeCallback=q}y.__boundDepthTexture=W}if(C.depthTexture&&!y.__autoAllocateDepthBuffer)if(z)for(let W=0;W<6;W++)Xe(y.__webglFramebuffer[W],C,W);else{const W=C.texture.mipmaps;W&&W.length>0?Xe(y.__webglFramebuffer[0],C,0):Xe(y.__webglFramebuffer,C,0)}else if(z){y.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(e.bindFramebuffer(n.FRAMEBUFFER,y.__webglFramebuffer[W]),y.__webglDepthbuffer[W]===void 0)y.__webglDepthbuffer[W]=n.createRenderbuffer(),Yt(y.__webglDepthbuffer[W],C,!1);else{const q=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,at=y.__webglDepthbuffer[W];n.bindRenderbuffer(n.RENDERBUFFER,at),n.framebufferRenderbuffer(n.FRAMEBUFFER,q,n.RENDERBUFFER,at)}}else{const W=C.texture.mipmaps;if(W&&W.length>0?e.bindFramebuffer(n.FRAMEBUFFER,y.__webglFramebuffer[0]):e.bindFramebuffer(n.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=n.createRenderbuffer(),Yt(y.__webglDepthbuffer,C,!1);else{const q=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,at=y.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,at),n.framebufferRenderbuffer(n.FRAMEBUFFER,q,n.RENDERBUFFER,at)}}e.bindFramebuffer(n.FRAMEBUFFER,null)}function re(C,y,z){const W=i.get(C);y!==void 0&&yt(W.__webglFramebuffer,C,C.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&Kt(C)}function ye(C){const y=C.texture,z=i.get(C),W=i.get(y);C.addEventListener("dispose",v);const q=C.textures,at=C.isWebGLCubeRenderTarget===!0,ut=q.length>1;if(ut||(W.__webglTexture===void 0&&(W.__webglTexture=n.createTexture()),W.__version=y.version,o.memory.textures++),at){z.__webglFramebuffer=[];for(let J=0;J<6;J++)if(y.mipmaps&&y.mipmaps.length>0){z.__webglFramebuffer[J]=[];for(let et=0;et<y.mipmaps.length;et++)z.__webglFramebuffer[J][et]=n.createFramebuffer()}else z.__webglFramebuffer[J]=n.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){z.__webglFramebuffer=[];for(let J=0;J<y.mipmaps.length;J++)z.__webglFramebuffer[J]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(ut)for(let J=0,et=q.length;J<et;J++){const ht=i.get(q[J]);ht.__webglTexture===void 0&&(ht.__webglTexture=n.createTexture(),o.memory.textures++)}if(C.samples>0&&Be(C)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let J=0;J<q.length;J++){const et=q[J];z.__webglColorRenderbuffer[J]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[J]);const ht=s.convert(et.format,et.colorSpace),Ct=s.convert(et.type),mt=x(et.internalFormat,ht,Ct,et.normalized,et.colorSpace,C.isXRRenderTarget===!0),dt=De(C);n.renderbufferStorageMultisample(n.RENDERBUFFER,dt,mt,C.width,C.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+J,n.RENDERBUFFER,z.__webglColorRenderbuffer[J])}n.bindRenderbuffer(n.RENDERBUFFER,null),C.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),Yt(z.__webglDepthRenderbuffer,C,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(at){e.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture),ee(n.TEXTURE_CUBE_MAP,y);for(let J=0;J<6;J++)if(y.mipmaps&&y.mipmaps.length>0)for(let et=0;et<y.mipmaps.length;et++)yt(z.__webglFramebuffer[J][et],C,y,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+J,et);else yt(z.__webglFramebuffer[J],C,y,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0);p(y)&&b(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ut){for(let J=0,et=q.length;J<et;J++){const ht=q[J],Ct=i.get(ht);let mt=n.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(mt=C.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(mt,Ct.__webglTexture),ee(mt,ht),yt(z.__webglFramebuffer,C,ht,n.COLOR_ATTACHMENT0+J,mt,0),p(ht)&&b(mt)}e.unbindTexture()}else{let J=n.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(J=C.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(J,W.__webglTexture),ee(J,y),y.mipmaps&&y.mipmaps.length>0)for(let et=0;et<y.mipmaps.length;et++)yt(z.__webglFramebuffer[et],C,y,n.COLOR_ATTACHMENT0,J,et);else yt(z.__webglFramebuffer,C,y,n.COLOR_ATTACHMENT0,J,0);p(y)&&b(J),e.unbindTexture()}C.depthBuffer&&Kt(C)}function Jt(C){const y=C.textures;for(let z=0,W=y.length;z<W;z++){const q=y[z];if(p(q)){const at=w(C),ut=i.get(q).__webglTexture;e.bindTexture(at,ut),b(at),e.unbindTexture()}}}const Ce=[],Ze=[];function vn(C){if(C.samples>0){if(Be(C)===!1){const y=C.textures,z=C.width,W=C.height;let q=n.COLOR_BUFFER_BIT;const at=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ut=i.get(C),J=y.length>1;if(J)for(let ht=0;ht<y.length;ht++)e.bindFramebuffer(n.FRAMEBUFFER,ut.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,ut.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,ut.__webglMultisampledFramebuffer);const et=C.texture.mipmaps;et&&et.length>0?e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ut.__webglFramebuffer[0]):e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ut.__webglFramebuffer);for(let ht=0;ht<y.length;ht++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(q|=n.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(q|=n.STENCIL_BUFFER_BIT)),J){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ut.__webglColorRenderbuffer[ht]);const Ct=i.get(y[ht]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ct,0)}n.blitFramebuffer(0,0,z,W,0,0,z,W,q,n.NEAREST),c===!0&&(Ce.length=0,Ze.length=0,Ce.push(n.COLOR_ATTACHMENT0+ht),C.depthBuffer&&C.storeMultisampledDepthBuffer===!1&&(Ce.push(at),Ze.push(at),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Ze)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Ce))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),J)for(let ht=0;ht<y.length;ht++){e.bindFramebuffer(n.FRAMEBUFFER,ut.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.RENDERBUFFER,ut.__webglColorRenderbuffer[ht]);const Ct=i.get(y[ht]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,ut.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.TEXTURE_2D,Ct,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ut.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.storeMultisampledDepthBuffer===!1&&c){const y=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[y])}}}function De(C){return Math.min(r.maxSamples,C.samples)}function Be(C){const y=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function F(C){const y=o.render.frame;u.get(C)!==y&&(u.set(C,y),C.update())}function nn(C,y){const z=C.colorSpace,W=C.format,q=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||z!==jo&&z!==Ki&&(jt.getTransfer(z)===de?(W!==Qn||q!==Cn)&&Nt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ie("WebGLTextures: Unsupported texture color space:",z)),y}function he(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(l.width=C.naturalWidth||C.width,l.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(l.width=C.displayWidth,l.height=C.displayHeight):(l.width=C.width,l.height=C.height),l}this.allocateTextureUnit=$,this.resetTextureUnits=k,this.getTextureUnits=I,this.setTextureUnits=G,this.setTexture2D=nt,this.setTexture2DArray=Y,this.setTexture3D=tt,this.setTextureCube=rt,this.rebindTextures=re,this.setupRenderTarget=ye,this.updateRenderTargetMipmap=Jt,this.updateMultisampleRenderTarget=vn,this.setupDepthRenderbuffer=Kt,this.setupFrameBufferTexture=yt,this.useMultisampledRTT=Be,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function _x(n,t){function e(i,r=Ki){let s;const o=jt.getTransfer(r);if(i===Cn)return n.UNSIGNED_BYTE;if(i===Dc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Lc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===ed)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===nd)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===jh)return n.BYTE;if(i===td)return n.SHORT;if(i===Xs)return n.UNSIGNED_SHORT;if(i===Pc)return n.INT;if(i===gi)return n.UNSIGNED_INT;if(i===hi)return n.FLOAT;if(i===_i)return n.HALF_FLOAT;if(i===id)return n.ALPHA;if(i===rd)return n.RGB;if(i===Qn)return n.RGBA;if(i===Fi)return n.DEPTH_COMPONENT;if(i===fr)return n.DEPTH_STENCIL;if(i===sd)return n.RED;if(i===Ic)return n.RED_INTEGER;if(i===yr)return n.RG;if(i===Nc)return n.RG_INTEGER;if(i===Uc)return n.RGBA_INTEGER;if(i===Vo||i===Wo||i===Xo||i===$o)if(o===de)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Vo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Wo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Xo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===$o)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Vo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Wo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Xo)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===$o)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Nl||i===Ul||i===Fl||i===Ol)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Nl)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ul)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Fl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Ol)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Bl||i===zl||i===kl||i===Gl||i===Hl||i===Jo||i===Vl)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Bl||i===zl)return o===de?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===kl)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Gl)return s.COMPRESSED_R11_EAC;if(i===Hl)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Jo)return s.COMPRESSED_RG11_EAC;if(i===Vl)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Wl||i===Xl||i===$l||i===Yl||i===ql||i===Kl||i===Zl||i===Jl||i===Ql||i===jl||i===tc||i===ec||i===nc||i===ic)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Wl)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Xl)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===$l)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Yl)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===ql)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Kl)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Zl)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Jl)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Ql)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===jl)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===tc)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===ec)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===nc)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ic)return o===de?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===rc||i===sc||i===oc)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===rc)return o===de?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===sc)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===oc)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===ac||i===lc||i===Qo||i===cc)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===ac)return s.COMPRESSED_RED_RGTC1_EXT;if(i===lc)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Qo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===cc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===$s?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}const vx=`
void main() {
...
<div id="joystick" aria-label="Movement joystick"><div id="joystick-knob"></div></div><div id="drive-controls" aria-label="Truck driving controls"><button data-drive-key="KeyW" aria-label="Accelerate">▲</button><button data-drive-key="KeyA" aria-label="Steer left">◀</button><button data-drive-key="KeyS" aria-label="Reverse and brake">▼</button><button data-drive-key="KeyD" aria-label="Steer right">▶</button></div><div id="money-stream"></div><div id="status-bar" role="status"><div id="status-main"><b id="hint-key">E</b><span><small id="status-kicker">NEXT ACTION</small><strong id="nav-label">Job board</strong><em id="nav-distance"></em></span></div><div id="notice"><b id="notice-icon"><svg viewBox="0 0 36 36" aria-hidden="true"><path d="M15.2 4.8 Q18 1 20.8 4.8 L33.8 28.2 Q36 33 31 33 H5 Q0 33 2.2 28.2 Z" fill="#c83d39"/></svg><span>!</span></b><span id="notice-text"></span></div><div id="purchase" hidden><strong id="purchase-name"></strong><div class="progress"><i id="purchase-progress"></i></div><small id="purchase-detail">STAND STILL TO INVEST</small></div></div><aside id="tutorial-card" hidden><small>TUTORIAL</small><h2 id="tutorial-title"></h2><ul id="tutorial-points"></ul><div class="tutorial-actions"><button id="tutorial-skip">Skip tutorial</button><button id="tutorial-next">Got it</button></div></aside><nav id="camera-controls"><button id="camera-follow" title="Follow">◎</button><button id="zoom-in">＋</button><button id="zoom-out">−</button><button id="help">?</button></nav><button id="stuck-button" hidden>Got stuck?</button><footer><button data-action="interact"><b>E</b><span>Interact</span></button><button data-action="cab"><b>F</b><span>Cab</span></button><button data-action="rotate"><b>R</b><span>Rotate</span></button><button data-action="rear"><b>G</b><span>Rear</span></button></footer><dialog id="dialog"></dialog>`;document.documentElement.style.setProperty("--premium-color",ce.color);Q("#job-count").insertAdjacentHTML("afterend",'<div id="job-score"></div>');let Yd=!1,B=Fd(),Qt=null;for(const n of["movecraft-rewrite-v1","movecraft-update-backup"])try{const t=Qi.getItem(n);if(t){Qt=JSON.parse(t);break}}catch{}try{if(Qt?.company&&(B=Kx(Qt.company)),Qt&&Qt.worldVersion!==2){const n=t=>{t[0]>120?t[0]+=Dh.destination-144:t[0]>45&&(t[0]+=Dh.pickup-72)};for(const t of Qt.loads??[])t.mode!=="truck"&&n(t.position);Qt.truck&&(Qt.truck.position=[0,0,0],Qt.truck.yaw=0),Qt.player=[-6,0,1],Qt.navLeg="",Qt.navIndex=0,Qt.navPath=[],Qt.worldVersion=2}}catch{}let Zs=!0,_l=!0,Nh=null;try{Zs=JSON.parse(Qi.getItem("movecraft-audio-v1")??"{}").effects??!0}catch{}const Pe=new Bp;Pe.background=new $t(13032672);Pe.fog=new kc(13032672,115,215);const Ln=new Ax({antialias:!0});Ln.setPixelRatio(Math.min(devicePixelRatio,1.5));Ln.shadowMap.enabled=!0;Ln.shadowMap.type=Hh;Ln.toneMapping=Cc;Ln.toneMappingExposure=1.15;Q("#world").appendChild(Ln.domElement);const Ne=new Ma(-18,18,12,-12,.1,450);Ne.position.set(22,29,26);Ne.zoom=.78;const _n=new Cx(Ne,Ln.domElement);Ln.domElement.tabIndex=0;const Ms=()=>Ln.domElement.focus({preventScroll:!0});Ln.domElement.addEventListener("pointerdown",Ms);_n.enablePan=!1;_n.enableDamping=!0;_n.minZoom=.55;_n.maxZoom=3.5;_n.minPolarAngle=.35;_n.maxPolarAngle=1.03;Pe.add(new bm(16775135,6588822,2));const Oi=new Tm(16772305,2.7);Oi.position.set(-25,45,20);Oi.castShadow=!0;Oi.shadow.mapSize.set(2048,2048);Object.assign(Oi.shadow.camera,{left:-32,right:32,top:32,bottom:-32,near:.1,far:100});Oi.shadow.normalBias=.035;Pe.add(Oi,Oi.target);const ba=iM();Pe.add(ba.root);const ps=new xe;ps.name="navigation-route-guide";Pe.add(ps);const qd=7.2,Kd=()=>we+6,ji=new xe;ji.name="navigation-parking-guide";const Zd=new yi({color:16768099,transparent:!0,opacity:.68,depthWrite:!1,side:gn,polygonOffset:!0,polygonOffsetFactor:-3}),Ea=new Ot(new Si(qd,1),Zd);Ea.rotation.x=-Math.PI/2;Ea.position.y=.105;ji.add(Ea);ji.visible=!1;Pe.add(ji);let ko="",Ut=Jc(0,B.levels.truck,0),Sn=Ut.fromSite.x,an=Ut.fromSite.z??0,wn=Ut.toSite.x,hn=Ut.toSite.z??0,gr=Wd(B),Bn=fs(Sn,Ut.fromSite.variant,!1,an),ei=fs(wn,Ut.toSite.variant,!0,hn);Pe.add(gr.root,Bn.root,ei.root);const _r=Id(15313475),ot=_r.root;function la(){const n=Id(15313475,0,B.selectedSkins.person,B.levels.worker),t=_r.root.userData.rig?.body;t&&(ot.remove(t),mi(t));const e=n.root.userData.rig.body;n.root.remove(e),ot.add(e),_r.root.userData.rig=n.root.userData.rig,_r.animate=n.animate}la();ot.position.set(-6,0,1);Pe.add(ot);const jc=new Ot(new $c(.38,.46,32),new yi({color:16773043,side:gn}));jc.rotation.x=-Math.PI/2;jc.position.y=.04;ot.add(jc);let Lt,we=4.2,zn=5,Ue=!1,We=!1,Gt=null,te=!1,Ge=0,Us=0,Zi=1,Ui=1,Ko=!1,gc=0,ca=0,ve=null;const ue=[];let Er=0,wr=0,_c=-10,Ve=null,Wn=[];const vc=new Map,Kn=new Ot(new Si(1,1),new yi({color:16763725,transparent:!0,opacity:.82,side:gn,depthWrite:!1}));Kn.rotation.x=-Math.PI/2;Kn.position.y=.095;Kn.visible=!1;Kn.renderOrder=4;Pe.add(Kn);const Di=new Ot(new Si(1,1),new yi({color:13974845,transparent:!0,opacity:.72,side:gn,depthWrite:!1}));Di.rotation.x=-Math.PI/2;Di.position.y=.105;Di.visible=!1;Di.renderOrder=5;Pe.add(Di);let Tr=0,Yn=0,vr="",je=0,kt=Number(Qt?.tutorialStep??0),Qe=0,vl=0,xl=0,ua=0,Rn=0,xc=0,Ml="",yl="",Uh=-1,Go=-10,Zo=!1,Xn=0,Zn=!1,Gs=0;const qi=[],Mc=[],yc=[],cM=ot.position.clone(),Jd=new A,Ci=new A,Ee=new Set,Ji=new ct,tu=new A(0,1,0),Fn=new Ot(new er(1,.04,1),new yi({color:2981988,transparent:!0,opacity:.58,depthTest:!0,depthWrite:!1}));Pe.add(Fn);Fn.renderOrder=10;const eu=new Qp(new tm(Fn.geometry),new pd({color:1527614,depthTest:!0,depthWrite:!1}));eu.renderOrder=11;Fn.add(eu);Fn.visible=!1;let li=[],os=[];const ni=n=>Lt.userData.cargo.localToWorld(n.clone()),ii=n=>Lt.userData.cargo.worldToLocal(n.clone()),Hs=n=>Lt.localToWorld(n.clone());function uM(){Qi.setItem("movecraft-audio-v1",JSON.stringify({effects:Zs}))}function hM(){if(!(!Zs||Ef()))try{const n=Nh??(Nh=new AudioContext);n.resume();const t=n.createOscillator(),e=n.createGain();t.type="sine",t.frequency.value=480,e.gain.setValueAtTime(1e-4,n.currentTime),e.gain.exponentialRampToValueAtTime(.012,n.currentTime+.008),e.gain.exponentialRampToValueAtTime(1e-4,n.currentTime+.055),t.connect(e).connect(n.destination),t.start(),t.stop(n.currentTime+.06)}catch{}}document.addEventListener("click",n=>{n.target.closest("button")&&hM()});function qt(n){Q("#notice-text").textContent=n;const t=/^(No |There |Clear |Park |Stand |Move around|Step |Brake |Stop |Finish |Cannot|Can't|The driver door|This furniture|Place .* on)/i.test(n);Q("#notice").classList.toggle("error",t),ua=4,Q("#status-bar").classList.add("show-notice")}function nr(n){Ee.clear();const t=!n.includes('class="reward-modal"');Q("#dialog").innerHTML=`${t?'<button class="close" aria-label="Close">×</button>':""}${n}`,Q("#dialog").open||Q("#dialog").showModal(),t&&(Q("#dialog .close").onclick=()=>Q("#dialog").close())}const Jn=[["Welcome to MOVING EMPIRE",["Better with keyboard · on mobile, use the joystick to walk and arrow buttons to drive","Walk with WASD and hold Shift to sprint","The top bar tells you the next useful action","We will introduce each control group once"],"#status-bar"],["The whole Actions bar",["The row at the bottom contains every action","E interacts and places · F enters or leaves the cab","R rotates furniture · G moves the rear ramp","The same letters work on a keyboard; tap the buttons on touchscreens"],"footer"],["The whole Camera bar",["The four buttons on the left only change your view","◎ follows you again · + zooms in · − zooms out · ? opens help","Drag the scene to look around. These controls do not move your character"],"#camera-controls"],["Accept your first move",["The card on the right is your job panel","Walk onto the marked job field to accept a move"],"#job-card"],["Money and price fields",["Coins and Jems are shown together in the upper-left corner","Coins pay for upgrades: stand still on a marked price field to invest them","Each price field fills as you pay; then its upgrade confirmation opens","Jems are earned from moves and daily gifts; they buy skins or coins in the shop"],".wallet"]],Vs=[["Finish the move",["The job panel shows cargo, score and payout","Collect pay after delivery; collisions and time lower the score","Company shows upgrades and crew income; collect earnings at each crew field"],"#job-card"],["Shop and daily gifts",["The cart opens gifts, currency exchange and cosmetic skins","Claim one gift each day; Jems buy skins"],"#daily-button"],["Settings",["The gear has sound, display, rescue and replay settings","The ? in the Camera bar opens full help"],"#settings"]],fi=10,hr=fi+Vs.length;function no(){const n=kt>=hr,t=!Q("#tutorial-card").hidden;document.body.classList.toggle("tutorial-active",t),document.body.dataset.tutorialStep=String(kt),document.body.dataset.tutorialStage=t?kt<=2?"intro":kt===3?"job":kt===4?"money":kt>=fi?"final":"move":"off",document.body.classList.toggle("tutorial-camera-introduced",kt>=2),document.body.classList.toggle("tutorial-shop-introduced",kt>=fi+1),document.body.classList.toggle("tutorial-settings-introduced",kt>=fi+2);const e=new Set(n||kt>=1?["interact","cab","rotate","rear"]:[]);document.querySelectorAll("footer [data-action]").forEach(i=>i.classList.toggle("tutorial-hidden",!e.has(i.dataset.action)))}function io(){const n=Q("#tutorial-card"),t=Q("#camera-controls");if(n.hidden){n.style.top="",n.style.maxHeight="",t.style.top="",t.style.transform="",t.style.visibility="",Q("#right-rail").style.top="";return}const e=document.querySelector("#right-rail .tutorial-focus");if(innerWidth<=700&&document.body.dataset.tutorialStage==="final"&&e){const c=Math.ceil(e.getBoundingClientRect().bottom+12);n.style.top=`${c}px`,n.style.maxHeight=`${Math.max(150,innerHeight-c-94)}px`}else n.style.top="",n.style.maxHeight="";const i=n.getBoundingClientRect(),r=t.getBoundingClientRect(),s=Q("footer").getBoundingClientRect().top,o=s-5;document.body.dataset.tutorialStage==="job"&&innerWidth<=700?Q("#right-rail").style.top=`${Math.ceil(i.bottom+12)}px`:Q("#right-rail").style.top="";const a=i.bottom+7;if(a+r.height>o){t.style.visibility="hidden";return}t.style.visibility="",t.style.top=`${a}px`,t.style.transform="none"}new ResizeObserver(io).observe(Q("#tutorial-card"));window.addEventListener("resize",io);function ui(n,t,e="Got it",i=""){document.body.classList.remove("tutorial-exit","tutorial-exit-skip"),document.querySelectorAll(".tutorial-focus").forEach(r=>r.classList.remove("tutorial-focus")),Q("#tutorial-title").textContent=n,Q("#tutorial-points").innerHTML=t.map(r=>`<li>${r}</li>`).join(""),Q("#tutorial-next").textContent=e,Q("#tutorial-card").hidden=!1,Q("#tests").hidden=!0,no(),i&&document.querySelector(i)?.classList.add("tutorial-focus"),io()}function Qd(n=!1){document.body.classList.remove("tutorial-exit","tutorial-exit-skip"),document.body.offsetWidth,document.body.classList.toggle("tutorial-exit-skip",n),document.body.classList.add("tutorial-exit"),window.setTimeout(()=>document.body.classList.remove("tutorial-exit","tutorial-exit-skip"),1800)}function as(n){B.jobs>0&&kt<fi&&(kt=fi),n==="job"&&kt<=5?(kt=6,ui("Follow the route",["Blue arrows show the way"],"Got it","#status-bar")):n==="lift"&&kt<=6?(kt=7,ui("Load furniture",["Green = fits · red = blocked","Try another grid space or orientation if it is red"],"Got it",'[data-action="interact"]')):n==="loaded"&&kt<=7?(kt=8,ui("Ready to depart",["Finish loading, then enter the cab"],"Got it",'[data-action="cab"]')):n==="cab"&&kt<=8?(kt=9,ui("Drive carefully",["Raise the rear with G before driving","Truck collisions and long travel time lower your move score"],"Got it","#status-bar")):n==="delivered"&&kt<=9?(kt=9,ui("Finish the move",["Park in the yellow bay","Then choose your reward"],"Got it","#job-card")):n==="paid"&&kt<=fi&&(kt=fi,ui(Vs[0][0],Vs[0][1],"Next",Vs[0][2])),no(),Ae()}Q("#tutorial-next").onclick=()=>{if(kt<Jn.length-1)kt++,ui(Jn[kt][0],Jn[kt][1],"Got it",Jn[kt][2]);else if(kt>=fi&&kt<hr-1){kt++;const n=Vs[kt-fi];ui(n[0],n[1],kt===hr-1?"Finish tutorial":"Next",n[2])}else kt===Jn.length-1?kt=5:kt===hr-1&&(kt=hr),Q("#tutorial-card").hidden=!0,io(),document.querySelectorAll(".tutorial-focus").forEach(n=>n.classList.remove("tutorial-focus"));no(),kt===hr&&Qd(),Ae(),Ms()};Q("#tutorial-skip").onclick=()=>{kt=hr,Q("#tutorial-card").hidden=!0,io(),document.querySelectorAll(".tutorial-focus").forEach(n=>n.classList.remove("tutorial-focus")),no(),Qd(!0),Ae(),Ms()};function Js(){const n=Lt,t=n?.position.clone()??new A,e=n?.rotation.clone()??new xi;for(const o of ue)o.mode==="truck"&&Pe.attach(o.mesh);n&&mi(n),zn=oa(B.levels.truck),we=.2+zn*.8,Lt=Wx(zn,B.levels.truck,B.selectedSkins.truck),Lt.position.copy(t),Lt.rotation.copy(e),Pe.add(Lt);for(const o of ue)o.mode==="truck"&&(Lt.userData.cargo.add(o.mesh),o.mesh.position.copy(o.position));const i=new xe;i.position.set(4.69,.35,-1.95),P(i,0,.55,.65,.06,1.1,1.28,Lt.userData.bodyColor,!0),P(i,0,1.4,.65,.06,.62,1.28,3495010,!0);const r=P(i,.035,1.4,.65,.025,.48,1.02,9091781);r.material=new Sr({color:8895944,transparent:!0,opacity:.38,roughness:.12}),P(i,-.035,.68,.65,.035,.34,.95,7692094,!0);for(const o of[.04,1.26])P(i,.055,.85,o,.08,1.7,.06,3230808,!0);P(i,.075,.78,1.02,.035,.08,.24,2506569,!0),Lt.add(i);const s=i.clone(!0);s.position.x=1.31,s.scale.x=-1,Lt.add(s),Lt.userData.cabDoor=i,jd(),n&&Aa()}function dM(){mi(gr.root),gr=Wd(B),Pe.add(gr.root),js(),Dn(),Aa()}function jd(){const n=e=>e*e*(3-2*e),t=n(ge.clamp(Zi*2,0,1));Lt.userData.rampPivot.rotation.x=ge.lerp(-Math.PI/2,Math.atan(.78/2.2),t),Lt.userData.cabDoor&&(Lt.userData.cabDoor.rotation.y=n(gc)*1.42)}function ms(n){n.mode==="truck"?(Lt.userData.cargo.add(n.mesh),n.mesh.position.copy(n.position)):n.mode==="hand"?(ot.add(n.mesh),n.mesh.position.set(0,.95,Qs(n))):(Pe.add(n.mesh),n.mesh.position.copy(n.position)),n.mesh.rotation.set(0,n.item.rotated?Math.PI/2:0,0)}function ha(n=!1){if(Ue&&!We&&!n)return qt("Finish this move and collect payment first.");xc=0;const t=`${Ut.fromSite?.id??""}->${Ut.toSite?.id??""}`;for(const s of ue)mi(s.mesh);ue.length=0,Er=0,wr=0,_c=-10,Gt=null,Ve=null,Tr=B.jobs;const e=Yn;do Yn=Math.floor(Math.random()*7);while(Yn===e);vr="",je=0;const i=Math.max(B.jobs,Math.floor((B.levels.truck+B.levels.worker)*.45));let r=0;do Ut=Jc(i,B.levels.truck,B.jobs*11+Yn+r++);while(`${Ut.fromSite.id}->${Ut.toSite.id}`===t&&r<10);Ue=!0,We=!1,Sn=Ut.fromSite.x,an=Ut.fromSite.z??0,wn=Ut.toSite.x,hn=Ut.toSite.z??0,mi(Bn.root),mi(ei.root),Bn=fs(Sn,Ut.fromSite.variant+Yn,!1,an),ei=fs(wn,Ut.toSite.variant+Yn,!0,hn),Pe.add(Bn.root,ei.root),tf(),Sc();for(const s of Ut.items){const o={item:s,mesh:Nd(s.model),mode:"ground",position:new A(Sn+s.pickupX,.12,an+s.pickupZ),velocity:new A,angular:new A,hitAt:-10,settled:!0};ue.push(o),ms(o)}Dn(),qt(`New move: ${Ut.from} → ${Ut.to}. Follow the ground arrows.`),as("job"),Ae()}function ir(){return Ue&&ue.length>0&&ue.every(n=>n.mode==="delivered")}function tf(){const n=[],t=new Set,e=[...Ut.items].sort((i,r)=>r.w*r.d-i.w*i.d||i.id-r.id);for(const i of e){const r=i.w*Ft+.32,s=i.d*Ft+.32,o=[];for(let l=an-4.5+s/2;l<=an+4.45-s/2;l+=.48)for(let u=Sn-10.25+r/2;u<=Sn-.95-r/2;u+=.48)o.push({x:u,z:l,rank:Math.sin(i.id*17.37+u*8.1+l*3.7)});o.sort((l,u)=>l.rank-u.rank);const a=({x:l,z:u},h)=>!Bn.barriers.some(d=>Math.abs(l-d.x)<(r+d.w)/2+h&&Math.abs(u-d.z)<(s+d.d)/2+h)&&!n.some(d=>Math.abs(l-d.x)<(r+d.w)/2+h&&Math.abs(u-d.z)<(s+d.d)/2+h);let c=o.find(l=>a(l,.18))??o.find(l=>a(l,.035));if(!c){const l=[];for(let u=an+5.7+s/2;u<=an+8.2-s/2;u+=.2)for(let h=Sn-10+r/2;h<=Sn-1.2-r/2;h+=.35)l.push({x:h,z:u});c=l.find(u=>a(u,.04))}c?(i.pickupX=c.x-Sn,i.pickupZ=c.z-an,n.push({x:c.x,z:c.z,w:r,d:s})):t.add(i.id)}t.size&&(Ut.items=Ut.items.filter(i=>!t.has(i.id)),Ut.reward=Math.round(Ut.items.reduce((i,r)=>i+r.value,0)*(1+(Ut.difficulty-1)*.07)))}function Sc(){vc.clear();const n=ue.filter(r=>r.mode==="delivered").map(r=>({x:r.position.x,z:r.position.z,w:r.item.w*Ft,d:r.item.d*Ft})),t=wn-10.1,e=hn-4.9,i=(Tr*7+Yn*3)%11;for(const r of[...Ut.items].sort((s,o)=>o.w*o.d-s.w*s.d||s.id-o.id)){if(ue.some(o=>o.item.id===r.id&&o.mode==="delivered"))continue;let s;for(const o of[.18,.02])for(let a=0;a<121&&!s;a++){const c=(Math.floor(a/11)*3+i)%11,l=(a*7+i*2)%11;if(c>11-r.d||l>11-r.w)continue;const u=t+(l+r.w/2)*Ft,h=e+(c+r.d/2)*Ft,d=r.w*Ft/2,f=r.d*Ft/2,g=ei.barriers.some(m=>Math.abs(u-m.x)<d+m.w/2+o&&Math.abs(h-m.z)<f+m.d/2+o),S=n.some(m=>Math.abs(u-m.x)<d+m.w/2+o&&Math.abs(h-m.z)<f+m.d/2+o);!g&&!S&&(s=new A(u,.12,h),n.push({x:u,z:h,w:d*2,d:f*2}))}s&&vc.set(r.id,s)}}function ef(n){const t=vc.get(n.item.id);if(!t)return null;const e=ot.position.clone().add(new A(0,0,1.1).applyQuaternion(ot.quaternion));return{target:t,close:Math.min(Math.hypot(e.x-t.x,e.z-t.z),Math.hypot(ot.position.x-t.x,ot.position.z-t.z))<1.5}}function nf(n){return n.x>wn-10.5&&n.x<wn-.5&&n.z>hn-5&&n.z<hn+4.9}function nu(){return ni(new A(3,0,(we-2.2)/2))}function wa(){const n=ue.some(s=>s.mode==="ground"&&!s.fallen),t=!Ue||We?"yard":n?"pickup":"delivery";if(t==="yard")return{leg:t,point:new A(2,0,-15)};const i=(t==="pickup"?Sn:wn)+4,r=t==="pickup"?an:hn;return{leg:t,point:new A(i,0,r-2.1)}}function iu(n=wa().point){if(Math.abs(Ge)>=.35)return!1;const t=qd/2,e=Kd()/2;for(const i of[.8,5.2])for(const r of[-2.35,we+.25]){const s=ni(new A(i,0,r));if(Math.abs(s.x-n.x)>t||Math.abs(s.z-n.z)>e)return!1}return!0}function da(){return Math.round(Ut.reward*Math.max(.5,ls()/100))}function rf(){const n=180+Ut.items.length*40+Math.hypot((Ut.fromSite?.x??0)-(Ut.toSite?.x??0),(Ut.fromSite?.z??0)-(Ut.toSite?.z??0))*1.5;return Math.max(0,Math.floor((wr-n)/30)*2)}function ls(){return Math.max(0,100-Er*(Tr===0?2:4)-rf())}function sf(){return`${Er} truck collision${Er===1?"":"s"} · ${Math.floor(wr/60)}m ${Math.floor(wr%60)}s · time −${rf()}`}function bc(n=1){if(!ir()||We)return;const t=da()*n;ds(B,t);const e=pc(ls())*n;B.jems+=e,B.jobs++,We=!0,Dn(),qt(`+$${t} · +${e} ${ce.name} · Move completed!`),as("paid"),Ae()}function fa(){!ir()||We||Q("#dialog").open||!Q("#tutorial-card").hidden||(nr(`<div class="reward-modal"><small>MOVE COMPLETE</small><h2>$${da().toLocaleString("en-US")} · ${ce.icon} ${pc(ls())}</h2><p>${Ut.from} → ${Ut.to}</p><p>Move score: ${ls()}/100</p><p>${sf()}</p><button id="claim-normal">Collect reward</button>${`<button id="claim-double">▶ Watch video · $${(da()*2).toLocaleString("en-US")} + ${ce.icon} ${pc(ls())*2}</button>`}<p class="fine">The reward video is a short in-game preview.</p></div>`),Q("#claim-normal").onclick=()=>{Q("#dialog").close(),bc(1)},Q("#claim-double").onclick=()=>{const n=Q("#dialog");n.innerHTML='<div class="reward-video"><b>MOVING EMPIRE</b><p>Your crew makes every move count.</p><div class="progress"><i></i></div></div>',window.setTimeout(()=>{n.close(),bc(2)},3e3)})}function fM(){if(B.levels.truck<bn.truck)return"truck"}function Sl(){if(!(B.levels.truck<bn.truck)){if(B.levels.yard<bn.yard&&B.fleet.length>=B.levels.yard)return"yard";if(B.levels.hire<bn.hire&&B.fleet.length<B.levels.yard)return"hire";if(zd(B)&&!B.finished)return"factory"}}function pM(n){if(B.test)return 0;if(n.income!==void 0)return Math.min(1,Rn/.8);if(n.upgrade)return Math.min(1,(B.contributions[n.upgrade]??0)/pr(B,n.upgrade));if(n.fleet!==void 0){const t=B.fleet[n.fleet];return t?Math.min(1,(t.contribution??0)/(1e3*(t.level+1))):0}return Math.min(1,Rn/1.8)}function Dn(){for(const i of li)mi(i.root);li=[];const n=(i,r,s,o,a,c,l=0)=>{const u=Ih(r,s,0,0,7589002,l);u.position.copy(o),Pe.add(u),li.push({key:i,root:u,position:o,upgrade:a,fleet:c})};n("job","NEXT MOVE",Ue&&!We?"ACTIVE":"ACCEPT",new A(-10,.06,1)),li[li.length-1].root.visible=!Ue||We,B.finished&&(li[li.length-1].root.visible=!1);const t={truck:new A(-.45,.06,-1.25),worker:new A(-20,.06,-4.8),yard:new A(-8,.06,-20.7),factory:new A(15,.06,-15)},e=[fM(),B.levels.worker<bn.worker?"worker":void 0,Sl()==="hire"?void 0:Sl()].filter((i,r,s)=>!!i&&s.indexOf(i)===r);for(const i of e){const r=pr(B,i),s=(B.contributions[i]??0)/r;n(i,br[i],B.test?"FREE":`$${r.toLocaleString("en-US")}`,t[i],i,void 0,s)}if(Sl()==="hire"){const i=B.fleet.length,r=pr(B,"hire");n("hire",`HIRE CREW ${i+1}`,B.test?"FREE":`$${r.toLocaleString("en-US")}`,new A(8+i*4.8,.06,-16.5),"hire",void 0,(B.contributions.hire??0)/r)}B.fleet.forEach((i,r)=>{if((i.pending??0)>0){const s=Ih("COLLECT CREW",`$${i.pending}`,0,0,7589002,0),o=new A(8+r*4.8,.05,-19.5);s.position.copy(o),Pe.add(s),li.push({key:`income-${r}`,root:s,position:o,income:r})}if(i.level<4){const s=(i.level+1)*1e3;n(`fleet-${r}`,`TRUCK ${r+2} · LV ${i.level}`,B.test?"FREE":`$${s.toLocaleString("en-US")}`,new A(8+r*4.8,.05,-16.5),void 0,r,(i.contribution??0)/s)}})}function of(n){const t=B.levels[n],e=Zx(B,n);if(e)return qt(e);n==="truck"&&Js(),n==="worker"&&la(),["yard","hire"].includes(n)?dM():Dn();const i={truck:[`Loading deck: ${oa(t)} → ${oa(B.levels.truck)} rows`,`Top speed: ${Math.round((8.5+t*1.3)*3.6)} → ${Math.round((8.5+B.levels.truck*1.3)*3.6)} km/h`,B.levels.truck===1?"Cab and roof added":B.levels.truck===2?"More enclosed body panels":B.levels.truck===3?"Cargo body reinforced":B.levels.truck===4?"Full-height enclosed body completed":"Trailer length and load capacity increased",...B.levels.truck>=bn.truck?["Company-base upgrade unlocked"]:[]],worker:[`Worker level: ${t} → ${B.levels.worker}`,`Walk speed: ${Math.round((1+t*.07)*100)}% → ${Math.round((1+B.levels.worker*.07)*100)}%`,`Sprinting speed: ${((1+t*.07)*6.7).toFixed(1)} → ${((1+B.levels.worker*.07)*6.7).toFixed(1)} m/s`,`Lifting time: ${Math.round(100/(1+t*.23))}% → ${Math.round(100/(1+B.levels.worker*.23))}%`,"Heavy furniture is easier to carry"],yard:[`Base level ${B.levels.yard}`,"One new employee parking bay",`${B.levels.yard} bays available`],hire:[`${B.fleet.length} crews employed`,"New employee added","New employee truck included"],factory:["MOVING EMPIRE completed","Furniture company purchased","Coming soon!"],cargo:["Included in the central truck upgrade"],gear:["Included in the central truck upgrade"],fleet:["Employee truck upgraded"]};B.levels[n]>t&&nr(`<div class="upgrade-modal"><small>UPGRADE COMPLETE</small><div class="upgrade-badge">✓</div><h2>${br[n]}</h2><ul>${i[n].map(r=>`<li>${r}</li>`).join("")}</ul><button class="modal-ok">Continue</button></div>`),document.querySelector(".modal-ok")?.addEventListener("click",()=>Q("#dialog").close()),qt(`${br[n]} · Level ${B.levels[n]}`),Ae()}function pa(){if(!(te||Ve||Gt))return li.find(n=>{const t=Number(n.root.userData.padHalfWidth??1.3),e=Number(n.root.userData.padHalfDepth??.85);return n.root.visible&&Math.abs(ot.position.x-n.position.x)<t*1.16&&Math.abs(ot.position.z-n.position.z)<e*1.2&&Math.abs(ot.position.y-n.position.y)<1.15})}function Fh(n,t=!1){if(!t&&Qe-Uh<.14)return;Uh=Qe;const e=document.querySelector(".wallet").getBoundingClientRect(),i=n.position.clone().project(Ne),r=(i.x+1)/2*innerWidth,s=(1-i.y)/2*innerHeight,o=e.left+e.width/2,a=e.top+e.height/2,c=t?r:o,l=t?s:a,u=t?o:r,h=t?a:s,d=document.createElement("i");d.textContent="$",d.style.left=`${c}px`,d.style.top=`${l}px`,d.style.setProperty("--money-x",`${u-c}px`),d.style.setProperty("--money-y",`${h-l}px`),d.classList.toggle("payout",t),Q("#money-stream").appendChild(d),d.addEventListener("animationend",()=>d.remove(),{once:!0}),window.setTimeout(()=>d.remove(),1200)}function mM(n){const t=pa();if(!t||Ci.length()>.2){Rn=0,Ml="",Q("#purchase").hidden=!0,t||(yl="");return}if(yl===t.key||(t.key!==Ml&&(Rn=t.key==="job"?xc:0,Ml=t.key),t.upgrade&&Od(B,t.upgrade)))return;if((t.upgrade?pr(B,t.upgrade)-(B.contributions?.[t.upgrade]??0):t.fleet!==void 0?1e3*(B.fleet[t.fleet].level+1)-(B.fleet[t.fleet].contribution??0):0)>B.cash&&!B.test&&Tf(),Rn+=n,t.key==="job"&&(xc=Rn),t.upgrade&&!B.test){B.contributions??={};const o=pr(B,t.upgrade),a=B.contributions[t.upgrade]??0,c=Math.min(B.cash,o-a,o*n/1.8);B.cash-=c,B.contributions[t.upgrade]=a+c,Rn=Math.min(Rn,(a+c)/o*1.8),c>0&&Fh(t)}if(t.fleet!==void 0&&!B.test){const o=B.fleet[t.fleet],a=1e3*(o.level+1),c=o.contribution??0,l=Math.min(B.cash,a-c,a*n/1.8);B.cash-=l,o.contribution=c+l,Rn=Math.min(Rn,(c+l)/a*1.8),l>0&&Fh(t)}const i=B.test?Math.min(1,Rn/1.8):pM(t);t.root.userData.setProgress?.(i),Q("#purchase").hidden=!1,Q("#purchase-name").textContent=t.key==="job"?"Accept the next move":t.income!==void 0?`Collect $${B.fleet[t.income]?.pending??0}`:t.upgrade?br[t.upgrade]:"Upgrade fleet truck",Q("#purchase-progress").style.width=`${Math.min(100,i*100)}%`;const r=t.upgrade?pr(B,t.upgrade):t.fleet!==void 0?1e3*(B.fleet[t.fleet].level+1):0,s=Math.min(r,Math.round(r*i));if(Q("#purchase-detail").textContent=r?B.test?"DEVELOPMENT MODE · FREE":`${Math.round(i*100)}% · $${s.toLocaleString("en-US")} OF $${r.toLocaleString("en-US")} INVESTED`:"STAND STILL TO ACTIVATE",Rn>=1.8)if(yl=t.key,Rn=0,Q("#purchase").hidden=!0,t.key==="job")ha();else if(t.income!==void 0){const o=Qx(B,t.income);qt(`+$${o} · Employee route complete`),Dn(),Ae()}else t.upgrade?of(t.upgrade):t.fleet!==void 0&&Jx(B,t.fleet)&&(js(),Dn(),nr(`<div class="upgrade-modal"><small>VEHICLE UPGRADED</small><div class="upgrade-badge">✓</div><h2>Employee truck ${t.fleet+2}</h2><ul><li>Faster route</li><li>$125 more income per trip</li><li>Vehicle level ${B.fleet[t.fleet].level}</li></ul><button class="modal-ok">Continue</button></div>`),Q(".modal-ok").onclick=()=>Q("#dialog").close(),Ae())}function Ec(){const n=ii(ot.position);return n.x>1.15&&n.x<4.85&&n.z>=.2&&n.z<=we&&ot.position.y>.6}function ro(n){const t=ii(n);if(t.x>1.4&&t.x<4.6){if(t.z>=.2&&t.z<=we)return .78;if(Zi>.94&&t.z>we&&t.z<we+2.2)return .78*(we+2.2-t.z)/2.2}return 0}function gM(n,t=1/0){let e=-1/0;for(const i of ue){if(i.mode!=="truck"&&i.mode!=="ground")continue;const[r,s]=tn(i.item),o=i.mode==="truck"?ii(n):n,a=i.position,c=a.y+Xd(i.item.model);c<=t+.14&&Math.abs(o.x-a.x)<r*Ft/2-.08&&Math.abs(o.z-a.z)<s*Ft/2-.08&&(e=Math.max(e,c))}return e}function ma(n,t=1/0){return Math.max(ro(n),gM(n,t))}function cs(){const n=ii(ot.position),t=Zi>.94&&n.x>1.4&&n.x<4.6&&n.z>we&&n.z<=we+2.25;return t?Ko=!0:Ec()||(Ko=!1),t||Ec()&&Ko&&Zi>.94}function af(){let n,t=2.75;for(const e of ue){if(["hand","air","delivered"].includes(e.mode)||e.mode==="truck"&&!cs())continue;const i=e.mesh.getWorldPosition(new A),r=Math.hypot(i.x-ot.position.x,i.z-ot.position.z);r<t&&Math.abs(i.y-ot.position.y)<1.5&&(n=e,t=r)}return n}function Oh(n,t){return ue.every(e=>{if(e===t||["hand","air","delivered"].includes(e.mode))return!0;const i=e.mesh.getWorldPosition(new A),[r,s]=tn(e.item);return Math.abs(n.x-i.x)>r*Ft/2+.38||Math.abs(n.z-i.z)>s*Ft/2+.38})}function _M(n){const t=n.mesh.getWorldPosition(new A),[e,i]=tn(n.item),r=n.mode==="truck",s=r?n.position:t,a=[new A(s.x-e*Ft/2-.62,0,s.z),new A(s.x+e*Ft/2+.62,0,s.z),new A(s.x,0,s.z-i*Ft/2-.62),new A(s.x,0,s.z+i*Ft/2+.62)].map(u=>r?ni(u.setY(.78)):u.setY(0)).filter(u=>{if(Ar(u,.3)||!Oh(u,n)||r&&!Ta(u))return!1;for(let h=1;h<=6;h++){const d=ot.position.clone().lerp(u,h/6);if(!Oh(d,n)||Ar(d,.24))return!1}return!0});if(!a.length)return null;const c=a.sort((u,h)=>u.distanceToSquared(ot.position)-h.distanceToSquared(ot.position))[0];c.y=ro(c);const l=Math.atan2(t.x-c.x,t.z-c.z);return{to:c,yaw:l,item:t}}function ru(){if(!Gt)return null;const[n,t]=tn(Gt.item),e=new A(0,0,.65+Math.max(n,t)*Ft/2).applyQuaternion(ot.quaternion).add(ot.position),i=ii(e),r=ue.map(u=>({...u.item,x:u.mode==="truck"?(u.position.x-1.4)/Ft-tn(u.item)[0]/2:u.item.x,z:u.mode==="truck"?(u.position.z-.2)/Ft-tn(u.item)[1]/2:u.item.z,location:u.mode==="truck"?"truck":"pickup"})),s=ge.clamp(Math.round((i.x-1.4)/Ft-n/2),0,4-n),o=ge.clamp(Math.round((i.z-.2)/Ft-t/2),0,zn-t),a=(u,h)=>Qc(r,Gt.item,u,h,4,zn);if(a(s,o))return{x:s,z:o,w:n,d:t,valid:!0};let c=null,l=1/0;for(let u=0;u<=zn-t;u++)for(let h=0;h<=4-n;h++){const d=(h-s)**2+(u-o)**2;d<l&&a(h,u)&&(c={x:h,z:u,w:n,d:t,valid:!0},l=d)}return c??{x:s,z:o,w:n,d:t,valid:!1}}function Qs(n){const[,t]=tn(n.item);return .62+t*Ft/2}function vM(){if(Ve||te)return;if(ir()&&!We)return fa();const n=pa();if(n){n.key==="job"?qt("Stand still on the job field to accept a move."):n.key==="collect"?bc():n.upgrade||n.fleet!==void 0?qt("Stand still on this field; payment starts automatically."):qt("Stand inside the markers to build.");return}if(Gt){const o=Gt,a=o.mesh.getWorldPosition(new A);let c,l;if(cs()){const f=ru();if(!f.valid)return qt("No clear space nearby. Press R to rotate or move along the truck.");o.item.x=f.x,o.item.z=f.z,c=new A(1.4+(f.x+f.w/2)*Ft,.78,.2+(f.z+f.d/2)*Ft),l="truck"}else{const f=ii(ot.position);if(f.x>-.5&&f.x<6.5&&f.z>-.2&&f.z<we+.8)return qt("Carry furniture through the lowered rear ramp to load it.");const g=nf(ot.position),S=ef(o);if(g&&!S)return qt("This furniture has no clear delivery spot. Move away from the doorway and try again.");if(g&&S&&!S.close)return qt(`Place ${o.item.name} on its highlighted spot.`);if(c=g&&S?S.target.clone():ot.position.clone().add(new A(0,0,1.1).applyQuaternion(ot.quaternion)),c.y=.12,l=g&&S?"delivered":"ground",l!=="delivered"&&Ar(c,.3))return qt("There is a wall here. Step into the room.")}Pe.attach(o.mesh);const u=o.mesh.getWorldQuaternion(new vi),h=l==="delivered"?0:(l==="truck"?Lt.rotation.y:0)+(o.item.rotated?Math.PI/2:0),d=new vi().setFromEuler(new xi(0,h,0));Ve={kind:"drop",load:o,time:0,duration:.5,from:a,to:l==="truck"?ni(c):c,mode:l,fromQuaternion:u,toQuaternion:d},o.position.copy(c),Gt=null;return}const t=af();if(!t)return qt("Stand close to furniture.");if(Ue&&!We){const{leg:o,point:a}=wa(),c=t.mode==="ground"&&o==="pickup",l=t.mode==="truck"&&o==="delivery";if((c||l)&&!iu(a))return qt(`Park the complete truck inside the yellow ${o} bay first.`)}const e=t.mesh.getWorldPosition(new A),i=_M(t);if(!i)return qt("Move around the furniture so there is room to lift it safely.");const r=ot.position.clone(),s=ge.clamp(r.distanceTo(i.to)/3.8,.18,.55);Pe.attach(t.mesh),Ve={kind:"lift",load:t,time:0,duration:s+(.62+t.item.weight*.34)/(1+B.levels.worker*.23),from:e,to:new A,mode:"hand",approachFrom:r,approachTo:i.to,approachYaw:i.yaw,approachDuration:s},t.mode="hand",t.velocity.set(0,0,0),t.angular.set(0,0,0)}function xM(n){if(!Ve)return;Ve.time+=n;const t=Ve,e=t.approachDuration??0,i=t.time<e,r=Math.min(1,Math.max(0,(t.time-e)/(t.duration-e))),s=r*r*(3-2*r),o=ot.userData.rig;if(i&&t.approachFrom&&t.approachTo){const c=Math.min(1,t.time/e),l=c*c*(3-2*c);if(ot.position.lerpVectors(t.approachFrom,t.approachTo,l),_r.animate(Qe,!0,!1,!1),t.approachYaw!==void 0){const u=Math.atan2(Math.sin(t.approachYaw-ot.rotation.y),Math.cos(t.approachYaw-ot.rotation.y));ot.rotation.y+=u*(1-Math.exp(-12*n))}t.load.mesh.position.copy(t.from);return}o.body.rotation.x=.42*Math.sin(r*Math.PI),o.body.position.y=-.19*Math.sin(r*Math.PI),o.arms.forEach(c=>c.rotation.x=-1.35*Math.sin(Math.min(1,r*1.35)*Math.PI/2));const a=t.kind==="lift"?ge.smoothstep(r,.08,.94):s;if(t.kind==="lift"&&t.to.copy(ot.position).add(new A(0,.95,Qs(t.load)).applyQuaternion(ot.quaternion)),t.kind==="lift"){const c=t.from.clone();c.y=Math.max(t.to.y,t.from.y+.95),a<.58?t.load.mesh.position.lerpVectors(t.from,c,ge.smoothstep(a/.58,0,1)):t.load.mesh.position.lerpVectors(c,t.to,ge.smoothstep((a-.58)/.42,0,1))}else t.load.mesh.position.lerpVectors(t.from,t.to,a),t.fromQuaternion&&t.toQuaternion&&t.load.mesh.quaternion.slerpQuaternions(t.fromQuaternion,t.toQuaternion,a);t.load.mesh.rotation.x=ge.damp(t.load.mesh.rotation.x,0,8,n),t.load.mesh.rotation.z=ge.damp(t.load.mesh.rotation.z,0,8,n),t.time>=t.duration&&(t.load.mode=t.mode,t.mode==="truck"&&(t.load.fallen=!1),t.mode==="delivered"&&(t.load.item.rotated=!1),t.kind==="lift"?(Gt=t.load,ot.add(t.load.mesh),t.load.mesh.position.set(0,.95,Qs(t.load)),t.load.mesh.rotation.set(0,t.load.item.rotated?Math.PI/2:0,0),as("lift")):(ms(t.load),Aa(),t.mode==="truck"&&as("loaded")),t.load.velocity.set(0,0,0),t.load.angular.set(0,0,0),t.load.settled=!0,Ve=null,o.body.rotation.x=0,o.body.position.y=0,ir()&&(Dn(),qt("Everything delivered. Choose your reward."),as("delivered"),Gs=1.6),Ae())}function MM(){if(te||Ve||Gt)return;const n=ii(ot.position);if(Math.hypot(n.x-3,n.z-we)>4.8)return qt("Walk to the rear of your truck.");if(n.x>1.2&&n.x<4.8&&n.z>we-.2&&n.z<we+2.4)return qt("Step to the side of the ramp.");if(Ui<.5&&!iu())return qt("Park fully in the yellow bay until it turns green before lowering the rear.");Ui=Ui>.5?0:1}function yM(){if(!(Ve||Gt||ve)){if(te){Ge=0,ca=1,ve={entering:!1,time:0,swapped:!1},qt("Opening the driver door…");return}if(ot.position.distanceTo(Hs(new A(5.3,0,-1)))>3.8)return qt("The driver door is at the front right.");ca=1,ve={entering:!0,time:0,swapped:!1,from:ot.position.clone()},Ci.set(0,0,0),qt("Opening the driver door…")}}function SM(n){if(!ve)return;ve.time+=n;const t=ve.entering?.72:.5;if(ve.entering&&!ve.swapped&&ve.from&&ve.time>=.14){const e=Hs(new A(5.15,0,-1.15)),i=ge.smoothstep((ve.time-.14)/.55,0,1);e.y=ro(e),ot.position.lerpVectors(ve.from,e,i),ot.rotation.y=Lt.rotation.y-Math.PI/2,_r.animate(Qe,!0,!1,!1)}if(!ve.swapped&&ve.time>=t){if(ve.swapped=!0,ve.entering)te=!0,ot.visible=!1,qt(Ui?"Rear lowered. Raise it with G when loading is complete.":"W/S drive and brake. F exits when stopped."),as("cab");else{te=!1,ot.visible=!0;let e=Hs(new A(5.5,0,-1));for(const i of[5.5,.5]){const r=Hs(new A(i,0,-1));if(!Ar(r,.28)){e=r;break}}ot.position.copy(e),Ar(ot.position,.28)&&so(!1)}Ae()}ve.time>=(ve.entering?.82:.9)&&(ca=0),ve.time>=(ve.entering?1.18:1.35)&&(ve=null)}function Ar(n,t=.25){return[...ba.barriers,...gr.barriers,...Bn.barriers,...ei.barriers].some(e=>Math.abs(n.x-e.x)<e.w/2+t&&Math.abs(n.z-e.z)<e.d/2+t)}function lf(){for(const n of[1.15,1.8,2.5,3.2,3.9,4.55,4.85])for(let t=-2.35;t<=we+.4;t+=.42)if(Ar(t<0?Hs(new A(n,0,t)):ni(new A(n,0,t)),.19))return!0;return!1}function bM(n){if(!Gt)return!1;const[t,e]=tn(Gt.item),i=n.clone().add(new A(0,0,Qs(Gt)).applyAxisAngle(tu,ot.rotation.y)),r=t*Ft/2,s=e*Ft/2,o=Math.abs(Math.cos(ot.rotation.y)),a=Math.abs(Math.sin(ot.rotation.y)),c=r*o+s*a,l=r*a+s*o;return i.x-c<He.minX||i.x+c>He.maxX||i.z-l<He.minZ||i.z+l>He.maxZ?!0:[...ba.barriers,...gr.barriers,...Bn.barriers,...ei.barriers].some(u=>Math.abs(i.x-u.x)<c+u.w/2+.04&&Math.abs(i.z-u.z)<l+u.d/2+.04)}function Ta(n,t=Zn,e=ot.position.y){if(n.x<He.minX||n.x>He.maxX||n.z<He.minZ||n.z>He.maxZ||Ar(n)||bM(n))return!1;const i=ii(n);if(i.x>1.15&&i.x<4.85&&i.z>-2.4&&i.z<.2||!t&&Math.abs(ma(n,e+.2)-e)>.22||i.z>=.2&&i.z<we&&(Math.abs(i.x-1.4)<.15||Math.abs(i.x-4.6)<.15)&&e<(B.levels.truck>0?2.75:1.02))return!1;for(const r of ue)if(r.mode==="truck"||r.mode==="ground"){const[s,o]=tn(r.item),a=r.mode==="truck"?r.position:r.mesh.getWorldPosition(new A),c=r.mode==="truck"?i:n,l=a.y+Xd(r.item.model);if(e<l-.08&&Math.abs(c.x-a.x)<s*Ft/2+.16&&Math.abs(c.z-a.z)<o*Ft/2+.16)return!1}return!0}function EM(n){if(te||ve||Ve||Q("#dialog").open)return Ci.set(0,0,0),Zo=!1,!1;const t=Number(Ee.has("KeyD")||Ee.has("ArrowRight"))-Number(Ee.has("KeyA")||Ee.has("ArrowLeft")),e=Number(Ee.has("KeyW")||Ee.has("ArrowUp"))-Number(Ee.has("KeyS")||Ee.has("ArrowDown")),i=Ne.getWorldDirection(new A);i.y=0,i.normalize();const r=new A(-i.z,0,i.x).multiplyScalar(t).addScaledVector(i,e).add(new A(Ji.x,0,Ji.y));Zo=!Gt&&r.lengthSq()>0&&(Ee.has("ShiftLeft")||Ee.has("ShiftRight")||Ji.length()>.88);const s=Gt?Math.max(1.35,3.1-Gt.item.weight*.25/(1+B.levels.worker*.3)):Zo?6.7:3.9;r.normalize().multiplyScalar(s*(1+B.levels.worker*.07)),Ci.lerp(r,1-Math.exp(-10*n));const o=ot.position.clone();for(let a=0;a<4;a++)for(const c of["x","z"]){const l=ot.position.clone();if(l[c]+=Ci[c]*n/4,Ta(l)){if(!Zn){const u=ma(l,ot.position.y+.2);ot.position.y-u>.22?(Zn=!0,Xn=Math.min(0,Xn),l.y=ot.position.y):l.y=u}ot.position.copy(l)}}if(Ci.length()>.1){const a=Math.atan2(Ci.x,Ci.z),c=Math.atan2(Math.sin(a-ot.rotation.y),Math.cos(a-ot.rotation.y));ot.rotation.y+=c*(1-Math.exp(-14*n))}return o.distanceTo(ot.position)>.003}function wM(){te||ve||Ve||Q("#dialog").open||Zn||(Zn=!0,Xn=4.3)}function TM(n){if(te||ve){Zn=!1,Xn=0;return}const t=ma(ot.position,ot.position.y+.16);if(!Zn&&ot.position.y>t+.08&&(Zn=!0,Xn=Math.min(0,Xn)),!Zn){ot.position.y=t;return}const e=ot.position.y;Xn-=12.5*n,ot.position.y+=Xn*n;const i=ma(ot.position,e+.12);Xn<=0&&ot.position.y<=i&&e>=i-.06&&(ot.position.y=i,Xn=0,Zn=!1),ot.position.y<-2&&so()}function so(n=!0){if(te)return;const t=ot.position.clone(),e=[];for(const r of mn)for(let s=He.minX+6;s<He.maxX-6;s+=3)e.push(new A(s,0,r));for(const r of mr)for(let s=He.minZ+6;s<He.maxZ-6;s+=3)e.push(new A(r,0,s));e.sort((r,s)=>r.distanceToSquared(t)-s.distanceToSquared(t));for(const r of[2,3,4.2,5.5])for(let s=0;s<16;s++)e.push(new A(t.x+Math.cos(s*Math.PI*2/16)*r,0,t.z+Math.sin(s*Math.PI*2/16)*r));const i=e.find(r=>(r.y=ro(r),Ta(r,!1,r.y)));ot.position.copy(i??new A(-6,0,1)),Xn=0,Zn=!1,Ci.set(0,0,0),yc.length=0,cM.copy(ot.position),Q("#stuck-button").hidden=!0,n&&qt("Moved you to the nearest clear space."),Ae()}function cf(){const n=nu(),t=Lt.rotation.y,e=Lt.userData.trailer,i=e.rotation.y,r=new A(3,0,(we-2.2)/2),s=[];for(const c of mn)for(let l=He.minX+9;l<He.maxX-9;l+=4)s.push({center:new A(l,0,c),yaw:Math.PI/2});for(const c of mr)for(let l=He.minZ+9;l<He.maxZ-9;l+=4)s.push({center:new A(c,0,l),yaw:0});s.sort((c,l)=>c.center.distanceToSquared(n)-l.center.distanceToSquared(n));for(const c of[3.5,5.5,8])for(let l=0;l<12;l++)s.push({center:n.clone().add(new A(Math.cos(l*Math.PI*2/12)*c,0,Math.sin(l*Math.PI*2/12)*c)),yaw:t});const o=Lt.position.clone();e.rotation.y=0;const a=s.find(({center:c,yaw:l})=>(Lt.rotation.y=l,Lt.position.copy(c).sub(r.clone().applyAxisAngle(tu,l)),Lt.updateMatrixWorld(!0),!(lf()||os.some(h=>h.visible&&c.distanceTo(h.position)<4.2))));a||(Lt.position.copy(o),Lt.rotation.y=t,e.rotation.y=i),Lt.updateMatrixWorld(!0),Ge=0,Us=0,Mc.length=0,qi.length=0,Jd.copy(Lt.position),Q("#stuck-button").hidden=!0,qt(a?"Moved the truck to the nearest clear space.":"No clear rescue position found nearby."),Ae()}function Aa(){!te&&!Ta(ot.position,!1,ot.position.y)&&so(!1)}function AM(n){if(!te||ve)return{acceleration:0,yawRate:0};const t=Number(Ee.has("KeyW")||Ee.has("ArrowUp"))-Number(Ee.has("KeyS")||Ee.has("ArrowDown")),e=Number(Ee.has("KeyA")||Ee.has("ArrowLeft"))-Number(Ee.has("KeyD")||Ee.has("ArrowRight")),i=t,r=e,s=Ge;if(i&&Ui>.05)return Ge=0,Qe-Go>1.5&&(Go=Qe,qt("Raise the rear with G before driving.")),{acceleration:0,yawRate:0};Ge+=i*(i*Ge<0?10:4+B.levels.truck*.45)*n,i||(Ge*=Math.exp(-1.7*n)),!i&&Math.abs(Ge)<.04&&(Ge=0),Ge=ge.clamp(Ge,-4,8.5+B.levels.truck*1.3),Us=ge.damp(Us,ge.clamp(r,-1,1)*.56,4.5,n);const o=Lt.userData.trailer;o.rotation.y=0,Lt.updateMatrixWorld(!0);const a=Ge*Math.tan(Us)/Math.max(3.1,we*.65),c=new A(3,0,(we-2.2)/2),l=ni(c),u=l.clone(),h=Lt.position.clone(),d=Lt.rotation.y;Lt.rotation.y+=a*n,l.addScaledVector(new A(-Math.sin(Lt.rotation.y),0,-Math.cos(Lt.rotation.y)),Ge*n),Lt.position.copy(l).sub(c.applyAxisAngle(tu,Lt.rotation.y)),Lt.updateMatrixWorld(!0);let f=!1,g=!1;f=lf();const S=2.4;(l.x<He.minX+S||l.x>He.maxX-S||l.z<He.minZ+S||l.z>He.maxZ-S)&&(f=!0);for(const m of os)m.visible&&l.distanceTo(m.position)<4.2&&l.distanceTo(m.position)<u.distanceTo(m.position)-.005&&(f=!0,g=!0);f&&(Lt.position.copy(h),qi.push(Qe),Ue&&!We&&Qe-_c>1.5&&(Er++,_c=Qe),Lt.rotation.y=d,Lt.updateMatrixWorld(!0),Ge=-s*.12,Qe-Go>.7&&(Go=Qe,g&&qt("Both trucks stopped safely. Reverse away to continue.")));for(const m of Lt.userData.wheels??[])m.rotation.x-=Ge*n/.46;for(const m of Lt.userData.frontWheels??[])m.rotation.y=ge.damp(m.rotation.y,Us*.72,9,n);return{acceleration:(Ge-s)/n,yawRate:a}}function js(){os.forEach(mi),os=[],B.fleet.forEach((n,t)=>{const e=new xe;e.name=`fleet-${t}`;const i=parseInt(aa.truck.find(a=>a.id===B.selectedSkins.truck)?.color.slice(1)??"e6ad51",16),r=new $t(i).multiplyScalar(.83).getHex();P(e,0,.48,0,2.35,.35,4.3,3361358,!0),P(e,0,1.52,.63,2.28,1.85,2.85,i,!0),P(e,0,2.46,.63,2.36,.09,2.93,r,!0),P(e,0,1.18,-1.45,2.1,1.18,1.35,i,!0),P(e,0,1.79,-1.48,2.12,.09,1.34,r,!0),P(e,0,1.38,-2.13,1.72,.55,.055,9156802,!0),P(e,0,.86,-2.13,1.6,.2,.055,3427670,!0),P(e,0,1.15,2.09,2,1.12,.08,r,!0);for(const a of[-1,1])P(e,a*.84,.81,-2.13,.22,.2,.055,16769956,!0),P(e,a*1.07,1.35,-1.48,.055,.48,.58,9156802,!0),P(e,a*.9,.77,2.12,.19,.28,.055,13591893,!0);const s=[];for(const a of[-1.2,1.2])for(const c of[-1.46,1.35]){const l=new Ot(new un(.38,.38,.2,14),new Sr({color:2505027}));l.rotation.z=Math.PI/2,l.position.set(a,.38,c),e.add(l),s.push(l);const u=new Ot(new un(.2,.2,.205,14),new Sr({color:12108988}));u.rotation.z=Math.PI/2,u.position.set(a*1.01,.38,c),e.add(u)}e.userData.wheels=s,e.userData.skin=B.selectedSkins.truck;const o=Tc(wc(n,t),n.phase);e.position.copy(o.position),e.rotation.y=o.yaw+Math.PI,e.userData.safePosition=o.position.clone(),Pe.add(e),os.push(e)})}function wc(n,t){const e=8+t*4.8;return[new A(e,0,-9),new A(e,0,4),new A(e,0,12),new A(42,0,12),new A(90,0,12),new A(90,0,48),new A(42,0,48),new A(42,0,12),new A(e,0,12),new A(e,0,4),new A(e,0,-9)]}function Tc(n,t){if(t<=0)return{position:n[0].clone(),yaw:0,segment:0};const e=n.slice(1).map((s,o)=>s.distanceTo(n[o])),i=e.reduce((s,o)=>s+o,0);let r=ge.clamp(t,0,.9999)*i;for(let s=0;s<e.length;s++){if(r<=e[s]){const o=r/Math.max(.001,e[s]),a=n[s].clone().lerp(n[s+1],o),c=n[s+1].clone().sub(n[s]);return{position:a,yaw:Math.atan2(c.x,c.z),segment:s}}r-=e[s]}return{position:n.at(-1).clone(),yaw:0,segment:e.length-1}}function Bh(n,t){const e=new ct(Math.sin(n.yaw),Math.cos(n.yaw)),i=new ct(Math.sin(t.yaw),Math.cos(t.yaw)),r=new ct(e.y,-e.x),s=new ct(i.y,-i.x),o=new ct(t.position.x-n.position.x,t.position.z-n.position.z),a=3.65,c=1.43;for(const l of[e,r,i,s]){const u=a*Math.abs(l.dot(e))+c*Math.abs(l.dot(r)),h=a*Math.abs(l.dot(i))+c*Math.abs(l.dot(s));if(Math.abs(l.dot(o))>=u+h)return!1}return!0}function RM(n){const t=B.fleet.map(u=>u.pending??0),e=eM(B,n,-1);e&&ua<=0&&qt(`+$${e} · Your company is working`),Lt.updateMatrixWorld(!0);const i=new _s().setFromObject(Lt).expandByScalar(2.6),r=B.fleet.map((u,h)=>Tc(wc(u,h),u.phase)),s=r.some((u,h)=>B.fleet[h].phase>0&&u.segment>=7&&u.segment<=9),o=r.some((u,h)=>B.fleet[h].phase>0&&u.segment>=1&&u.segment<=3),a=r.some((u,h)=>B.fleet[h].phase>0&&u.segment===6&&u.position.z<19),c=s||!o&&a?"in":"out",l=B.fleet.map((u,h)=>h).sort((u,h)=>B.fleet[h].phase-B.fleet[u].phase);for(const u of l){const h=B.fleet[u],d=os[u];if(!d||h.pending)continue;h.route??=u%3;const f=h.phase+n/Bd(h),g=Tc(wc(h,u),f>=1?0:f),S=g.segment>=7||g.segment===6&&g.position.z<19,m=g.segment>=1&&g.segment<=3,p=c==="in"&&m||c==="out"&&S,b=i.containsPoint(g.position.clone().setY(1)),w=r.some((x,_)=>_!==u&&Bh(g,x)&&(!Bh(r[u],x)||g.position.distanceTo(x.position)<=r[u].position.distanceTo(x.position)+.001));if(!p&&!b&&!w){h.phase=f>=1?0:f,f>=1&&(h.completed++,h.pending=(h.pending??0)+kd(h));const x=d.userData.safePosition?g.position.distanceTo(d.userData.safePosition):0;d.position.copy(g.position),r[u]=g,d.rotation.y=g.yaw+Math.PI;for(const _ of d.userData.wheels??[])_.rotation.x-=x/.4;d.userData.safePosition=g.position.clone()}}B.fleet.some((u,h)=>(u.pending??0)>t[h])&&(Dn(),qt("An employee truck returned. Collect its income at the parking bay."),Ae())}function CM(n){const t=te?ni(new A(3,0,2)):ot.position;for(const s of[...ba.roofs,...gr.roofs,...Bn.roofs,...ei.roofs]){const o=Math.abs(t.x-s.bounds.x)<s.bounds.w/2+1&&Math.abs(t.z-s.bounds.z)<s.bounds.d/2+1;for(const a of[s.mesh,...s.walls??[]]){const c=a.material;c.opacity=ge.damp(c.opacity,o?.035:1,6,n),c.depthWrite=c.opacity>.5,a.castShadow=c.opacity>.5}}const e=ii(ot.position),i=!te&&e.x>1&&e.x<5&&e.z>-.1&&e.z<we+2.5,r=[Lt.userData.roof,...Lt.userData.cargoWalls??[]];for(const s of r){const o=s.material;o.opacity=ge.damp(o.opacity,i||te?.025:1,7,n),o.depthWrite=o.opacity>.5,s.castShadow=o.opacity>.5}}function PM(){if(!Ue||We)return{point:new A(-10,0,1),text:"Accept a move at your job board"};if(ir())return{point:new A(wn+2,0,hn),text:"Choose your completion reward"};const n=ue.find(t=>t.mode==="ground");return n?{point:n.position.clone(),text:n.fallen?"Recover the fallen furniture":"Pick up the furniture"}:{point:new A(wn-5.6,0,hn+1),text:"Unload inside the new home"}}function DM(n){if(!te)return n;const t=nu(),{leg:e,point:i}=wa(),r=i.x,s=i.z;if(Math.abs(t.x-r)<10&&Math.abs(t.z-s)<10)return vr=e,Wn=[],je=0,{point:new A(r,0,s),text:e==="yard"?"Park fully inside the yellow yard bay":`Park fully inside the yellow ${e} bay`};const o=Wn.length<2?1/0:Math.min(...Wn.slice(1).map((x,_)=>{const M=Wn[_],R=x.x-M.x,v=x.z-M.z,T=R*R+v*v,D=T?ge.clamp(((t.x-M.x)*R+(t.z-M.z)*v)/T,0,1):0;return Math.hypot(t.x-M.x-R*D,t.z-M.z-v*D)})),a=x=>mn.reduce((_,M)=>Math.abs(M-(x+12))<Math.abs(_-(x+12))?M:_),l=e==="yard"?12:a(e==="pickup"?an:hn),u=t.x>-26&&t.x<36&&t.z>-36&&t.z<8,h=(x,_)=>Math.abs(t.x-(x+4))<12&&Math.abs(t.z-(_-2.1))<13,d=u?12:h(Sn,an)?a(an):h(wn,hn)?a(hn):void 0;(vr!==e||!Wn.length||o>7)&&(vr=e,je=0,Wn=rM(t,new A(r,0,s),{startLane:d,goalLane:l}));const f=Wn;let g=0,S=1/0;for(let x=0;x<f.length-1;x++){const _=f[x],M=f[x+1],R=M.x-_.x,v=M.z-_.z,T=R*R+v*v,D=T?ge.clamp(((t.x-_.x)*R+(t.z-_.z)*v)/T,0,1):0,O=Math.hypot(t.x-_.x-R*D,t.z-_.z-v*D)+Math.max(0,je-x-1)*2;O<S&&(S=O,g=x)}for(je=Math.min(f.length-1,Math.max(je,g+1));je<f.length-1&&(t.distanceTo(f[je])<2.5||oM(f[je-1],f[je],t));)je++;const m=f[je],p=Math.round(t.distanceTo(m)),b=f[je+1];let w=e==="yard"?"Return to your company yard":`Continue to the ${e} house`;if(b){const x=sM(f[je-1],m,b);w=x==="straight"?`Continue straight for ${p} m`:x==="around"?`In ${p} m turn around`:`In ${p} m turn ${x}`}else p<18&&(w=e==="yard"?"Park in your company yard":`Park at the ${e} house`);return{point:m,text:w}}function zh(){for(;ps.children.length;){const n=ps.children.pop();n instanceof Ot&&(n.geometry.dispose(),n.material.dispose())}}function LM(){const n=te&&Wn.length>1,t=wa().point;if(ji.visible=te,ji.position.set(t.x,0,t.z),Ea.scale.y=Kd(),!n){ko&&zh(),ko="";return}const e=Wn,i=`${vr}:${e.map(l=>`${l.x.toFixed(1)},${l.z.toFixed(1)}`).join(";")}`,r=()=>{const l=ps.children[0];if(!l)return;const h=l.geometry.userData.segmentEnds[Math.max(0,je-2)]??0;l.geometry.setDrawRange(h,l.geometry.getAttribute("position").count-h)};if(i===ko){r();return}ko=i,zh();const s=[],o=[];for(let l=0;l<e.length-1;l++){const u=e[l],h=e[l+1],d=h.clone().sub(u),f=d.length(),g=mn.some(w=>Math.abs(u.z-w)<.15&&Math.abs(h.z-w)<.15)||mr.some(w=>Math.abs(u.x-w)<.15&&Math.abs(h.x-w)<.15);if(f<.5||!g){o.push(s.length/3);continue}const S=d.multiplyScalar(1/f),m=new A(-S.z,0,S.x),p=4.2,b=Math.min(2.2,f*.4);for(let w=b;w<f-.45;w+=p){const x=u.clone().addScaledVector(S,w),_=x.clone().addScaledVector(S,.82),M=x.clone().addScaledVector(S,-.58),R=M.clone().addScaledVector(m,.5),v=M.clone().addScaledVector(m,-.5);s.push(_.x,.14,_.z,R.x,.14,R.z,v.x,.14,v.z)}o.push(s.length/3)}if(!s.length)return;const a=new Oe;a.setAttribute("position",new se(s,3)),a.userData.segmentEnds=o,a.computeVertexNormals();const c=new Ot(a,new yi({color:7792592,transparent:!0,opacity:.82,side:gn,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-3}));c.name="route-ground-arrows",c.renderOrder=3,ps.add(c),r()}function jr(){const n=PM(),t=DM(n),e=ue.filter(c=>c.mode==="truck").length,i=ue.filter(c=>c.mode==="delivered").length;LM(),Q("#jem-count").textContent=B.test?"∞":B.jems.toLocaleString("en-US"),Q("#cash").textContent=B.test?"∞":B.cash>=1e4?`$${(B.cash/1e3).toFixed(B.cash<1e5?1:0)}K`:`$${Math.floor(B.cash).toLocaleString("en-US")}`,Q("#cash-mode").textContent=B.test?"TEST MONEY":`$${Math.floor(B.earned).toLocaleString("en-US")} earned`,Q("#job-title").textContent=We?B.finished?"Coming soon":"Move completed!":Ue?Ut.title:"Small beginnings",Q("#job-label").textContent=Ue?`MOVE ${Tr+1} · LEVEL ${Ut.difficulty}`:"YOUR NEXT MOVE",Q("#job-step").textContent=t.text,Q("#job-progress").style.width=`${Ue?(e+i*2)/ue.length/2*100:0}%`,Q("#job-count").textContent=Ue?`${e} in truck  ·  ${i}/${ue.length} delivered`:"Your first customer is waiting",Q("#job-score").innerHTML=Ue?`<div class="score-total"><span>MOVE SCORE</span><b>${ls()}/100</b></div><small>${sf()}</small>`:"",Q("#job-value").textContent=Ue?`${We?"COLLECTED":"PAYDAY"}  $${ir()?da():Ut.reward}`:B.finished?"You built the complete company.":"Start with a job. Build an empire.";const r=te?ni(new A(3,0,1)):ot.position,s=Math.round(r.distanceTo(t.point));Q("#nav-distance").textContent=te&&s>5?`${s} m`:"",Q("#status-kicker").textContent=te?`${Math.round(Math.abs(Ge)*3.6)} KM/H · NEXT ACTION`:"NEXT ACTION";let o="E",a=t.text;if(Ve)a=`${Ve.kind==="lift"?"Lifting":"Placing"} ${Ve.load.item.name}`,o="···";else if(te)o="W/S",a=t.text;else if(Gt)a=cs()?ru()?.valid?"Place in highlighted space · R rotate":"No clear space nearby · R rotate or move closer":Kn.visible?`Place ${Gt.item.name} on the marked spot`:"Carry to the truck or into the delivery house";else if(pa()){const c=pa();a=c.key==="job"?"Stand still on the job field to accept a move":c.income!==void 0?`Collect $${B.fleet[c.income]?.pending??0} from this crew`:c.upgrade?`Stand still to upgrade ${br[c.upgrade]}`:"Stand still to upgrade this fleet truck",o=c.key==="job"?"⏱":c.upgrade||c.fleet!==void 0?"$":"E"}else{const c=af(),l=ii(ot.position);c?(a=`Lift ${c.item.name} · ${c.item.weight>=4?"HEAVY":c.item.fragile?"FRAGILE":"READY"}`,o="E"):Math.hypot(l.x-5.3,l.z+1)<3?(a="Enter your truck",o="F"):Math.hypot(l.x-3,l.z-we)<4&&(a=Ui?"Raise the rear":"Lower the rear",o="G")}Q("#hint-key").textContent=o,Q("#nav-label").textContent=a,Q("#company-stats").innerHTML=`<div><b>${B.jobs}</b><span>YOUR MOVES</span></div><div><b>${B.levels.hire}</b><span>CREWS</span></div><div><b>${B.fleet.length}</b><span>FLEET TRUCKS</span></div>`,Q("#fleet-list").innerHTML=B.fleet.map((c,l)=>`<div class="fleet-row"><span>Truck ${l+2} · Level ${c.level}<small>${(c.pending??0)>0?`$${c.pending} ready at parking bay`:c.phase<.05?"Loading at the base":c.phase<.82?"Driving through the city tunnel":"Returning to its bay"} · ${c.completed} trips</small></span><div class="progress"><i style="width:${Math.max(0,c.phase)*100}%"></i></div></div>`).join(""),document.querySelectorAll("[data-upgrade]").forEach(c=>{const l=c.dataset.upgrade;c.textContent=`${br[l]} · ${B.levels[l]}/${bn[l]}`})}function Ae(){if(!Yd)try{Qi.setItem("movecraft-rewrite-v1",JSON.stringify({worldVersion:2,navPath:Wn.map(n=>n.toArray()),company:B,contract:Ut,jobActive:Ue,jobPaid:We,jobNumber:Tr,routeVariant:Yn,collisionHits:Er,jobElapsed:wr,navLeg:vr,navIndex:je,tutorialStep:kt,truck:{position:Lt.position.toArray(),yaw:Lt.rotation.y,trailerAngle:Lt.userData.trailer.rotation.y,rear:Ui},player:ot.position.toArray(),loads:ue.map(n=>({item:n.item,mode:n.mode==="hand"?"ground":n.mode,position:n.mode==="hand"?ot.position.toArray():n.position.toArray(),velocity:n.velocity.toArray(),rotation:n.mesh.rotation.toArray(),settled:n.settled,fallen:n.fallen}))}))}catch{}}function IM(){if(Qt)try{Ut=Qt.contract?.fromSite&&Qt.contract?.toSite?Qt.contract:{...Jc(Qt.jobNumber??B.jobs,B.levels.truck,Qt.routeVariant??0),...Qt.contract??{},fromSite:Ut.fromSite,toSite:Ut.toSite},Sn=Ut.fromSite.x,an=Ut.fromSite.z??0,wn=Ut.toSite.x,hn=Ut.toSite.z??0,Ue=!!Qt.jobActive,We=!!Qt.jobPaid,Tr=Qt.jobNumber??0,Yn=Qt.routeVariant??Tr%3,Er=Qt.collisionHits??0,wr=Qt.jobElapsed??0,vr="",je=0,Wn=[],Qt.truck&&(Lt.position.fromArray(Qt.truck.position),Lt.rotation.y=Qt.truck.yaw,Lt.userData.trailer.rotation.y=0,Zi=Ui=Qt.truck.rear),Qt.player&&ot.position.fromArray(Qt.player),Ue&&(mi(Bn.root),mi(ei.root),Bn=fs(Sn,Ut.fromSite.variant+Yn,!1,an),ei=fs(wn,Ut.toSite.variant+Yn,!0,hn),Pe.add(Bn.root,ei.root),tf(),Sc());let n=!1;for(const t of Qt.loads??[]){const e={item:t.item,mesh:Nd(t.item.model),mode:t.mode==="air"?"ground":t.mode,position:new A().fromArray(t.position),velocity:new A().fromArray(t.velocity??[0,0,0]),angular:new A,hitAt:-10,settled:t.settled,fallen:!1};if(t.mode==="air"&&(e.position.y=.12,e.fallen=!0),t.shelf&&e.mode==="truck"&&(n=!0,e.position.y=.78,e.item.x=Math.max(0,Math.min(3,e.item.x)),e.item.z=Math.max(0,Math.min(zn-tn(e.item)[1],e.item.z)),e.position.x=1.4+(e.item.x+tn(e.item)[0]/2)*Ft,e.position.z=.2+(e.item.z+tn(e.item)[1]/2)*Ft),ue.push(e),e.mode==="ground"&&!e.fallen&&Bn.barriers.some(i=>Math.abs(e.position.x-i.x)<(e.item.w*Ft+i.w)/2+.18&&Math.abs(e.position.z-i.z)<(e.item.d*Ft+i.d)/2+.18)){const i=Ut.items.find(r=>r.id===e.item.id);i&&(e.item.pickupX=i.pickupX,e.item.pickupZ=i.pickupZ),e.position.set(Sn+e.item.pickupX,.12,an+e.item.pickupZ)}ms(e),t.rotation&&e.mode!=="truck"&&e.mesh.rotation.fromArray(t.rotation)}if(n||ue.some(t=>t.mode==="truck"&&t.item.z+tn(t.item)[1]>zn)){const t=[];let e=0;for(const i of ue.filter(r=>r.mode==="truck")){let r;const s=i.item.rotated;for(const o of[s,!s]){i.item.rotated=o;for(let a=0;a<zn&&!r;a++)for(let c=0;c<4&&!r;c++)Qc(t,i.item,c,a,4,zn)&&(r={x:c,z:a,rotated:o});if(r)break}if(r){i.item.rotated=r.rotated,i.item.x=r.x,i.item.z=r.z;const[o,a]=tn(i.item);i.position.set(1.4+(r.x+o/2)*Ft,.78,.2+(r.z+a/2)*Ft),t.push({...i.item,location:"truck"})}else i.mode="ground",i.fallen=!0,i.position.copy(ni(new A(3+e%2*1.4,.12,we+3+Math.floor(e/2)*1.5))),e++;ms(i)}}Ue&&Sc(),Aa()}catch{qt("Saved session could not be fully restored.")}}function NM(){(!Ue||We)&&ha(!0),B.levels.truck<3&&(B.levels.truck=3,B.levels.cargo=B.levels.gear=3,Js()),Gt=null,Ve=null;for(const n of ue)n.mode="ground",n.item.rotated=!1;for(const n of ue){let t=!1;for(const e of[!1,!0]){if(t)break;n.item.rotated=e;for(let i=0;i<zn&&!t;i++)for(let r=0;r<4&&!t;r++){const s=ue.map(o=>({...o.item,location:o.mode==="truck"?"truck":"pickup"}));if(Qc(s,n.item,r,i,4,zn)){n.item.x=r,n.item.z=i;const[o,a]=tn(n.item);n.mode="truck",n.position.set(1.4+(r+o/2)*Ft,.78,.2+(i+a/2)*Ft),n.velocity.set(0,0,0),t=!0}}}ms(n)}Dn(),qt(`${ue.filter(n=>n.mode==="truck").length}/${ue.length} packed. Test packing expands the cargo bay.`),Ae()}function UM(n){if(Math.abs(Ge)>.35)return qt("Stop before using test tools.");n==="job"&&ha(!0),n==="pack"&&NM(),n==="deliver"&&(Ue||ha(),ue.forEach((t,e)=>{t.mode="delivered",t.position.set(wn-8+e%3*2.5,.12,hn-3+Math.floor(e/3)*2.5),ms(t)}),Gt=null,Ve=null,Dn(),ot.position.set(wn-6,0,hn+6),te=!1,ot.visible=!0,qt("Delivery complete. Choose your reward."),fa()),n==="home"&&(ot.position.set(-6,0,1),te=!1,ot.visible=!0,qt("Test teleport: player returned. Truck and cargo stay where they are.")),n==="restart"&&(nr('<h2>Reset test career?</h2><p>This replaces your saved rewrite career with the shabby starting setup.</p><button id="confirm-reset">Reset career</button>'),Q("#confirm-reset").onclick=()=>{Yd=!0,Qi.removeItem("movecraft-rewrite-v1"),Qi.removeItem("movecraft-update-backup"),location.reload()}),Ae()}const uf={interact:vM,cab:yM,rotate:()=>{Gt&&!Ve&&(Gt.item.rotated=!Gt.item.rotated,Gt.mesh.rotation.set(0,Gt.item.rotated?Math.PI/2:0,0),Gt.mesh.position.z=Qs(Gt))},rear:MM};document.querySelectorAll("[data-action]").forEach(n=>n.onclick=()=>uf[n.dataset.action]());document.querySelectorAll("[data-test]").forEach(n=>n.onclick=()=>UM(n.dataset.test));Q("#upgrade-tests").innerHTML=Object.keys(br).filter(n=>["truck","worker","yard","hire","factory"].includes(n)).map(n=>`<button data-upgrade="${n}"></button>`).join("");document.querySelectorAll("[data-upgrade]").forEach(n=>n.onclick=()=>{if(Math.abs(Ge)>.35)return qt("Stop before upgrading.");const t=n.dataset.upgrade;of(t);const e=li.find(i=>i.key===t);e&&(te=!1,ot.visible=!0,ot.position.copy(e.position).add(new A(0,0,2)),ot.position.y=ro(ot.position),Ne.zoom=t==="yard"||t==="fleet"?.9:1.6,Ne.updateProjectionMatrix())});Q("#test-toggle").onclick=()=>{Q("#tests").hidden=!Q("#tests").hidden};Q("#company-toggle").onclick=()=>{Q("#company-panel").hidden=!Q("#company-panel").hidden};function FM(){const n=new Date,t=n.toISOString().slice(0,10),e=new Date(n.getTime()-864e5).toISOString().slice(0,10),i=B.daily.lastClaim===t,r=B.daily.lastClaim===e?B.daily.streak>=8?1:B.daily.streak+1:1,s=i?B.daily.streak:r,o=l=>ss(l)?`$${ss(l)}`:rs(l)?`<span class="daily-jem">${ce.icon} ${rs(l)} ${ce.name}</span>`:"Construction worker skin",a=r===8&&B.ownedSkins.person.includes("build")?`<span class="daily-jem">${ce.icon} 5 ${ce.name}</span>`:o(r),c=Array.from({length:8},(l,u)=>{const h=u+1;return`<div class="daily-day ${h===s?"today":h<s?"collected":""} ${h===8?"daily-skin-day":""}"><span>DAY ${h}</span>${h===8?`<div class="daily-skin-preview">${$d("person","build")}</div>`:""}<strong>${o(h)}</strong><small>${h<s||i&&h===s?"✓ Collected":h===s?"Available":"Upcoming"}</small></div>`}).join("");return`<div class="daily-modal"><small>DAILY REWARD</small><h2>${i?"Come back tomorrow":`Claim ${a}`}</h2><div class="daily-days">${c}</div><p>Claim on consecutive days. A missed day restarts the series at Day 1.${B.ownedSkins.person.includes("build")?" If you already own the Day 8 skin, you receive 5 Jems instead.":""}</p>${i?"":'<button id="claim-daily">Claim reward</button>'}</div>`}let hf="daily";function Ls(n,t){Ae(),nr(`<div class="shop-success"><div class="shop-success-icon">✓</div><small>PURCHASE COMPLETE</small><h2>${n}</h2><p>${t}</p><button id="shop-success-close">Continue shopping</button></div>`),Q("#shop-success-close").onclick=()=>ga(hf)}function bl(n){const t=document.querySelector("#shop-error");t&&(t.textContent=n,t.hidden=!1)}function ga(n="daily"){hf=n;const t=`<div class="shop-tabs"><button data-shop-tab="daily" class="${n==="daily"?"active":""}">Daily gifts</button><button data-shop-tab="currency" class="${n==="currency"?"active":""}">Coins & Jems</button><button data-shop-tab="skins" class="${n==="skins"?"active":""}">Skins</button></div>`;let e="";n==="daily"&&(e=FM()),n==="currency"&&(e=`<div class="shop-section"><h2>Coins & ${ce.name}</h2><p class="shop-balance">${ce.icon} ${B.test?"∞":B.jems} ${ce.name} · $${B.test?"∞":Math.floor(B.cash).toLocaleString("en-US")}</p>${mc.map((s,o)=>`<div class="shop-card"><span class="shop-art coins">$</span><span><b>${s.coins.toLocaleString("en-US")} coins</b><small>Exchange ${s.jems} ${ce.name}</small></span><button data-coin-pack="${o}">${ce.icon} ${s.jems}</button></div>`).join("")}${`<div class="shop-card"><span class="shop-art coins">$</span><span><b>5,000 coins</b><small>Rewarded video</small></span><button data-video-reward="coins">▶ Watch</button></div><div class="shop-card"><span class="shop-art jems">${ce.icon}</span><span><b>10 ${ce.name}</b><small>Rewarded video</small></span><button data-video-reward="jems">▶ Watch</button></div>`}</div>`),n==="skins"&&(e=`<div class="shop-section"><h2>Skins</h2><p class="shop-balance">${ce.icon} ${B.test?"∞":B.jems} ${ce.name}</p><p class="shop-note">Looks only · levels stay unchanged</p>${["truck","person"].map(s=>`<h3>${s==="truck"?"Truck":"Person"}</h3><div class="skin-grid">${aa[s].map(o=>{const a=B.ownedSkins[s].includes(o.id),c=B.selectedSkins[s]===o.id;return`<div class="skin-card"><div class="skin-preview ${s}">${$d(s,o.id)}</div><b>${o.name}</b><button data-skin-kind="${s}" data-skin-id="${o.id}" ${c?"disabled":""}>${c?"Equipped":a?"Equip":`${ce.icon} ${o.price}`}</button></div>`}).join("")}</div>`).join("")}</div>`),nr(`<div class="shop-modal"><div class="shop-heading"><span>🛒 SHOP</span><div class="shop-wealth"><span>$${B.test?"∞":Math.floor(B.cash).toLocaleString("en-US")}</span><span>${ce.icon} ${B.test?"∞":B.jems}</span></div></div>${t}<p id="shop-error" class="shop-error" hidden></p>${e}</div>`),document.querySelectorAll("[data-shop-tab]").forEach(s=>s.onclick=()=>ga(s.dataset.shopTab));const i=document.querySelector("#claim-daily-double");i&&(i.onclick=()=>{i.disabled=!0,wf(()=>{const s=Math.min(8,B.daily.streak+1);Ph(B);const o=ss(s),a=rs(s);o&&ds(B,o),a&&(B.jems+=a),Ae(),jr(),Ls(o?`$${o*2}`:`${ce.icon} ${a*2}`,"Daily gift doubled"),Q("#daily-button").classList.remove("ready")},()=>{i.disabled=!1,bl("Ad unavailable · try again")})});const r=document.querySelector("#claim-daily");r&&(r.onclick=()=>{const s=B.ownedSkins.person.includes("build");Ph(B),Ae(),jr();const o=B.daily.streak,a=ss(o)?`$${ss(o)}`:rs(o)?`${ce.icon} ${rs(o)} ${ce.name}`:s?`${ce.icon} 5 ${ce.name}`:"Construction worker skin";Ls(a,"Daily reward claimed"),Q("#daily-button").classList.remove("ready")}),document.querySelectorAll("[data-coin-pack]").forEach(s=>s.onclick=()=>{const o=Number(s.dataset.coinPack),a=mc[o];if(!a||!aM(B,o))return bl(`You need ${a?.jems??0} ${ce.name}.`);jr(),Ls(`${a.coins.toLocaleString("en-US")} coins`,`Paid ${a.jems} ${ce.name}`)}),document.querySelectorAll("[data-video-reward]").forEach(s=>s.onclick=()=>{const o=s.dataset.videoReward;s.disabled=!0;const a=()=>{o==="coins"?ds(B,5e3):B.jems+=10,jr(),Ls(o==="coins"?"5,000 coins":`10 ${ce.name}`,"Video reward claimed")};{const c=Q("#dialog");c.innerHTML='<div class="reward-video"><b>MOVING EMPIRE</b><p>Video preview</p><div class="progress"><i></i></div></div>',window.setTimeout(a,3e3)}}),document.querySelectorAll("[data-skin-kind]").forEach(s=>s.onclick=()=>{const o=s.dataset.skinKind,a=s.dataset.skinId;if(B.ownedSkins[o].includes(a)){B.selectedSkins[o]=a,o==="truck"?(Js(),js()):la(),Ae(),ga("skins");return}if(!lM(B,o,a))return bl(`Not enough ${ce.name} for this skin.`);o==="truck"?(Js(),js()):la();const c=aa[o].find(l=>l.id===a);Ls(`${c.name} ${o==="truck"?"truck":"person"} skin`,"Purchased and equipped · Upgrade level unchanged")})}Q("#daily-button").onclick=()=>ga();Q("#job-toggle").onclick=()=>Q("#job-body").classList.toggle("collapsed");const OM="406b1e8ded8c31c22583e85f4204eff2ae6692fa65a9c8a9552756b5a834b3f4";async function BM(n){const t=new TextEncoder().encode(n),e=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(e),r=>r.toString(16).padStart(2,"0")).join("")===OM}function Ac(){Q("#mode-toggle").hidden=!0,Q("#test-toggle").hidden=!0,B.test||(Q("#tests").hidden=!0)}B.test=!1;Ac();Q("#camera-follow").onclick=()=>{Ne.zoom=.78,Ne.updateProjectionMatrix()};for(const[n,t]of[["zoom-in",1.2],["zoom-out",1/1.2]])Q(`#${n}`).onclick=()=>{Ne.zoom=ge.clamp(Ne.zoom*t,_n.minZoom,_n.maxZoom),Ne.updateProjectionMatrix()};Q("#settings").onclick=()=>{nr(`<div class="settings-panel"><h2>Settings</h2><section><h3>Audio</h3><label><span>Button sound</span><input id="sound" type="checkbox" ${Zs?"checked":""}></label></section><section><h3>Game & display</h3><label><span>Soft shadows</span><input id="shadows" type="checkbox" ${_l?"checked":""}></label><button id="rescue-now">Got stuck? Move to a clear spot</button><button id="replay-tutorial">Replay tutorial</button></section><section><details id="dev-section" ${B.test?"open":""}><summary>Advanced</summary><div class="developer-access">${B.test?'<button id="dev-tools-open">Open tools</button><button id="dev-disable">Disable developer mode</button>':'<label><span>Access code</span><input id="dev-code" type="password" autocomplete="off" spellcheck="false"></label><button id="dev-unlock">Unlock</button><p id="dev-error" class="fine" role="status"></p>'}</div></details></section><section><h3>About</h3><p>Moving Empire · Publisher: Tortugarx</p></section><section><h3>Progress</h3><button id="update-game">Update game safely</button><p class="fine">${bf()}</p></section></div>`);const n=document.querySelector("#dev-unlock");n&&(Q("#dev-code").onkeydown=t=>{t.key==="Enter"&&(t.preventDefault(),n.click())},n.onclick=async()=>{n.disabled=!0;const t=Q("#dev-code");await BM(t.value)?(B.test=!0,Ac(),Dn(),Ae(),Q("#dialog").close(),qt("Developer tools unlocked.")):(Q("#dev-error").textContent="Incorrect code.",t.value="",n.disabled=!1)}),document.querySelector("#dev-tools-open")?.addEventListener("click",()=>{Q("#dialog").close(),Q("#tests").hidden=!1}),document.querySelector("#dev-disable")?.addEventListener("click",()=>{B.test=!1,Ac(),Dn(),Ae(),Q("#dialog").close()}),Q("#sound").onchange=t=>{Zs=t.target.checked,uM()},Q("#shadows").onchange=t=>{_l=t.target.checked,Ln.shadowMap.enabled=_l},Q("#rescue-now").onclick=()=>{Q("#dialog").close(),te?cf():so()},Q("#replay-tutorial").onclick=()=>{kt=0,Q("#dialog").close(),ui(Jn[0][0],Jn[0][1],"Got it",Jn[0][2]),Ae()},Q("#update-game").onclick=()=>{Ae();const t=Qi.getItem("movecraft-rewrite-v1");t&&Qi.setItem("movecraft-update-backup",t);const e=new URL(location.href);e.searchParams.set("update",Date.now().toString()),location.replace(e)}};Q("#stuck-button").onclick=()=>te?cf():so();Q("#help").onclick=()=>nr("<h2>Moving controls</h2><p>WASD / arrows move relative to the camera; the mobile joystick points in the world direction to walk. Shift sprints. Space jumps. Drag to orbit, scroll or pinch to zoom.</p><p>E lifts and places. Carry furniture onto the truck through the rear. R rotates. F enters/exits the cab. W/S drives/brakes; A/D steer. On mobile, use the four arrow buttons to drive. G raises or lowers the rear.</p><p>Stand still on an upgrade field to invest automatically.</p>");document.addEventListener("wheel",n=>{(n.ctrlKey||n.metaKey)&&n.preventDefault()},{passive:!1});for(const n of["gesturestart","gesturechange","gestureend"])document.addEventListener(n,t=>t.preventDefault(),{passive:!1});window.addEventListener("keydown",n=>{(n.ctrlKey||n.metaKey)&&["Equal","Minus","Digit0","NumpadAdd","NumpadSubtract","Numpad0"].includes(n.code)&&n.preventDefault()},{capture:!0});window.addEventListener("keydown",n=>{if(Q("#dialog").open||(["KeyW","KeyA","KeyS","KeyD","ArrowUp","ArrowDown","ArrowLeft","ArrowRight","ShiftLeft","Space"].includes(n.code)&&(Ee.add(n.code),n.preventDefault()),n.repeat))return;n.code==="Space"&&wM();const t={KeyE:"interact",KeyF:"cab",KeyR:"rotate",KeyG:"rear"};t[n.code]&&uf[t[n.code]]()});window.addEventListener("keyup",n=>Ee.delete(n.code));window.addEventListener("blur",()=>{Ee.clear(),Ji.set(0,0)});const gs=Q("#joystick"),df=Q("#joystick-knob");let to=null;function ff(n){const t=gs.getBoundingClientRect(),e=t.width*.35,i=n.clientX-(t.left+t.width/2),r=n.clientY-(t.top+t.height/2),s=ge.clamp(i/e,-1,1),o=ge.clamp(r/e,-1,1);Ji.set(Math.abs(s)<.1?0:s,Math.abs(o)<.1?0:o),df.style.transform=`translate(${Ji.x*e}px, ${Ji.y*e}px)`}gs.addEventListener("pointerdown",n=>{n.pointerType==="mouse"||to!==null||(n.stopPropagation(),to=n.pointerId,Ms(),gs.setPointerCapture(n.pointerId),ff(n))});gs.addEventListener("pointermove",n=>{n.pointerId===to&&ff(n)});const pf=n=>{n.pointerId===to&&(to=null,Ji.set(0,0),df.style.transform="translate(0, 0)")};gs.addEventListener("pointerup",pf);gs.addEventListener("pointercancel",pf);document.querySelectorAll("[data-drive-key]").forEach(n=>{const t=n.dataset.driveKey;n.addEventListener("pointerdown",i=>{i.preventDefault(),i.stopPropagation(),Ms(),n.setPointerCapture(i.pointerId),Ee.add(t),n.classList.add("held")});const e=()=>{Ee.delete(t),n.classList.remove("held")};n.addEventListener("pointerup",e),n.addEventListener("pointercancel",e),n.addEventListener("lostpointercapture",e)});document.querySelectorAll("[data-key]").forEach(n=>{n.onpointerdown=t=>{n.setPointerCapture(t.pointerId),Ee.add(n.dataset.key)},n.onpointerup=n.onpointercancel=()=>Ee.delete(n.dataset.key)});function Ra(){const n=Math.max(1,Q("#world").clientWidth),t=Math.max(1,Q("#world").clientHeight);Ln.setSize(n,t,!1);const e=n/t;Ne.left=-12*e,Ne.right=12*e,Ne.top=12,Ne.bottom=-12,_n.minZoom=Math.max(.55,e/4),Ne.zoom=Math.max(Ne.zoom,_n.minZoom),Ne.updateProjectionMatrix()}window.addEventListener("resize",Ra);window.visualViewport?.addEventListener("resize",Ra);new ResizeObserver(Ra).observe(Q("#world"));Js();IM();Jd.copy(Lt.position);js();Dn();Ra();jr();Q("#daily-button").classList.toggle("ready",B.daily.lastClaim!==new Date().toISOString().slice(0,10));kt===0&&B.jobs===0&&ui(Jn[0][0],Jn[0][1],"Got it",Jn[0][2]);no();ir()&&!We&&(Gs=.8);_n.target.copy(ot.position);Ne.position.add(ot.position);_n.update();let kh=!1,Gh=performance.now(),El=0;function mf(n){const t=Math.min((n-Gh)/1e3,.1);Gh=n,Qe+=t,Ue&&!We&&Q("#tutorial-card").hidden&&!Q("#dialog").open&&(wr+=t),Gs>0?(Gs-=t,Gs<=0&&fa()):ir()&&!We&&Q("#tutorial-card").hidden&&!Q("#dialog").open&&fa(),SM(t),Zi=ge.damp(Zi,Ui,3,t),gc=ge.damp(gc,ca,8,t),jd();const e=EM(t);if(!Ec()){const h=ii(ot.position);Zi>.94&&h.x>1.4&&h.x<4.6&&h.z>we&&h.z<=we+2.25||(Ko=!1)}document.body.classList.toggle("seated",te),TM(t);const i=te?Mc:yc,r=te?nu():ot.position;for((!i.length||Qe-i[i.length-1].t>=.35)&&i.push({t:Qe,x:r.x,z:r.z});i.length&&Qe-i[0].t>10;)i.shift();const s=i.length>1&&Qe-i[0].t>=9.5&&i.every(h=>Math.hypot(h.x-i[0].x,h.z-i[0].z)<(te?4:1.5));for(;qi.length&&Qe-qi[0]>10;)qi.shift();const o=te&&qi.length>=3,a=!Q("#tutorial-card").hidden||Q("#dialog").open||!Q("#tests").hidden||!Q("#company-panel").hidden;for(a&&(i.length=0,qi.length=0),Q("#stuck-button").hidden=!!ve||a||!(s||o),Q("#stuck-button").textContent=te?"Truck stuck?":"Got stuck?",te?yc.length=0:(Mc.length=0,qi.length=0),ve||_r.animate(Qe,e,!!Gt||!!Ve,Zo),xM(t),Gt&&(Gt.mesh.rotation.y=ge.damp(Gt.mesh.rotation.y,Gt.item.rotated?Math.PI/2:0,12,t)),El+=t;El>=1/60;)AM(1/60),El-=1/60;if(RM(t),mM(t),CM(t),ji.visible){const h=iu(ji.position),d=h?6808973:16768099;Zd.color.setHex(d)}const c=te?ni(new A(3,.6,(we-2)/2)):ot.position.clone().add(new A(0,.6,0)),l=c.clone().sub(_n.target);if(_n.target.copy(c),Ne.position.add(l),Oi.position.copy(c).add(new A(-25,45,20)),Oi.target.position.copy(c),_n.update(),Fn.visible=!!Gt&&cs(),Fn.visible){const h=ru();Fn.scale.set(h.w*Ft,1,h.d*Ft),Fn.position.copy(ni(new A(1.4+(h.x+h.w/2)*Ft,.82,.2+(h.z+h.d/2)*Ft))),Fn.rotation.y=Lt.rotation.y,Fn.material.color.set(h.valid?2386770:13974845),Fn.material.opacity=h.valid?.62:.82,eu.material.color.set(h.valid?1195825:7282464)}const u=Gt&&!cs()?ef(Gt):null;if(Kn.visible=!!u&&ot.position.distanceTo(u.target)<18,u&&Gt&&(Kn.position.x=u.target.x,Kn.position.z=u.target.z,Kn.scale.set(Gt.item.w*Ft,Gt.item.d*Ft,1),Kn.material.color.setHex(u.close?4828784:15321180)),Di.visible=!!Gt&&!cs()&&nf(ot.position)&&!u?.close,Di.visible&&Gt){const h=ot.position.clone().add(new A(0,0,1.1).applyQuaternion(ot.quaternion));Di.position.set(h.x,.105,h.z),Di.scale.set(Gt.item.w*Ft,Gt.item.d*Ft,1)}ua-=t,ua<=0&&Q("#status-bar").classList.remove("show-notice"),xl+=t,vl+=t,xl>.18&&(jr(),xl=0),vl>5&&(Ae(),vl=0),Ln.render(Pe,Ne),kh||(kh=!0,document.getElementById("loading-screen")?.remove(),Ms()),!Q("#dialog").open&&Q("#tests").hidden&&Q("#company-panel").hidden&&(Q("#tutorial-card").hidden||kt>0),requestAnimationFrame(mf)}requestAnimationFrame(mf);window.addEventListener("pagehide",Ae);
